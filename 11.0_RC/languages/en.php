...
$lang["fieldtype-text_box_formatted_and_tinymce"] = "Text box (formatted / TinyMCE)";
...
$lang["information-enable_complete_indexing"] = "Index field values as one unbroken keyword for this field. This option is incompatible with partial indexing.";
$lang["property-enable_complete_indexing"] = "Enable complete indexing";
...
$lang["background_most_recent_image"] = "Most recent image";
...
$lang["edit_multiple_existing_values"] = 'Existing keywords on resources in this selection';
$lang["edit_multiple_show_more"] = 'Show more';
$lang["edit_multiple_too_many"] = 'Showing top 100 most used values. Others also exist.';
$lang["edit_multiple_action_text_rt"] = 'All text / options(s) will be replaced with the following keywords';
$lang["edit_multiple_action_text_ap"] = 'These keywords will be appended';
$lang["edit_multiple_action_text_rm"] = 'These keywords will be removed';
...
$lang["try"] = "Try";
$lang["tryselectingallcountries"] = "Try selecting \"all\" in the countries box, or";
$lang["tryselectinganyyear"] = "Try selecting \"any year\" in the year box, or";
$lang["tryselectinganymonth"] = "Try selecting \"any month\" in the month box, or";
...
$lang["log-up"] = "Uploaded preview image";
...
$lang["forgottenpassword"] = "Forgot your password?";
...
$lang["login"] = "Log in";
$lang["loginincorrect"] = "Email / username or password are incorrect";
$lang["request_new_password"] = "If you have forgotten your password, use the link below to request a new one.";
...
$lang["email_conflicts_username"] = "Email cannot be the same as the username of a different user.";
$lang["username_conflicts_email"] = "Username cannot be the same as the email address of a different user.";
...
$lang["yourname"] = "Full name";
$lang["youremailaddress"] = "Email";
...
$lang["enter_username_or_email"] = "Enter a username or email address";
$lang["enter_a_password"] = "Enter a password";
$lang["enter_a_full_name"] = "Enter a full name";
$lang["enter_an_email_address"] = "Enter an email address";
$lang["new_to_resourcespace"] = "New to [applicationname]?";
$lang["show_password"] = "Show password";
$lang["hide_password"] = "Hide password";
$lang["select_a_user_group"] = "Select a user group";
...
$lang["requiredfields"] = "Some fields have errors";
...
$lang["enterantispamcode"] = "Please enter the following code";
...
$lang["deny_edit_all_resource_types"] = "Deny edit access to all resource types except those specified by \"Can edit resources of type\" permissions";
$lang["can_edit_resource_type"] = "Can edit resources of type [resourcetype]. Ignored if \"Deny edit access to all resource types\" permission (see above) is not present";
...
$lang["can_upload_preview_images"] = "Can upload preview images";
...
$lang['error_fieldidnotfound'] = 'Field ID not found.';
...
$lang['systemconfig_watermark_open'] = 'Apply watermark to thumb / preview for groups with the "w" permission even when access is "Open"';
$lang['systemconfig_watermark_open_search'] = 'If watermark applied to thumb / preview (above option), also apply the watermark to the search page';
...
$lang['systemconfig_minyear'] = 'Earliest date to include in date selector on the search form. Normally year of first upload';
$lang['systemconfig_searchbyday'] = 'Include day in search in addition to month/year';
$lang['systemconfig_default_collection_sort'] = 'Default sort order when viewing collection resources. When users are expecting resources to be shown in the order they provided this should be collection';
$lang['systemconfig_systemconfig_searchbyday'] = 'Show the resource workflow state (icon and text) in search results when in thumbnail display mode';
$lang['systemconfig_category_tree_search_use_and'] = 'Selecting a value in a category tree field on the search page will automatically select all parent values';
$lang['systemconfig_category_tree_search_use_and_logic'] = 'All selected category tree values must be present for search to return result (selecting no will find matches for any selected value)';
$lang['systemconfig_recent_search_quantity'] = 'Number of resources to display with Recent and View new material links';
...
$lang['systemconfig_general'] = 'General';
$lang['systemconfig_date_yyyy'] = 'Display year in a four digit format';
$lang['systemconfig_imperial_measurements'] = 'Use imperial instead of metric for the download size guidelines';
$lang['systemconfig_site_text_custom_create'] = 'Allow for the creation of new site text entries from Manage Content (intended for developing new pages)';
$lang['systemconfig_no_welcometext'] = 'Hide welcome text on home page';
$lang['systemconfig_internal_preview_sizes_editable'] = 'Allow editing of internal sizes';
$lang['systemconfig_edit_autosave'] = 'Automatically save changes on the edit page. If no, the Save button must be used';
$lang['systemconfig_resource_request_reason_required'] = 'When requesting a resource or resources, is the "Reason for request" field mandatory';
$lang['systemconfig_research_request'] = 'Enable the Research Request functionality';
$lang['systemconfig_custom_access'] = 'Enable "custom access" level for additional resource access control';
$lang['systemconfig_enable_related_resources'] = 'Enable the "Related resources" field when editing resources.';
...
$lang['systemconfig_inactive_user_disable_days'] = 'Automatically disable inactive users after a set number of days (0 disables this feature)';
$lang['systemconfig_sharing'] = 'Sharing';
$lang['systemconfig_external_share_groups_config_options'] = 'Honor group config options when sharing externally as a specific user group';
$lang['systemconfig_resource_share_expire_days_default'] = 'Default number of days ahead to select for share expiry (set 0 to use first option)';
$lang['systemconfig_restricted_share'] = 'Should those with "restricted" access to a resource be able to share the resource';
$lang['systemconfig_blank_edit_template'] = 'When uploading resources (batch upload) and editing the template, reset values to blank or the default value every time';
$lang['systemconfig_enable_copy_data_from'] = 'When batch uploading, enable the "Copy resource data from existing resource" feature';
$lang['systemconfig_resource_view'] = 'Resource View';
$lang['systemconfig_show_resourceid'] = 'Show the resource ID on the view page';
$lang['systemconfig_show_resource_type'] = 'Show the resource type on the view page';
$lang['systemconfig_show_access_field'] = 'Show resource access on the view page';
$lang['systemconfig_show_contributed_by'] = 'Show the "contributed by" user on the view page';
$lang['systemconfig_show_related_themes'] = 'Show related collections and public collections panel on view page';
$lang['systemconfig_metadata_download'] = ' Show "Download metadata" option on the view page';
$lang['systemconfig_uploading'] = 'Uploading';
$lang['systemconfig_upload_add_to_new_collection'] = '"Add to New Collection" option will be used for batch uploads. Turn off to default to "Do not Add to Collection"';
$lang['systemconfig_upload_add_to_new_collection_opt'] = 'For batch uploads, enable the "Add to New Collection" option';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = 'For batch uploads, enable the "Do Not Add to New Collection" option (if not enabled will force upload to a collection)';
$lang['systemconfig_upload_collection_name_required'] = 'Require that a collection name is entered for batch uploads. Will override the Upload[timestamp] default behavior';
...
$lang['systemconfig_allow_password_change'] = 'Allow password change';
$lang['systemconfig_allow_password_reset'] = 'Allow users to request new password via the login screen';
$lang['systemconfig_allow_keep_logged_in'] = 'Show "Keep me logged in on this device" option on the login screen';
$lang['systemconfig_remember_me_checked'] = '"Keep me logged in on this device" option selected by default';
$lang['systemconfig_session_length'] = 'User session length (minutes)';
$lang['systemconfig_session_autologout'] = 'Automatically log user out at the end of session (idle time equal to session length)';
...
$lang['config_integer_invalid_range'] = 'Invalid value. Enter a number between %MIN% and %MAX%';
...
$lang["actions_email_new_actions_title"] = "New actions";
$lang["actions_email_new_actions_intro"] = "There are new actions to be completed.";
...
$lang["cleanup_invalid_nodes"]              = "Clean field data from invalid resource types";
...
$lang["user_pref_new_action_emails"]        = "Email me if new actions are created";
