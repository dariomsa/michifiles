...
$lang["group_config_inherit"] = 'Die Gruppen-Konfiguration wird von der übergeordneten Benutzergruppe übernommen. Hier gibt es nichts zu konfigurieren.';
$lang["property-group_preferences_inherit"] = 'Von der übergeordneten Gruppe übernehmen';
$lang["property-sort_method"] = 'Sortiermethode';
$lang["information-sort_method"] = 'Reihenfolge, die verwendet werden soll, wenn Suchergebnisse angezeigt werden, die nach diesem Feld sortiert sind.';
$lang["exiftoolconflictingversions"] = 'Konfliktierende Versionen von Exiftool erkannt';
$lang["editgroupconfigoverrides"] = 'Gruppenkonfigurationseinstellungen bearbeiten';
$lang["sort-method_default"] = 'Standard - Alphanumerisch';
$lang["sort-method_dot-notation"] = 'Zugangsnummer - Punktnotation';
$lang["save-error-invalid"] = 'Fehler beim automatischen Speichern - bitte überprüfen Sie den Inhalt und versuchen Sie es erneut';
$lang["fieldtitle-usergroup_config"] = 'Gruppenüberschreibungen';
$lang["page-title_usergroup_config"] = 'Gruppenkonfigurationseinstellungen bearbeiten';
$lang["action-title_usergroup_override_detail"] = 'Alle hier konfigurierten Einstellungen überschreiben die Systemstandardeinstellungen für Benutzer in dieser Gruppe.';
$lang["team_resource_non_ingested_search"] = 'Nicht ingestierte Ressourcen anzeigen';
$lang["language-ms"] = 'Malay';
$lang["language-tl"] = 'Filipino';
$lang["upgrade_028_notify_config_not_set"] = 'Kann die (systemweite) Konfigurationsoption %name% nicht auf %value% setzen';
$lang["annotate_tagging_fields"] = 'Tagging-Felder';
$lang["annotate_text_adds_comment"] = 'Kommentar für Ressourcen-Textanmerkungen hinzufügen. (Nicht anwendbar für feste Listenfeldanmerkungen)';
$lang["annotate_public_view"] = 'Sind Anmerkungen öffentlich sichtbar (z. B. externe Freigaben)?';
$lang["annotate_show_author"] = 'Anzeigen des Annotationsautors?';
$lang["annotate_exclude_restypes"] = 'Ressourcentypen zum Ausschließen (ankreuzen, um auszuschließen und nicht annotiert zu werden)';
$lang["annotate_pseudo_rtf_comment_title"] = 'Kommentare (Modus)';
$lang["annotorious_add_a_comment"] = 'Kommentar hinzufügen...';
$lang["annotorious_type_to_search_field"] = 'Geben Sie ein, um das Feld zu durchsuchen...';
$lang["annotate_pdf_sheet_tool"] = 'Annotations PDF';
$lang["annotate_pdf_intro_text"] = 'Wählen Sie die Seitengröße für Ihr Annotations-PDF aus.';
$lang["annotate_pdf_no_annotations"] = 'Es gibt keine Anmerkungen.';
$lang["statusinvalid"] = 'Ungültig';
$lang["accessinvalid"] = 'Ungültig';
$lang["requiredfields-status-required_fields"] = 'Erforderliche Felder müssen ausgefüllt werden, um den Status auf %%STATUS%% zu ändern. Bitte setzen Sie die folgenden Felder und versuchen Sie es erneut: %%FIELDS%%';
$lang["error_file_upload_cond-InvalidMimeType"] = 'Ungültiger MIME-Typ';
$lang["error-edit_status_change_missing_required_fields"] = 'Es ist nicht möglich, den Archivstatus aller Ressourcen zu ändern. Die folgenden Ressourcen wurden übersprungen, da in erforderlichen Feldern Daten fehlen:';
$lang["missing_required_fields"] = 'Ressourcen mit unvollständigen erforderlichen Feldern';
$lang["missing_required_fields_intro"] = 'Ressourcen in der Sammlung erscheinen unten sortiert nach unvollständigen erforderlichen Feldern.';
$lang["action_update_now"] = 'Jetzt aktualisieren';
$lang["errors"] = 'Fehler';
...
$lang["years"] = 'Jahre';
$lang["ago"] = 'vor';
$lang["action-selectresource"] = 'Ressource auswählen';
$lang["addremove"] = 'Auswählen';
$lang["expand"] = 'Erweitern';
$lang["error_fieldidnotfound"] = 'Feld-ID nicht gefunden.';
$lang["page-title_login"] = 'Anmelden';
$lang["page-title_about"] = 'Über uns';
$lang["page-title_alternative_file"] = 'Alternative Datei';
$lang["page-title_alternative_files"] = 'Alternative Dateien';
$lang["page-title_annotate_pdf_config"] = 'PDF annotieren';
$lang["page-title_annotate_pdf_gen"] = 'PDF annotieren';
$lang["page-title_api_test"] = 'API-Test';
$lang["page-title_change_language"] = 'Sprache ändern';
$lang["page-title_check"] = 'Installationsprüfung';
$lang["page-title_collection_comment"] = 'Sammlungs Kommentare';
$lang["page-title_collection_copy_resources"] = 'Kopiere Sammlungsressourcen';
$lang["page-title_collection_download"] = 'Sammlung herunterladen';
$lang["page-title_collection_edit"] = 'Sammlung bearbeiten';
$lang["page-title_collection_edit_previews"] = 'Sammlungsvorschauen bearbeiten';
$lang["page-title_collection_email"] = 'E-Mail-Sammlung';
$lang["page-title_collection_feedback"] = 'Sammlung Feedback';
$lang["page-title_collection_log"] = 'Sammlungsprotokoll';
$lang["page-title_collection_manage"] = 'Sammlungen verwalten';
$lang["page-title_collection_public"] = 'Öffentliche Sammlungen';
$lang["page-title_collection_request"] = 'Sammlung anfordern';
$lang["page-title_collection_set_category"] = 'Sammlungskategorie festlegen';
$lang["page-title_collections_featured"] = 'Hervorgehobene Sammlungen';
$lang["page-title_collection_share"] = 'Sammlung teilen';
$lang["page-title_collections"] = 'Sammlungen';
$lang["page-title_contact"] = 'Kontaktieren Sie uns';
$lang["page-title_contactsheet_settings"] = 'Kontaktblatt-Konfiguration';
$lang["page-title_content"] = 'Vorschau auf den Inhalt der Seite';
$lang["page-title_contribute"] = 'Beiträge';
$lang["page-title_csv_export_results_metadata"] = 'CSV-Export';
$lang["page-title_dash_tile"] = 'Dash-Kachel bearbeiten';
$lang["page-title_done"] = 'Fertig';
$lang["page-title_download"] = 'Herunterladen';
$lang["page-title_download_progress"] = 'Download-Fortschritt';
$lang["page-title_download_usage"] = 'Download-Nutzung';
$lang["page-title_edit_fields"] = 'Metadatenfeld bearbeiten';
$lang["page-title_edit"] = 'Ressource bearbeiten';
$lang["page-title_geo_edit"] = 'Standort bearbeiten';
$lang["page-title_geo_search"] = 'Standortsuche';
$lang["page-title_graph"] = 'Graf';
$lang["page-title_help"] = 'Hilfe';
$lang["page-title_home"] = 'Dash';
$lang["page-title_job_details"] = 'Offline Job Details';
$lang["page-title_log_entry"] = 'Ressourcenprotokoll';
$lang["page-title_log"] = 'Ressourcenprotokoll';
$lang["page-title_manage_external_shares"] = 'Shares verwalten';
$lang["page-title_manage_jobs"] = 'Offline-Jobs verwalten';
$lang["page-title_metadata_download"] = 'Metadaten herunterladen';
$lang["page-title_mp3_play"] = 'Audio-Datei abspielen';
$lang["page-title_no_uploads"] = 'Hochladen nicht verfügbar';
$lang["page-title_preview"] = 'Vorschau';
$lang["page-title_request_log"] = 'Anforderungsprotokoll';
$lang["page-title_requests"] = 'Anfragen';
$lang["page-title_research_request"] = 'Forschungsanfrage';
$lang["page-title_resource_collection_list"] = 'Sammlungsübersicht';
$lang["page-title_resource_email"] = 'E-Mail-Ressource';
$lang["page-title_resource_request"] = 'Ressource anfordern';
$lang["page-title_resource_share"] = 'Ressource teilen';
$lang["page-title_search_advanced"] = 'Erweiterte Suche';
$lang["page-title_search_disk_usage"] = 'Speicherplatznutzung';
$lang["page-title_search"] = 'Suche';
$lang["page-title_setup"] = 'Einrichten';
$lang["page-title_share_access"] = 'Zugriffsfreigabe';
$lang["page-title_share_upload"] = 'Hochladen Teilen';
$lang["page-title_simple_search"] = 'Suche';
$lang["page-title_system_down"] = 'Systemausfall';
$lang["page-title_terms"] = 'Nutzungsbedingungen';
$lang["page-title_themes"] = 'Hervorgehobene Sammlungen';
$lang["page-title_upload_batch"] = 'Ressourcen hochladen';
$lang["page-title_upload_preview"] = 'Upload-Vorschau';
$lang["page-title_upload_replace_batch"] = 'Massenersatz von Ressourcen';
$lang["page-title_user_password"] = 'Passwort ändern';
$lang["page-title_user_ratings"] = 'Benutzerbewertungsstatistiken für Ressource';
$lang["page-title_user_request"] = 'Benutzer anfordern';
$lang["page-title_video_player"] = 'Videoplayer';
$lang["page-title_view_alternative_files"] = 'Alternative Datei anzeigen';
$lang["page-title_view_metadata"] = 'Ressourcenmetadaten anzeigen';
$lang["page-title_view"] = 'Ressource anzeigen';
$lang["page-title_view_shares"] = 'Ansicht Teilen';
$lang["page-title_admin_content_edit"] = 'Inhalt der Website bearbeiten';
$lang["page-title_admin_content"] = 'Seiteninhalt';
$lang["page-title_admin_copy_field"] = 'Kopiere Ressourcen-Typ-Feld';
$lang["page-title_admin_download_config"] = 'Systemkonfiguration herunterladen';
$lang["page-title_admin_filter_edit"] = 'Filter bearbeiten';
$lang["page-title_admin_filter_manage"] = 'Filter verwalten';
$lang["page-title_admin_group_config_edit"] = 'Benutzergruppen-Konfigurationsüberschreibungen bearbeiten';
$lang["page-title_admin_group_management_edit"] = 'Benutzergruppe bearbeiten';
$lang["page-title_admin_group_management"] = 'Benutzergruppen';
$lang["page-title_admin_group_permissions"] = 'Benutzergruppenberechtigungen bearbeiten';
$lang["page-title_admin_home"] = 'Systemmenü';
$lang["page-title_admin_manage_field_options"] = 'Feldoptionen verwalten';
$lang["page-title_admin_manage_slideshow"] = 'Diashow verwalten';
$lang["page-title_admin_report_management_edit"] = 'Bericht bearbeiten';
$lang["page-title_admin_report_management"] = 'Berichte verwalten';
$lang["page-title_admin_resource_type_edit"] = 'Ressourcentyp bearbeiten';
$lang["page-title_admin_resource_type_field_edit"] = 'Ressourcentypfeld bearbeiten';
$lang["page-title_admin_resource_type_fields"] = 'Ressourcentypfelder';
$lang["page-title_admin_resource_types"] = 'Ressourcentypen';
$lang["page-title_admin_size_management_edit"] = 'Bildgröße bearbeiten';
$lang["page-title_admin_size_management"] = 'Bildgrößen';
$lang["page-title_admin_system_config"] = 'Systemkonfiguration';
$lang["page-title_admin_system_log"] = 'Systemprotokoll';
$lang["page-title_admin_system_performance"] = 'Systemleistung';
$lang["page-title_tabs"] = 'Tabs verwalten';
$lang["page-title_team_analytics_edit"] = 'Analysereport bearbeiten';
$lang["page-title_team_analytics"] = 'Analysebericht';
$lang["page-title_team_archive"] = 'Ressourcen archivieren';
$lang["page-title_team_copy"] = 'Ressource kopieren';
$lang["page-title_team_dash_admin"] = 'Dash verwalten';
$lang["page-title_team_dash_tile"] = 'Dash-Kacheln';
$lang["page-title_team_dash_tile_special"] = 'Erstelle spezielle Dash-Kachel';
$lang["page-title_team_export"] = 'Systemdaten exportieren';
$lang["page-title_team_external_shares"] = 'Externe Freigaben verwalten';
$lang["page-title_team_home"] = 'Admin-Menü';
$lang["page-title_team_mail"] = 'Massenmail senden';
$lang["page-title_team_plugins_groups"] = 'Benutzergruppen-Plugin-Zugriff verwalten';
$lang["page-title_team_plugins"] = 'Plugins verwalten';
$lang["page-title_team_related_keywords_edit"] = 'Verwandte Schlüsselwörter bearbeiten';
$lang["page-title_team_related_keywords"] = 'Verwandte Schlüsselwörter';
$lang["page-title_team_report"] = 'Bericht anzeigen';
$lang["page-title_team_request_edit"] = 'Bearbeitungsanfrage';
$lang["page-title_team_request"] = 'Anfragen';
$lang["page-title_team_research_edit"] = 'Forschungsanfrage bearbeiten';
$lang["page-title_team_research"] = 'Forschungsanfrage';
$lang["page-title_team_resource"] = 'Ressourcenmenü';
$lang["page-title_team_user_edit"] = 'Benutzer bearbeiten';
$lang["page-title_team_user"] = 'Benutzer verwalten';
$lang["page-title_team_user_purge"] = 'Benutzer löschen';
$lang["page-title_user_actions"] = 'Benutzeraktionen';
$lang["page-title_user_api_session"] = 'Zugriff auf die API des Remote-Systems';
$lang["page-title_user_change_password"] = 'Passwort ändern';
$lang["page-title_user_dash_admin"] = 'Benutzer-Dashboard verwalten';
$lang["page-title_user_home"] = 'Benutzermenü';
$lang["page-title_user_message"] = 'Benutzermeldung';
$lang["page-title_user_messages"] = 'Benutzernachrichten';
$lang["page-title_user_preferences"] = 'Benutzereinstellungen';
$lang["page-title_user_profile_edit"] = 'Mein Profil';
$lang["page-title_user_profile"] = 'Benutzerprofil';
$lang["backtomessages"] = 'Zurück zu Nachrichten';
$lang["viewallmessages"] = 'Alle Nachrichten anzeigen';
$lang["min_ago"] = '%TIME% Minute zuvor';
$lang["mins_ago"] = 'vor %TIME% Minuten';
$lang["hour_ago"] = '%TIME% Stunde zuvor';
$lang["hours_ago"] = '%TIME% Stunden zuvor';
$lang["day_ago"] = '%TIME% Tag her';
$lang["days_ago"] = '%TIME% Tage her';
$lang["week_ago"] = '%TIME% Woche her';
$lang["weeks_ago"] = '%TIME% Wochen zuvor';
$lang["month_ago"] = '%TIME% Monat her';
$lang["months_ago"] = '%TIME% Monate her';
$lang["random"] = 'Zufällig';
$lang["log-sf"] = 'Statiksync-Datei geändert';
$lang["log_code_J"] = 'Auftrag hinzugefügt';
$lang["log_code_JC"] = 'Auftrag abgeschlossen';
$lang["log_code_JD"] = 'Auftrag gelöscht';
$lang["email_username"] = 'E-Mail / Benutzername';
$lang["request_new_password"] = 'Wenn Sie Ihr Passwort vergessen haben, verwenden Sie den unten stehenden Link, um ein neues anzufordern.';
$lang["enter_username_or_email"] = 'Benutzername oder E-Mail-Adresse eingeben';
$lang["enter_a_password"] = 'Passwort eingeben';
$lang["enter_a_full_name"] = 'Vollständigen Namen eingeben';
$lang["enter_an_email_address"] = 'E-Mail-Adresse eingeben';
$lang["new_to_resourcespace"] = 'Neu bei [applicationname]?';
$lang["show_password"] = 'Passwort anzeigen';
$lang["hide_password"] = 'Passwort verbergen';
$lang["select_a_user_group"] = 'Benutzergruppe auswählen';
$lang["back_to_login"] = 'Zurück zum Login';
$lang["required"] = 'erforderlich';
$lang["select_a"] = 'Wählen Sie ein';
$lang["notsharableresources"] = 'Die folgenden Ressourcen können von diesem Benutzer nicht geteilt werden und können nicht zu einer geteilten Sammlung hinzugefügt werden: ';
$lang["antispam"] = 'Anti-Spam';
$lang["comments_body-placeholder-anon"] = 'Einen Kommentar hinzufügen.';
$lang["batch_replace_alternatives"] = 'Originaldateien oder alternative Dateien ersetzen';
$lang["batch_replace_upload_resources"] = 'Originaldateien';
$lang["batch_replace_upload_alternatives"] = 'Alternative Dateien';
$lang["userpreference_user_interface"] = 'Benutzeroberfläche';
$lang["systemconfig_watermark_open"] = 'Wasserzeichen auf Vorschaubild / Vorschau für Gruppen mit "w"-Berechtigung auch bei "Offen"-Zugriff anwenden';
$lang["systemconfig_watermark_open_search"] = 'Wenn Wasserzeichen auf Vorschaubild / Vorschau angewendet wird (obige Option), auch Wasserzeichen auf der Suchseite anwenden';
$lang["systemconfig_minyear"] = 'Frühestes Datum, das im Datumsauswahlfeld im Suchformular enthalten sein soll. Normalerweise Jahr des ersten Uploads';
$lang["systemconfig_searchbyday"] = 'Tag zusätzlich zu Monat/Jahr in der Suche einschließen';
$lang["systemconfig_default_collection_sort"] = 'Standard-Sortierreihenfolge beim Anzeigen von Sammlungsressourcen. Wenn Benutzer erwarten, dass Ressourcen in der Reihenfolge angezeigt werden, in der sie bereitgestellt wurden, sollte dies Sammlung sein';
$lang["systemconfig_systemconfig_searchbyday"] = 'Zeigen Sie den Workflow-Status der Ressource (Symbol und Text) in den Suchergebnissen im Thumbnail-Ansichtsmodus an';
$lang["systemconfig_category_tree_search_use_and"] = 'Wenn ein Wert in einem Kategoriebaumfeld auf der Suchseite ausgewählt wird, werden automatisch alle Elternwerte ausgewählt';
$lang["systemconfig_category_tree_search_use_and_logic"] = 'Alle ausgewählten Kategoriebaumwerte müssen vorhanden sein, damit die Suche Ergebnisse liefert (keine Auswahl findet Übereinstimmungen für beliebige ausgewählte Werte)';
$lang["systemconfig_recent_search_quantity"] = 'Anzahl der Ressourcen, die mit den Links \'Neu anzeigen\' und \'Neues Material anzeigen\' angezeigt werden';
$lang["systemconfig_general"] = 'Allgemein';
$lang["systemconfig_date_yyyy"] = 'Jahr im vierstelligen Format anzeigen';
$lang["systemconfig_imperial_measurements"] = 'Imperialeinheiten anstelle von metrischen Einheiten für die Download-Größenrichtlinien verwenden';
$lang["systemconfig_site_text_custom_create"] = 'Erstellen neuer Site-Text-Einträge aus \'Inhalt verwalten\' (vorgesehen für die Entwicklung neuer Seiten)';
$lang["systemconfig_no_welcometext"] = 'Willkommens-Text auf der Startseite ausblenden';
$lang["systemconfig_internal_preview_sizes_editable"] = 'Bearbeitung interner Größen zulassen';
$lang["systemconfig_edit_autosave"] = 'Änderungen auf der Bearbeitungsseite automatisch speichern. Wenn nein, muss die Schaltfläche \'Speichern\' verwendet werden';
$lang["systemconfig_resource_request_reason_required"] = 'Ist das Feld \'Grund für Anfrage\' beim Anfordern einer Ressource oder mehrerer Ressourcen verpflichtend?';
$lang["systemconfig_research_request"] = 'Funktion \'Forschungsanfrage\' aktivieren';
$lang["systemconfig_custom_access"] = 'Benutzerdefinierte Zugriffsebene für zusätzliche Ressourcensteuerung aktivieren';
$lang["systemconfig_enable_related_resources"] = 'Das Feld \'Verwandte Ressourcen\' beim Bearbeiten von Ressourcen aktivieren.';
$lang["systemconfig_user_accounts"] = 'Benutzerkonten';
$lang["systemconfig_inactive_user_disable_days"] = 'Inaktive Benutzer nach einer festgelegten Anzahl von Tagen automatisch deaktivieren (0 deaktiviert diese Funktion)';
$lang["systemconfig_sharing"] = 'Freigabe';
$lang["systemconfig_external_share_groups_config_options"] = 'Gruppenkonfigurationsoptionen bei externer Freigabe als bestimmte Benutzergruppe berücksichtigen';
$lang["systemconfig_resource_share_expire_days_default"] = 'Standardanzahl der Tage im Voraus für das Ablaufdatum der Freigabe auswählen (0 für erste Option setzen)';
$lang["systemconfig_restricted_share"] = 'Sollten Personen mit "eingeschränktem" Zugriff auf eine Ressource die Ressource teilen können';
$lang["systemconfig_blank_edit_template"] = 'Beim Hochladen von Ressourcen (Stapel-Upload) und Bearbeiten der Vorlage Werte bei jedem Vorgang auf leer oder den Standardwert zurücksetzen';
$lang["systemconfig_enable_copy_data_from"] = 'Beim Stapel-Upload die Funktion "Ressourcendaten von bestehender Ressource kopieren" aktivieren';
$lang["systemconfig_resource_view"] = 'Ressourcenansicht';
$lang["systemconfig_show_resourceid"] = 'Ressourcen-ID auf der Ansichtseite anzeigen';
$lang["systemconfig_show_resource_type"] = 'Ressourcentyp auf der Ansichtseite anzeigen';
$lang["systemconfig_show_access_field"] = 'Zugriff auf Ressource auf der Ansichtseite anzeigen';
$lang["systemconfig_show_contributed_by"] = 'Den "Beiträger"-Benutzer auf der Ansichtseite anzeigen';
$lang["systemconfig_show_related_themes"] = 'Verwandte Sammlungen und öffentliches Sammlungs-Panel auf der Ansichtseite anzeigen';
$lang["systemconfig_metadata_download"] = 'Option "Metadaten herunterladen" auf der Ansichtseite anzeigen';
$lang["systemconfig_uploading"] = 'Hochladen';
$lang["systemconfig_upload_add_to_new_collection"] = '"Zur neuen Sammlung hinzufügen"-Option wird für Stapel-Uploads verwendet. Ausschalten, um standardmäßig "Nicht zur Sammlung hinzufügen" zu verwenden';
$lang["systemconfig_upload_add_to_new_collection_opt"] = 'Für Stapel-Uploads die Option "Zur neuen Sammlung hinzufügen" aktivieren';
$lang["systemconfig_upload_do_not_add_to_new_collection_opt"] = 'Für Stapel-Uploads die Option "Nicht zur neuen Sammlung hinzufügen" aktivieren (wenn nicht aktiviert, wird der Upload in eine Sammlung erzwungen)';
$lang["systemconfig_upload_collection_name_required"] = 'Erfordern, dass für Stapel-Uploads ein Sammlungsname eingegeben wird. Überschreibt das Standardverhalten Upload[timestamp]';
$lang["systemconfig_allow_password_change"] = 'Passwortänderung erlauben';
$lang["systemconfig_allow_password_reset"] = 'Benutzern erlauben, über den Login-Bildschirm ein neues Passwort anzufordern';
$lang["systemconfig_allow_keep_logged_in"] = 'Option "Angemeldet bleiben auf diesem Gerät" auf dem Login-Bildschirm anzeigen';
$lang["systemconfig_remember_me_checked"] = 'Option "Angemeldet bleiben auf diesem Gerät" standardmäßig aktiviert';
$lang["systemconfig_session_length"] = 'Benutzersitzungsdauer (Minuten)';
$lang["systemconfig_session_autologout"] = 'Benutzer automatisch am Ende der Sitzung abmelden (Leerlaufzeit entspricht Sitzungsdauer)';
$lang["systemconfig_slideshow_photo_delay"] = 'Anzahl der Sekunden, die die Diashow auf das nächste Bild wartet';
$lang["config_integer_invalid_range"] = 'Ungültiger Wert. Geben Sie eine Zahl zwischen %MIN% und %MAX% ein';
$lang["alternative_file_replaced"] = 'Alternative Datei erfolgreich ersetzt';
$lang["jq_create_alt_previews_success_text"] = 'Vorschauen für alternative Datei #%ALTFILE% erfolgreich erstellt';
$lang["jq_create_alt_previews_failure_text"] = 'Fehler beim Erstellen der Vorschauen für alternative Datei #%ALTFILE%';
$lang["error_report_execution"] = 'Beim Ausführen des Berichts ist ein Fehler aufgetreten, bitte überprüfen Sie, ob die Abfrage gültig ist';
$lang["error_save_not_allowed_dash_tile_set_public"] = 'Änderung kann nicht gespeichert werden. Stellen Sie sicher, dass keine Dash-Widgets für alle oder mehrere Benutzer gesetzt sind, die mit dieser Sammlung verknüpft sind';
$lang["error_upload_replace_alternative_file_not_found"] = 'Fehler beim Aktualisieren der alternativen Datei. Kein passender Datensatz für alternative Datei mit Dateiname [filename] gefunden';
$lang["error_upload_replace_alternative_multiple_found"] = 'Fehler beim Aktualisieren der alternativen Datei. Mehrere passende Datensätze für alternative Datei mit Dateiname [filename] gefunden, Begrenzung nach Ressourcen-ID oder Sammlung';
$lang["oj-batch-replace-local-alternatives-success-text"] = 'Stapelweise Ersetzung hat erfolgreich %TOTALFILES% alternative Dateien ersetzt';
$lang["replacebatch_collection_alternatives"] = 'Geben Sie eine Sammlung-ID ein, wenn Sie nur alternative Dateien zu Ressourcen innerhalb dieser Sammlung hinzufügen oder ersetzen möchten';
$lang["replacebatch_resource_min_alternatives"] = 'Niedrigste Ressourcen-ID, für die alternative Dateien ersetzt werden sollen (ignoriert, wenn eine Sammlung angegeben ist)';
$lang["replacebatch_resource_max_alternatives"] = 'Höchste Ressourcen-ID, für die alternative Dateien ersetzt werden sollen';
$lang["system_config_search_engines"] = 'Suchmaschinen';
$lang["int_ranges_empty"] = 'Eingabe ist leer';
$lang["int_ranges_range_below_1"] = 'Zahlen müssen 1 oder größer im Bereich %%PART%% sein';
$lang["int_ranges_range_reversed"] = 'Der Anfang des Bereichs %%PART%% kann nicht größer als das Ende sein';
$lang["int_ranges_range_above_max"] = 'Bereich %%PART%% überschreitet die maximale Zahl von %%MAX_VAL%%';
$lang["int_ranges_single_below_1"] = 'Zahlen müssen 1 oder größer sein (%%PART%%)';
$lang["int_ranges_single_above_max"] = '%%PART%% überschreitet die maximale Zahl von %%MAX_VAL%%';
$lang["int_ranges_not_valid"] = '%%PART%% ist keine gültige Zahl oder kein gültiger Bereich (verwenden Sie Formate wie 3 oder 5-9)';
$lang["job_trigger"] = 'Einen Job auslösen';
$lang["job_configure"] = 'Job konfigurieren';
$lang["jobs_action_stream_log"] = 'Protokolldatei streamen';
$lang["jobs_action_download_log"] = 'Protokolldatei herunterladen';
$lang["jobs_action_not_started"] = 'Job hat noch nicht begonnen';
$lang["jobs_action_missing_job_progress"] = 'Fortschritt des Jobs kann nicht geladen werden';
$lang["job_action_not_found"] = 'Job nicht gefunden.';
$lang["job_list_core"] = 'Kern';
$lang["job_list_recreate_previews"] = 'Vorschauen neu erstellen';
$lang["job_list_exif_data"] = 'EXIF-Daten neu generieren';
$lang["job_list_purge_duplicates"] = 'Duplikate Ressourcen entfernen';
$lang["job_list_reindex"] = 'Daten neu indexieren';
$lang["job_list_checksums"] = 'Checksums aktualisieren';
$lang["job_list_extracted_text"] = 'Extrahierten Text aktualisieren';
$lang["oj_common_create_job"] = 'Auftrag erstellen';
$lang["oj_common_field_refs"] = 'Feld-Referenzen';
$lang["oj_common_collection_refs"] = 'Sammlungs-Referenzen';
$lang["oj_common_error_required"] = 'Feld erforderlich';
$lang["oj_common_error_invalid"] = 'Ungültiger Wert für Feld übergeben';
$lang["oj_common_error_invalid_field_ref"] = '%FIELD_REF% verweist nicht auf ein gültiges Feld';
$lang["oj_recreate_previews_target"] = 'Welche Art von Referenzen werden bereitgestellt?';
$lang["oj_recreate_previews_refs"] = 'Referenzen';
$lang["oj_recreate_previews_image_sizes"] = 'Zu generierende Bildgrößen';
$lang["oj_recreate_previews_resource_types"] = 'Zielressourcentypen';
$lang["oj_recreate_previews_use_existing"] = 'Vorhandene hochgeladene Vorschauen verwenden?';
$lang["oj_recreate_previews_video_update"] = 'Vorschauen für alle Videoressourcen aktualisieren, die nicht die erforderliche \'$ffmpeg_preview_extension\'-Erweiterung haben?';
$lang["oj_recreate_previews_delete_existing"] = 'Alle vorhandenen Vorschauen löschen';
$lang["oj_recreate_previews_refs_help"] = 'Diese Option steuert, welche Referenzen (entweder Ressourcen- oder Sammlungsreferenzen) für die Verarbeitung verwendet werden. Gültige Eingaben sind durch Kommas getrennte Listen, Bereiche und Wildcards, z.B. * würde alle Referenzen verarbeiten, 1-100 würde die ersten 100 Referenzen verarbeiten, 101-* würde Referenzen ab 101 verarbeiten, und 1,3,5 würde Referenzen 1, 3 und 5 verarbeiten. Diese können kombiniert werden, um genau die gewünschten Referenzen zu targetieren, z.B. 1,5-10,15-* würde Referenzen 1, 5 bis 10 und ab 15 verarbeiten.';
$lang["oj_recreate_previews_use_existing_help"] = 'Wenn diese Option aktiviert ist, werden manuell ersetzte Vorschauen auf Ressourcen beibehalten. Ohne diese Einstellung werden manuell hochgeladene Vorschauen durch Vorschauen aus der Originaldatei ersetzt.';
$lang["oj_recreate_previews_video_update_help"] = 'Wenn diese Option aktiviert ist, werden Videos aktualisiert, die nicht die aktuelle konfigurierte \'$ffmpeg_preview_extension\'-Erweiterung haben. Dies ist nützlich, wenn diese Einstellung geändert wurde, um nur die Ressourcen zu targetieren, die eine neue Vorschau benötigen.';
$lang["oj_recreate_previews_delete_existing_help"] = 'Wenn diese Option aktiviert ist, werden alle bestehenden Vorschauen vor der Neuerstellung gelöscht.';
$lang["oj_exif_data_blanks"] = 'Leeren Feldwert, wenn keine EXIF-Daten vorhanden sind';
$lang["oj_exif_data_overwrite"] = 'Vorhandene Feldwerte überschreiben, wenn EXIF-Daten vorhanden sind';
$lang["oj_exif_data_field_refs_help"] = 'Dies sind die Referenzen der Felder, für die EXIF-Daten extrahiert werden sollen. Diese Felder müssen "Exiftool-Feld" konfiguriert haben. Eine durch Kommas getrennte Liste kann verwendet werden, um die Felder anzugeben, z.B. 1,3,5.';
$lang["oj_exif_data_collection_refs_help"] = 'Wenn diese Option aktiviert ist, werden nur Ressourcen in den aufgelisteten Sammlungen aktualisiert. Wenn keine Sammlungen angegeben sind, werden EXIF-Daten für alle geeigneten Ressourcen aktualisiert. Sammlungen können durch eine durch Kommas getrennte Liste sowie Bereiche angegeben werden, z.B. 100,105,110-115';
$lang["oj_exif_data_blanks_help"] = 'Wenn diese Option aktiviert ist, wird das angegebene Feld geleert, wenn die Datei keine eingebetteten EXIF-Daten dafür enthält.';
$lang["oj_exif_data_overwrite_help"] = 'Wenn diese Option aktiviert ist, werden vorhandene Werte im angegebenen Feld durch eingebettete EXIF-Daten überschrieben, falls vorhanden.';
$lang["oj_purge_duplicates_intro"] = '<strong>Warnung: Dieses Skript ermöglicht das PERMANENTE LÖSCHEN von Ressourcen – bitte verwenden Sie die Trockentest-Option, um Ihre Einstellungen zu validieren, wenn Sie unsicher sind.</strong>';
$lang["oj_purge_duplicates_manage_method"] = 'Verwaltungsverfahren';
$lang["oj_purge_duplicates_lifo"] = 'Älteste behalten und neuere Duplikate entfernen';
$lang["oj_purge_duplicates_fifo"] = 'Neueste behalten und ältere Duplikate entfernen';
$lang["oj_purge_duplicates_dry_run"] = 'Trockentest';
$lang["oj_purge_duplicates_delete_perm"] = 'Permanent löschen';
$lang["oj_purge_duplicates_delete_error"] = 'Permanentes Löschen ist während eines Trockentests nicht möglich';
$lang["oj_purge_duplicates_collection_refs_help"] = 'Legt die Sammlungen als Umfang der Duplikaterkennung fest. Es ist nicht erforderlich, alle Duplikate in den Sammlungen zu haben, nur eines reicht aus. Duplikate werden systemweit verarbeitet und durch das gewählte Verwaltungsverfahren gelöscht. Sammlungen können durch eine durch Kommas getrennte Liste sowie Bereiche angegeben werden, z.B. 100,105,110-115';
$lang["oj_purge_duplicates_manage_method_help"] = 'Diese Einstellung steuert, wie das Skript mit der Entfernung der Duplikate umgeht.';
$lang["oj_purge_duplicates_dry_run_help"] = 'Wenn diese Option aktiviert ist, wird eine Testlauf durchgeführt, bei dem keine Ressourcen geändert werden. Die Ergebnisprotokolldatei des Testlaufs kann heruntergeladen werden, um die Ergebnisse zu überprüfen.';
$lang["oj_purge_duplicates_delete_perm_help"] = 'Wenn diese Option aktiviert ist, werden doppelte Ressourcen dauerhaft gelöscht, andernfalls werden Ressourcen in den konfigurierten Löschstatus verschoben.';
$lang["oj_reindex_field_refs_help"] = 'Diese Option beschränkt, welche Felder neu indexiert werden. Eine durch Kommas getrennte Liste kann verwendet werden, z.B. 1,3,5. Wenn keine Felder eingegeben werden, werden alle Felder neu indexiert.';
$lang["oj_checksums_recreate"] = 'Alle Checksums neu erstellen';
$lang["oj_checksums_recreate_help"] = 'Wenn diese Option aktiviert ist, werden alle Ressourcen-Checksums neu erstellt, nicht nur die, die derzeit keinen Checksum haben.';
$lang["oj_extracted_text_update_all"] = 'Auch aktualisieren, wenn bereits Daten vorhanden sind, und alte Werte überschreiben';
$lang["oj_extracted_text_collection_refs_help"] = 'Wenn diese Option aktiviert ist, werden nur Ressourcen in den aufgelisteten Sammlungen verarbeitet. Wenn keine Sammlungen angegeben sind, wird der extrahierte Text für alle geeigneten Ressourcen aktualisiert. Sammlungen können durch eine durch Kommas getrennte Liste sowie Bereiche angegeben werden, z.B. 100,105,110-115';
$lang["oj_extracted_text_update_all_help"] = 'Wenn diese Option aktiviert ist, wird die Extraktion auch bei vorhandenen Daten durchgeführt und der alte Wert überschrieben.';
$lang["requiredfield_multiple"] = 'Dies ist ein Pflichtfeld beim Ändern des Archivstatus';
$lang["reorder_invalid"] = 'Sammlung kann nur neu geordnet werden, wenn die Sortierreihenfolge die Sammlungssortierung ist';
$lang["reorder_permissions_fail"] = 'Sammlung kann nicht neu geordnet werden, da Sie keinen Zugriff auf alle Ressourcen in dieser Sammlung haben';
$lang["resource-card-menu-delete"] = 'Möchten Sie diese Ressource wirklich löschen?';
$lang["resource-card-menu-delete-button"] = 'Ja, Ressource löschen';
$lang["resource-card-menu-delete-perm"] = 'Sind Sie sicher? Diese Aktion kann nicht rückgängig gemacht werden.';
$lang["resource-card-menu-delete-perm-button"] = 'Ja, dauerhaft löschen';
$lang["blue"] = 'Blau';
$lang["green"] = 'Grün';
$lang["red"] = 'Rot';
$lang["purple"] = 'Lila';
$lang["fieldtype-geo_location"] = 'Geolokalisierung';
$lang["property-geomapping"] = 'Typ der Geolokalisierung';
$lang["information-geomapping"] = 'Speichern Sie die Geolokalisierung in diesem Feld als entweder Breite, Länge oder beides.<br \\/>Nur ein einzelnes Feld kann auf beides oder ein Feld auf jeweils Breite und Länge gesetzt werden.<br \\/>Nur für Einzeilige Textfelder verfügbar.';
$lang["disabled-geomapping-title"] = 'Geolokalisierung ist auf ein anderes Feld oder Felder eingestellt. Um es auf dieses Feld zu ändern, muss es aus anderen Feldern entfernt werden.';
$lang["geo_location-none"] = 'Keine';
$lang["geo_location-latitude"] = 'Breitengrad';
$lang["geo_location-longitude"] = 'Längengrad';
$lang["geo_location-both"] = 'Beides';
$lang["knowledgebase"] = 'Wissensdatenbank';
$lang["search_filter_panel_toggle"] = 'Suchfilter umschalten';
$lang["search_resources"] = 'Ressourcen durchsuchen';
$lang["clear_filters"] = 'Filter löschen';
$lang["save-error-invalid-latlong"] = 'Fehler beim automatischen Speichern - ungültige Geolokalisierung, Verwendung: Breite, Länge (z.B. 40.7128, -74.0060). Speicherort der Ressource wurde nicht aktualisiert.';
$lang["save-error-invalid-lat"] = 'Fehler beim automatischen Speichern - ungültiger Breitengrad, muss zwischen -90 und 90 liegen. Speicherort der Ressource wurde nicht aktualisiert.';
$lang["save-error-invalid-long"] = 'Fehler beim automatischen Speichern - ungültiger Längengrad, muss zwischen -180 und 180 liegen. Speicherort der Ressource wurde nicht aktualisiert.';
$lang["or"] = 'oder';
$lang["view_all_fcs"] = 'Alle hervorgehobenen Sammlungen anzeigen';
$lang["dashtile_upload"] = 'Ressourcen zu Ihrem System hinzufügen';
$lang["knowledgebase-tooltip"] = 'ResourceSpace (Wissensdatenbank) Dokumentation anzeigen';
$lang["noresources_collection"] = 'Keine Ressourcen in Sammlung';
$lang["hide_collection_bar"] = 'Versteckt';
$lang["minimal_collection_bar"] = 'Minimale Leiste';
$lang["thumbnails_collection_bar"] = 'Miniaturansichten';
$lang["language-bg"] = 'Bulgarisch';
$lang["language-zh-TW"] = 'Traditionelles Chinesisch';
