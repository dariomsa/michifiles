...
$lang['emailcollectionmessage'] = 'te ha enviado una colección de materiales via correo electrónico';
...
$lang['hasemailedyouaresource'] = 'te envió este material via correo electrónico';
$lang['haspostedresearchrequest'] = 'Enviaste una petición de material';
...
$lang['log-E'] = 'Compartir el recurso via correo electrónico con ';
...
$lang['matchingresources'] = 'materiales coincidentes';
...
$lang['newlogindetails'] = 'A continuación encontrarás los detalles de tu nuevo usuario.';
...
$lang['printallforyear'] = 'Imprimir todas las estadísticas de este año';
...
$lang['resourcesincollection'] = 'materiales en esta colección';
...
$lang['statisticsfor'] = 'Estadísticas del';
...
$lang['plugins-configvar'] = 'Setea la variable de configuración: $%cvn';
...
$lang['collectionlog-d'] = 'Material eliminado';
$lang['collectionlog-E'] = 'Enviar la colección por email a ';
...
$lang['collectionlog-S'] = 'Compartir colección con ';
$lang['collectionlog-s'] = 'Compartir material con';
$lang['collectionlog-T'] = 'Dejar de compartir colección con';
$lang['collectionlog-t'] = 'Detener el acceso al material por parte de';
...
$lang['error-oldphp'] = 'Requiere la versión de PHP %versión o superior.';
...
$lang['filetypenotsupported'] = 'tipo de archivo %EXTENSIONS no soportado';
...
$lang['enterantispamcode'] = 'Por favor ingrese el siguiente código';
...
$lang['edit_multiple_action_text_rt'] = 'Todo el texto / opción(es) será reemplazado con las siguientes palabras clave';
$lang['edit_multiple_action_text_ap'] = 'Estas palabras clave se agregarán';
$lang['edit_multiple_action_text_rm'] = 'Estas palabras clave serán eliminadas';
$lang['sortorder-asc'] = 'ASC';
$lang['sortorder-desc'] = 'DESCARGAR';
$lang['title'] = 'Título';
...
Para continuar teniendo el nombre del archivo de descarga formateado lo más cercano posible a la forma antigua, por favor actualice su sobrescritura de configuración con:
$download_filename_format = \'%format%\';';
$lang['upgrade_026_error_unable_to_set_config_system_wide'] = 'No se puede establecer la opción de configuración del sistema \'download_filename_format\' a \'%format%\'. Por favor, intente nuevamente de forma manual.';
$lang['upgrade_026_error_unable_to_process_deprecated_config_options'] = 'No se pueden procesar las opciones de configuración obsoletas para %entity%. Por favor, intente manualmente. Razón:-
...
$lang['email_actions_truncated'] = 'Solo se muestran las 1000 acciones más recientes aquí. Tienes [total] acciones. Inicia sesión en [application_name] para verlas todas.';
...
$lang['api-curl-help'] = 'El siguiente script de una línea de bash puede ejecutarse en cualquier sistema UNIX con OpenSSL y cURL instalados.';
$lang['share-password-not-set'] = 'Las comparticiones externas deben estar protegidas por una contraseña. Por favor, ingrese una contraseña para continuar.';
...
<a href="[url]">[url]</a><br /><br />
[text_footer]';
$lang['share_expired_icon_title'] = 'Vencido';
$lang['error_invalid_date_format'] = '"[value]" no es una fecha válida. Todos los valores en este campo deben estar formateados como AAAA-MM-DD';
$lang['related_resource_create'] = 'Crear nuevo recurso relacionado';
$lang['skip-to-main-content'] = 'Saltar al contenido principal';
$lang['cleanup_invalid_nodes'] = 'Limpiar datos de campo de tipos de recursos inválidos';
...
$lang['email_rate_limit_active'] = 'Se ha excedido el número máximo de correos electrónicos por hora enviados por este sistema. Actualmente, este sistema no está enviando correos electrónicos.';
$lang['email_rate_limit_inactive'] = 'El límite de correos electrónicos ha sido levantado y los correos electrónicos están siendo enviados.';
...
$lang['userlimitreached'] = 'Has alcanzado el límite de usuarios. Debes deshabilitar o eliminar un usuario existente antes de poder crear nuevas cuentas o habilitar cuentas existentes.';
...
$lang['missing_file'] = 'Este archivo falta. Por favor, contacta a tu administrador del sistema';
...
$lang['team_research__introtext'] = 'Organizar y gestionar \'Solicitudes de Investigación\'. <br /><br />Elija \'editar investigación\' para revisar los detalles de la solicitud y asignar la investigación a un miembro del equipo. Es posible basar una solicitud de investigación en una colección anterior ingresando el ID de la colección en la pantalla de \'editar\'. <br /><br />Una vez asignada la solicitud de investigación, elija \'editar colección\' para agregar la solicitud de investigación al panel de \'Colección Predeterminada\'. Usando las herramientas estándar, es posible agregar recursos a la investigación. <br /><br />Una vez que la investigación esté completa, elija \'editar investigación\', cambie el estado a completo y se enviará automáticamente un correo electrónico al usuario que solicitó la investigación. El correo electrónico contiene un enlace a la investigación y también se agrega automáticamente a su panel de \'Colección Predeterminada\'.';
$lang['themes__manage'] = 'Organizar y editar las colecciones destacadas disponibles en línea. Las colecciones destacadas son colecciones especialmente promocionadas. <br /><br /> <strong>1 Para crear una nueva entrada bajo una colección destacada - construir una colección</strong><br /> Elige <strong>Mis Colecciones</strong> desde el menú principal superior y configura una nueva colección <strong>pública</strong>. Recuerda incluir un nombre de colección destacada durante la configuración. Usa un nombre de colección destacada existente para agrupar la colección bajo una colección destacada actual (asegúrate de escribirlo exactamente igual), o elige un nuevo título para crear una nueva colección destacada. Nunca permitas que los usuarios agreguen/eliminan recursos de las colecciones destacadas. <br /> <br /><strong>2 Para editar el contenido de una entrada existente bajo una colección destacada </strong><br /> Elige <strong>editar colección</strong>. Los elementos en esa colección aparecerán en el panel de <strong>Mis Colecciones</strong> en la parte inferior de la pantalla. Usa las herramientas estándar para editar, eliminar o agregar recursos. <br /> <br /><strong>3 Para alterar el nombre de una colección destacada o mover una colección para que aparezca bajo una colección destacada diferente</strong><br /> Elige <strong>editar propiedades</strong> y edita la categoría de la colección destacada o el nombre de la colección. Usa un nombre de colección destacada existente para agrupar la colección bajo una colección destacada actual (asegúrate de escribirlo exactamente igual), o elige un nuevo título para crear una nueva colección destacada. <br /> <br /><strong>4 Para eliminar una colección de una colección destacada </strong><br /> Elige <strong>editar propiedades</strong> y elimina las palabras en el cuadro de categoría de colección destacada.';
$lang['confirmdeletefieldoption'] = '¿Está seguro de que desea ELIMINAR esta opción de campo?';
...
$lang['ui_removed_config_message'] = 'Esto ahora debe configurarse en el archivo de configuración como %variable';
$lang['language-bn'] = 'Bengalí';
$lang['language-fa'] = 'Persa';
$lang['language-pa'] = 'Panyabí';
$lang['language-sw'] = 'Swahili';
$lang['language-ur'] = 'Urdu';
$lang['information-enable_complete_indexing'] = 'Indexar los valores del campo como una palabra clave continua para este campo. Esta opción es incompatible con la indexación parcial.';
...
$lang['log-up'] = 'Imagen de vista previa cargada';
...
$lang['error_file_upload_cond-InvalidUploadPath'] = 'Ruta de carga inválida detectada';
$lang['error_file_upload_cond-SpecialFile'] = 'Archivo "especial" detectado que no está permitido';
$lang['error_file_upload_cond-InvalidExtension'] = 'Extensión inválida';
...
$lang['actions_myactions-tooltip'] = 'Ver acciones que requieren tu atención';
$lang['mymessages-tooltip'] = 'Lee y gestiona todos los mensajes enviados a ti';
$lang['my_jobs-tooltip'] = 'Verifica el estado de tus trabajos sin conexión';
...
$lang['managecontent-tooltip'] = 'Editar cualquier texto en la interfaz de usuario';
...
$lang['group_config_inherit'] = 'La configuración del grupo se hereda del grupo de usuarios padre. No hay nada que configurar aquí.';
$lang['property-group_preferences_inherit'] = 'Heredar del grupo padre';
$lang['property-sort_method'] = 'Método de ordenamiento';
$lang['information-sort_method'] = 'Ordenar para usar al mostrar los resultados de búsqueda ordenados por este campo.';
$lang['exiftoolconflictingversions'] = 'Se detectaron versiones conflictivas de Exiftool';
$lang['editgroupconfigoverrides'] = 'Editar configuraciones de grupo sobrescritas';
$lang['sort-method_default'] = 'Predeterminado - Alfanumérico';
$lang['sort-method_dot-notation'] = 'Número de acceso - notación de punto';
$lang['save-error-invalid'] = 'Error al guardar automáticamente - por favor revisa el contenido y vuelve a intentarlo';
$lang['fieldtitle-usergroup_config'] = 'Anulaciones de grupo';
$lang['page-title_usergroup_config'] = 'Editar configuraciones de grupo sobrescritas';
$lang['action-title_usergroup_override_detail'] = 'Cualquier configuración realizada aquí anulará los valores predeterminados del sistema para los usuarios en este grupo.';
$lang['team_resource_non_ingested_search'] = 'Ver recursos no ingeridos';
$lang['language-ms'] = 'Malayo';
$lang['language-tl'] = 'Filipino';
$lang['upgrade_028_notify_config_not_set'] = 'No se puede establecer la opción de configuración (a nivel del sistema) %name% en %value%';
$lang['annotate_tagging_fields'] = 'Campos de etiquetado';
$lang['annotate_text_adds_comment'] = 'Agregar comentario para anotaciones de texto de recursos. (N/A para anotaciones de campos de lista fija)';
$lang['annotate_public_view'] = '¿Son visibles las anotaciones públicamente (por ejemplo, comparticiones externas)?';
$lang['annotate_show_author'] = '¿Mostrar autor de la anotación?';
$lang['annotate_exclude_restypes'] = 'Tipos de recursos a excluir (marcar para excluir y no ser anotado)';
$lang['annotate_pseudo_rtf_comment_title'] = 'Comentarios (modo)';
$lang['annotorious_add_a_comment'] = 'Agregar un comentario...';
$lang['annotorious_type_to_search_field'] = 'Escriba para buscar...';
$lang['annotate_pdf_sheet_tool'] = 'Anotaciones PDF';
$lang['annotate_pdf_intro_text'] = 'Seleccione el tamaño de página para su PDF de Anotaciones.';
$lang['annotate_pdf_no_annotations'] = 'No hay anotaciones.';
$lang['statusinvalid'] = 'Inválido';
$lang['accessinvalid'] = 'Inválido';
$lang['requiredfields-status-required_fields'] = 'Los campos obligatorios deben completarse para cambiar el estado a %%STATUS%%. Por favor, complete los siguientes campos e intente nuevamente: %%FIELDS%%';
$lang['error_file_upload_cond-InvalidMimeType'] = 'Tipo MIME no válido';
$lang['error-edit_status_change_missing_required_fields'] = 'No es posible cambiar el estado de archivo de todos los recursos. Los siguientes recursos fueron omitidos ya que tienen datos faltantes en campos requeridos:';
$lang['missing_required_fields'] = 'Recursos con campos requeridos incompletos';
$lang['missing_required_fields_intro'] = 'Los recursos en la colección aparecen a continuación ordenados por campos requeridos incompletos.';
$lang['action_update_now'] = 'Actualizar ahora';
$lang['errors'] = 'Errores';
...
$lang['years'] = 'Años';
$lang['ago'] = 'hace';
$lang['action-selectresource'] = 'Seleccionar recurso';
$lang['addremove'] = 'Seleccionar';
$lang['expand'] = 'Expandir';
$lang['error_fieldidnotfound'] = 'Campo no encontrado.';
$lang['page-title_login'] = 'Iniciar sesión';
$lang['page-title_about'] = 'Acerca de Nosotros';
$lang['page-title_alternative_file'] = 'Archivo Alternativo';
$lang['page-title_alternative_files'] = 'Archivos Alternativos';
$lang['page-title_annotate_pdf_config'] = 'Anotar PDF';
$lang['page-title_annotate_pdf_gen'] = 'Anotar PDF';
$lang['page-title_api_test'] = 'API Test';
$lang['page-title_change_language'] = 'Cambiar idioma';
$lang['page-title_check'] = 'Verificación de Instalación';
$lang['page-title_collection_comment'] = 'Comentarios de la Colección';
$lang['page-title_collection_copy_resources'] = 'Copiar Recursos de Colección';
$lang['page-title_collection_download'] = 'Descarga de Colección';
$lang['page-title_collection_edit'] = 'Editar Colección';
$lang['page-title_collection_edit_previews'] = 'Editar Vistas de Colección';
$lang['page-title_collection_email'] = 'Colección de Correo Electrónico';
$lang['page-title_collection_feedback'] = 'Comentarios de la Colección';
$lang['page-title_collection_log'] = 'Registro de Colección';
$lang['page-title_collection_manage'] = 'Gestionar Colecciones';
$lang['page-title_collection_public'] = 'Colecciones Públicas';
$lang['page-title_collection_request'] = 'Solicitar Colección';
$lang['page-title_collection_set_category'] = 'Establecer Categoría de Colección';
$lang['page-title_collections_featured'] = 'Colecciones Destacadas';
$lang['page-title_collection_share'] = 'Compartir Colección';
$lang['page-title_collections'] = 'Colecciones';
$lang['page-title_contact'] = 'Contáctanos';
$lang['page-title_contactsheet_settings'] = 'Configuración de Hoja de Contacto';
$lang['page-title_content'] = 'Vista previa del contenido del sitio';
$lang['page-title_contribute'] = 'Contribuciones';
$lang['page-title_csv_export_results_metadata'] = 'Exportar CSV';
$lang['page-title_dash_tile'] = 'Editar mosaico de Dash';
$lang['page-title_done'] = 'Hecho';
$lang['page-title_download'] = 'Descargar';
$lang['page-title_download_progress'] = 'Progreso de Descarga';
$lang['page-title_download_usage'] = 'Descarga de uso';
$lang['page-title_edit_fields'] = 'Editar Campo de Metadatos';
$lang['page-title_edit'] = 'Editar Recurso';
$lang['page-title_geo_edit'] = 'Editar Ubicación';
$lang['page-title_geo_search'] = 'Búsqueda por ubicación';
$lang['page-title_graph'] = 'Gráfico';
$lang['page-title_help'] = 'Ayuda';
$lang['page-title_home'] = 'Dash';
$lang['page-title_job_details'] = 'Detalles del Trabajo Offline';
$lang['page-title_log_entry'] = 'Registro de Recursos';
$lang['page-title_log'] = 'Registro de Recursos';
$lang['page-title_manage_external_shares'] = 'Gestionar Compartidos';
$lang['page-title_manage_jobs'] = 'Gestionar Trabajos Fuera de Línea';
$lang['page-title_metadata_download'] = 'Descargar Metadatos';
$lang['page-title_mp3_play'] = 'Reproducir archivo de audio';
$lang['page-title_no_uploads'] = 'Cargando no disponible';
$lang['page-title_preview'] = 'Vista previa';
$lang['page-title_request_log'] = 'Registro de Solicitudes';
$lang['page-title_requests'] = 'Solicitudes';
$lang['page-title_research_request'] = 'Solicitud de Investigación';
$lang['page-title_resource_collection_list'] = 'Lista de Colecciones';
$lang['page-title_resource_email'] = 'Enviar Recurso';
$lang['page-title_resource_request'] = 'Solicitar Recurso';
$lang['page-title_resource_share'] = 'Compartir Recurso';
$lang['page-title_search_advanced'] = 'Búsqueda Avanzada';
$lang['page-title_search_disk_usage'] = 'Uso del disco';
$lang['page-title_search'] = 'Buscar';
$lang['page-title_setup'] = 'Configuración';
$lang['page-title_share_access'] = 'Compartir Acceso';
$lang['page-title_share_upload'] = 'Cargar Compartir';
$lang['page-title_simple_search'] = 'Buscar';
$lang['page-title_system_down'] = 'Sistema Caído';
$lang['page-title_terms'] = 'Términos de Uso';
$lang['page-title_themes'] = 'Colecciones Destacadas';
$lang['page-title_upload_batch'] = 'Cargar Recursos';
$lang['page-title_upload_preview'] = 'Cargar Vista Previa';
$lang['page-title_upload_replace_batch'] = 'Reemplazar Recursos por Lotes';
$lang['page-title_user_password'] = 'Cambiar Contraseña';
$lang['page-title_user_ratings'] = 'Estadísticas de Calificación de Usuario para el Recurso';
$lang['page-title_user_request'] = 'Solicitar Usuario';
$lang['page-title_video_player'] = 'Reproductor de Video';
$lang['page-title_view_alternative_files'] = 'Ver Archivo Alternativo';
$lang['page-title_view_metadata'] = 'Ver Metadatos del Recurso';
$lang['page-title_view'] = 'Ver Recurso';
$lang['page-title_view_shares'] = 'Ver Compartir';
$lang['page-title_admin_content_edit'] = 'Editar Contenido del Sitio';
$lang['page-title_admin_content'] = 'Contenido del Sitio';
$lang['page-title_admin_copy_field'] = 'Copiar Campo de Tipo de Recurso';
$lang['page-title_admin_download_config'] = 'Descargar Configuración del Sistema';
$lang['page-title_admin_filter_edit'] = 'Editar Filtro';
$lang['page-title_admin_filter_manage'] = 'Gestionar Filtro';
$lang['page-title_admin_group_config_edit'] = 'Editar Configuraciones de Sobrescritura del Grupo de Usuarios';
$lang['page-title_admin_group_management_edit'] = 'Editar Grupo de Usuario';
$lang['page-title_admin_group_management'] = 'Grupos de Usuarios';
$lang['page-title_admin_group_permissions'] = 'Editar Permisos del Grupo de Usuarios';
$lang['page-title_admin_home'] = 'Menú del sistema';
$lang['page-title_admin_manage_field_options'] = 'Gestionar Opciones de Campo';
$lang['page-title_admin_manage_slideshow'] = 'Gestionar presentación de diapositivas';
$lang['page-title_admin_report_management_edit'] = 'Editar Informe';
$lang['page-title_admin_report_management'] = 'Gestionar Informes';
$lang['page-title_admin_resource_type_edit'] = 'Editar Tipo de Recurso';
$lang['page-title_admin_resource_type_field_edit'] = 'Editar Campo de Tipo de Recurso';
$lang['page-title_admin_resource_type_fields'] = 'Campos de Tipo de Recurso';
$lang['page-title_admin_resource_types'] = 'Tipos de Recursos';
$lang['page-title_admin_size_management_edit'] = 'Editar tamaño de imagen';
$lang['page-title_admin_size_management'] = 'Tamaños de imagen';
$lang['page-title_admin_system_config'] = 'Configuración del Sistema';
$lang['page-title_admin_system_log'] = 'Registro del Sistema';
$lang['page-title_admin_system_performance'] = 'Rendimiento del Sistema';
$lang['page-title_tabs'] = 'Gestionar Pestañas';
$lang['page-title_team_analytics_edit'] = 'Editar Informe de Analíticas';
$lang['page-title_team_analytics'] = 'Informe de Análisis';
$lang['page-title_team_archive'] = 'Archivar Recursos';
$lang['page-title_team_copy'] = 'Copiar Recurso';
$lang['page-title_team_dash_admin'] = 'Gestionar Dash';
$lang['page-title_team_dash_tile'] = 'Azulejos del Tablero';
$lang['page-title_team_dash_tile_special'] = 'Crear Azulejo de Tablero Especial';
$lang['page-title_team_export'] = 'Exportar Datos del Sistema';
$lang['page-title_team_external_shares'] = 'Gestionar Comparticiones Externas';
$lang['page-title_team_home'] = 'Menú de Administración';
$lang['page-title_team_mail'] = 'Enviar Correo Masivo';
$lang['page-title_team_plugins_groups'] = 'Gestionar el acceso al plugin de grupo de usuarios';
$lang['page-title_team_plugins'] = 'Gestionar Plugins';
$lang['page-title_team_related_keywords_edit'] = 'Editar Palabras Clave Relacionadas';
$lang['page-title_team_related_keywords'] = 'Palabras Clave Relacionadas';
$lang['page-title_team_report'] = 'Ver Informe';
$lang['page-title_team_request_edit'] = 'Editar Solicitud';
$lang['page-title_team_request'] = 'Solicitudes';
$lang['page-title_team_research_edit'] = 'Editar Solicitud de Investigación';
$lang['page-title_team_research'] = 'Solicitud de Investigación';
$lang['page-title_team_resource'] = 'Menú de Recursos';
$lang['page-title_team_user_edit'] = 'Editar Usuario';
$lang['page-title_team_user'] = 'Gestionar Usuarios';
$lang['page-title_team_user_purge'] = 'Eliminar Usuarios';
$lang['page-title_user_actions'] = 'Acciones del Usuario';
$lang['page-title_user_api_session'] = 'Acceso a la API del Sistema Remoto';
$lang['page-title_user_change_password'] = 'Cambiar Contraseña';
$lang['page-title_user_dash_admin'] = 'Gestionar el Panel de Usuario';
$lang['page-title_user_home'] = 'Menú de Usuario';
$lang['page-title_user_message'] = 'Mensaje del usuario';
$lang['page-title_user_messages'] = 'Mensajes de Usuario';
$lang['page-title_user_preferences'] = 'Preferencias del Usuario';
$lang['page-title_user_profile_edit'] = 'Mi Perfil';
$lang['page-title_user_profile'] = 'Perfil de Usuario';
$lang['backtomessages'] = 'Volver a Mensajes';
$lang['viewallmessages'] = 'Ver todos los mensajes';
$lang['min_ago'] = 'hace %TIME% minutos';
$lang['mins_ago'] = 'hace %TIME% minutos';
$lang['hour_ago'] = 'hace %TIME% horas';
$lang['hours_ago'] = 'hace %TIME% horas';
$lang['day_ago'] = 'hace %TIME% días';
$lang['days_ago'] = 'hace %TIME% días';
$lang['week_ago'] = 'hace %TIME% semanas';
$lang['weeks_ago'] = 'hace %TIME% semanas';
$lang['month_ago'] = 'hace %TIME% meses';
$lang['months_ago'] = 'hace %TIME% meses';
$lang['random'] = 'Aleatorio';
$lang['log-sf'] = 'Archivo de Staticsync modificado';
$lang['log_code_J'] = 'Trabajo añadido';
$lang['log_code_JC'] = 'Trabajo completado';
$lang['log_code_JD'] = 'Trabajo eliminado';
$lang['email_username'] = 'Correo electrónico / nombre de usuario';
$lang['request_new_password'] = 'Si olvidaste tu contraseña, usa el enlace a continuación para solicitar una nueva.';
$lang['enter_username_or_email'] = 'Ingresa un nombre de usuario o dirección de correo electrónico';
$lang['enter_a_password'] = 'Ingresa una contraseña';
$lang['enter_a_full_name'] = 'Ingresa un nombre completo';
$lang['enter_an_email_address'] = 'Ingresa una dirección de correo electrónico';
$lang['new_to_resourcespace'] = '¿Nuevo en [applicationname]?';
$lang['show_password'] = 'Mostrar contraseña';
$lang['hide_password'] = 'Ocultar contraseña';
$lang['select_a_user_group'] = 'Selecciona un grupo de usuarios';
$lang['back_to_login'] = 'Volver a iniciar sesión';
$lang['required'] = 'requerido';
$lang['select_a'] = 'Selecciona un';
$lang['notsharableresources'] = 'Los siguientes recursos no son compartibles por este usuario y no pueden ser añadidos a una colección compartida: ';
$lang['antispam'] = 'Anti-Spam';
$lang['comments_body-placeholder-anon'] = 'Agrega un comentario.';
$lang['batch_replace_alternatives'] = 'Reemplazar archivos originales o archivos alternativos';
$lang['batch_replace_upload_resources'] = 'Archivos originales';
$lang['batch_replace_upload_alternatives'] = 'Archivos alternativos';
$lang['userpreference_user_interface'] = 'Interfaz de usuario';
$lang['systemconfig_watermark_open'] = 'Aplicar marca de agua a miniatura / vista previa para grupos con permiso "w" incluso cuando el acceso sea "Abierto"';
$lang['systemconfig_watermark_open_search'] = 'Si se aplica marca de agua a miniatura / vista previa (opción anterior), también aplicar la marca de agua a la página de búsqueda';
$lang['systemconfig_minyear'] = 'Fecha más antigua para incluir en el selector de fechas en el formulario de búsqueda. Normalmente año de la primera carga';
$lang['systemconfig_searchbyday'] = 'Incluir día en la búsqueda además de mes/año';
$lang['systemconfig_default_collection_sort'] = 'Orden de clasificación predeterminado al ver recursos de la colección. Cuando los usuarios esperan que los recursos se muestren en el orden en que fueron proporcionados, esto debe ser colección';
$lang['systemconfig_systemconfig_searchbyday'] = 'Mostrar el estado del flujo de trabajo del recurso (ícono y texto) en los resultados de búsqueda cuando esté en modo de visualización en miniatura';
$lang['systemconfig_category_tree_search_use_and'] = 'Seleccionar un valor en un árbol de categorías en la página de búsqueda seleccionará automáticamente todos los valores principales';
$lang['systemconfig_category_tree_search_use_and_logic'] = 'Todos los valores seleccionados en el árbol de categorías deben estar presentes para que la búsqueda devuelva resultados (no seleccionar ninguno para encontrar coincidencias con cualquier valor seleccionado)';
$lang['systemconfig_recent_search_quantity'] = 'Número de recursos a mostrar con enlaces a Recientes y Ver material nuevo';
$lang['systemconfig_general'] = 'General';
$lang['systemconfig_date_yyyy'] = 'Mostrar año en formato de cuatro dígitos';
$lang['systemconfig_imperial_measurements'] = 'Usar sistema imperial en lugar del métrico para las directrices de tamaño de descarga';
$lang['systemconfig_site_text_custom_create'] = 'Permitir la creación de nuevas entradas de texto del sitio desde Gestionar contenido (destinado a desarrollar nuevas páginas)';
$lang['systemconfig_no_welcometext'] = 'Ocultar texto de bienvenida en la página principal';
$lang['systemconfig_internal_preview_sizes_editable'] = 'Permitir edición de tamaños internos';
$lang['systemconfig_edit_autosave'] = 'Guardar automáticamente los cambios en la página de edición. Si no, se debe usar el botón Guardar';
$lang['systemconfig_resource_request_reason_required'] = 'Al solicitar un recurso o recursos, el campo "Razón de la solicitud" es obligatorio';
$lang['systemconfig_research_request'] = 'Habilitar la funcionalidad de Solicitud de investigación';
$lang['systemconfig_custom_access'] = 'Habilitar nivel de "acceso personalizado" para control adicional del acceso a recursos';
$lang['systemconfig_enable_related_resources'] = 'Habilitar el campo "Recursos relacionados" al editar recursos.';
$lang['systemconfig_user_accounts'] = 'Cuentas de usuario';
$lang['systemconfig_inactive_user_disable_days'] = 'Desactivar automáticamente usuarios inactivos después de un número establecido de días (0 desactiva esta función)';
$lang['systemconfig_sharing'] = 'Compartir';
$lang['systemconfig_external_share_groups_config_options'] = 'Respetar las opciones de configuración del grupo al compartir externamente como un grupo de usuarios específico';
$lang['systemconfig_resource_share_expire_days_default'] = 'Número predeterminado de días para seleccionar la expiración del compartido (establecer 0 para usar la primera opción)';
$lang['systemconfig_restricted_share'] = '¿Deben poder compartir los recursos aquellos con acceso "restringido" a un recurso?';
$lang['systemconfig_blank_edit_template'] = 'Al subir recursos (carga masiva) y editar la plantilla, restablecer los valores a en blanco o al valor predeterminado cada vez';
$lang['systemconfig_enable_copy_data_from'] = 'Al cargar en masa, habilitar la función "Copiar datos del recurso existente"';
$lang['systemconfig_resource_view'] = 'Vista del recurso';
$lang['systemconfig_show_resourceid'] = 'Mostrar el ID del recurso en la página de vista';
$lang['systemconfig_show_resource_type'] = 'Mostrar el tipo de recurso en la página de vista';
$lang['systemconfig_show_access_field'] = 'Mostrar acceso al recurso en la página de vista';
$lang['systemconfig_show_contributed_by'] = 'Mostrar el usuario "contribuido por" en la página de vista';
$lang['systemconfig_show_related_themes'] = 'Mostrar colecciones relacionadas y panel de colecciones públicas en la vista';
$lang['systemconfig_metadata_download'] = 'Mostrar opción "Descargar metadatos" en la vista';
$lang['systemconfig_uploading'] = 'Subiendo';
$lang['systemconfig_upload_add_to_new_collection'] = 'La opción "Agregar a Nueva Colección" se usará para cargas masivas. Desactivarla para que predetermine "No agregar a la colección"';
$lang['systemconfig_upload_add_to_new_collection_opt'] = 'Para cargas masivas, habilitar la opción "Agregar a Nueva Colección"';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = 'Para cargas masivas, habilitar la opción "No agregar a la Nueva Colección" (si no está habilitada, forzará la carga a una colección)';
$lang['systemconfig_upload_collection_name_required'] = 'Requiere que se ingrese un nombre de colección para cargas masivas. Anulará el comportamiento predeterminado de Upload[timestamp]';
$lang['systemconfig_allow_password_change'] = 'Permitir cambio de contraseña';
$lang['systemconfig_allow_password_reset'] = 'Permitir a los usuarios solicitar una nueva contraseña desde la pantalla de inicio de sesión';
$lang['systemconfig_allow_keep_logged_in'] = 'Mostrar opción "Mantenerme conectado en este dispositivo" en la pantalla de inicio de sesión';
$lang['systemconfig_remember_me_checked'] = 'Opción "Mantenerme conectado en este dispositivo" seleccionada por defecto';
$lang['systemconfig_session_length'] = 'Duración de la sesión del usuario (minutos)';
$lang['systemconfig_session_autologout'] = 'Cerrar sesión automáticamente al finalizar la sesión (tiempo inactivo igual a la duración de la sesión)';
$lang['systemconfig_slideshow_photo_delay'] = 'Número de segundos que la presentación de diapositivas esperará antes de cambiar la imagen';
$lang['config_integer_invalid_range'] = 'Valor inválido. Ingrese un número entre %MIN% y %MAX%';
$lang['alternative_file_replaced'] = 'Archivo alternativo reemplazado con éxito';
$lang['jq_create_alt_previews_success_text'] = 'Previsualizaciones creadas para el archivo alternativo #%ALTFILE con éxito';
$lang['jq_create_alt_previews_failure_text'] = 'Error al crear previsualizaciones para el archivo alternativo #%ALTFILE';
$lang['error_report_execution'] = 'Ocurrió un error al ejecutar el informe, por favor verifique que la consulta sea válida';
$lang['error_save_not_allowed_dash_tile_set_public'] = 'No se pudo guardar el cambio. Asegúrese de que no haya fichas de tablero configuradas para todos o varios usuarios vinculados a esta colección';
$lang['error_upload_replace_alternative_file_not_found'] = 'No se pudo actualizar el archivo alternativo. No se encontró un registro de archivo alternativo que coincida con el nombre de archivo [filename]';
$lang['error_upload_replace_alternative_multiple_found'] = 'No se pudo actualizar el archivo alternativo. Se encontraron múltiples registros de archivos alternativos que coinciden con el nombre de archivo [filename], limite por ID de recurso o colección';
$lang['oj-batch-replace-local-alternatives-success-text'] = 'La sustitución en masa ha reemplazado con éxito %TOTALFILES archivos alternativos';
$lang['replacebatch_collection_alternatives'] = 'Ingrese un ID de colección si solo desea agregar o reemplazar archivos alternativos en recursos dentro de esta colección';
$lang['replacebatch_resource_min_alternatives'] = 'ID de recurso más bajo para reemplazar archivos alternativos (se ignora si se especifica una colección)';
$lang['replacebatch_resource_max_alternatives'] = 'ID de recurso más alto para reemplazar archivos alternativos';
$lang['system_config_search_engines'] = 'Motores de búsqueda';
$lang['int_ranges_empty'] = 'La entrada está vacía';
$lang['int_ranges_range_below_1'] = 'Los números deben ser 1 o mayores en el rango %%PART%%';
$lang['int_ranges_range_reversed'] = 'El inicio del rango %%PART%% no puede ser mayor que el final';
$lang['int_ranges_range_above_max'] = 'El rango %%PART%% excede el número máximo de %%MAX_VAL%%';
$lang['int_ranges_single_below_1'] = 'Los números deben ser 1 o mayores (%%PART%%)';
$lang['int_ranges_single_above_max'] = '%%PART%% excede el número máximo de %%MAX_VAL%%';
$lang['int_ranges_not_valid'] = '%%PART%% no es un número válido ni un rango (use formatos como 3 o 5-9)';
$lang['job_trigger'] = 'Iniciar un trabajo';
$lang['job_configure'] = 'Configurar trabajo';
$lang['jobs_action_stream_log'] = 'Transmitir archivo de registro';
$lang['jobs_action_download_log'] = 'Descargar archivo de registro';
$lang['jobs_action_not_started'] = 'El trabajo aún no ha comenzado';
$lang['jobs_action_missing_job_progress'] = 'No se puede cargar el progreso del trabajo';
$lang['job_action_not_found'] = 'Trabajo no encontrado.';
$lang['job_list_core'] = 'Núcleo';
$lang['job_list_recreate_previews'] = 'Recrear vistas previas';
$lang['job_list_exif_data'] = 'Regenerar datos EXIF';
$lang['job_list_purge_duplicates'] = 'Eliminar recursos duplicados';
$lang['job_list_reindex'] = 'Reindexar datos';
$lang['job_list_checksums'] = 'Actualizar sumas de verificación';
$lang['job_list_extracted_text'] = 'Actualizar texto extraído';
$lang['oj_common_create_job'] = 'Crear trabajo';
$lang['oj_common_field_refs'] = 'Referencias de campos';
$lang['oj_common_collection_refs'] = 'Referencias de colecciones';
$lang['oj_common_error_required'] = 'Campo requerido';
$lang['oj_common_error_invalid'] = 'Valor inválido pasado para el campo';
$lang['oj_common_error_invalid_field_ref'] = '%FIELD_REF% no se refiere a un campo válido';
$lang['oj_recreate_previews_target'] = '¿Qué tipo de referencias se proporcionan?';
$lang['oj_recreate_previews_refs'] = 'Referencias';
$lang['oj_recreate_previews_image_sizes'] = 'Tamaños de imagen a generar';
$lang['oj_recreate_previews_resource_types'] = 'Tipos de recursos a targetear';
$lang['oj_recreate_previews_use_existing'] = '¿Usar vistas previas cargadas existentes?';
$lang['oj_recreate_previews_video_update'] = '¿Actualizar vistas previas de todos los recursos de video que no tengan la extensión \'$ffmpeg_preview_extension\' requerida?';
$lang['oj_recreate_previews_delete_existing'] = 'Eliminar todas las vistas previas existentes';
$lang['oj_recreate_previews_refs_help'] = 'Configurar esta opción controla qué referencias (ya sea referencia de recurso o de colección) se usarán para el procesamiento. Las entradas válidas incluyen listas separadas por comas, rangos y comodines, por ejemplo * procesaría todas las referencias, 1-100 procesaría las primeras 100 referencias, 101-* procesaría referencias 101 en adelante y 1,3,5 procesaría referencias 1, 3 y 5. Estas pueden combinarse para targetear exactamente las referencias requeridas, por ejemplo 1,5-10,15-* targetearía 1, 5 a 10 y 15 en adelante.';
$lang['oj_recreate_previews_use_existing_help'] = 'Configurar esta opción intentará preservar las vistas previas que hayan sido reemplazadas manualmente en los recursos. Si no se usa, las vistas previas cargadas manualmente serán reemplazadas por vistas derivadas del archivo original.';
$lang['oj_recreate_previews_video_update_help'] = 'Configurar esta opción actualizará cualquier video que no coincida con la extensión \'$ffmpeg_preview_extension\' configurada actualmente. Esto es útil cuando se ha cambiado esta configuración, para targetear solo aquellos recursos que necesitan una nueva vista previa.';
$lang['oj_recreate_previews_delete_existing_help'] = 'Configurar esta opción eliminará todas las vistas previas existentes antes de recrearlas.';
$lang['oj_exif_data_blanks'] = 'Valor de campo en blanco donde no exista datos EXIF';
$lang['oj_exif_data_overwrite'] = 'Sobrescribir valores de campo existentes donde existan datos EXIF';
$lang['oj_exif_data_field_refs_help'] = 'Estas son las referencias de los campos para los cuales desea extraer datos EXIF. Estos campos deben tener "Campo Exiftool" configurado. Se puede usar una lista separada por comas para especificar los campos, por ejemplo 1,3,5.';
$lang['oj_exif_data_collection_refs_help'] = 'Configurar esta opción significará que solo los recursos en las colecciones listadas serán actualizados. Si no se especifican colecciones, los datos EXIF se actualizarán para TODOS los recursos adecuados. Las colecciones pueden especificarse usando una lista separada por comas así como rangos, por ejemplo 100,105,110-115.';
$lang['oj_exif_data_blanks_help'] = 'Configurar esta opción hará que el campo especificado se limpie si el archivo no tiene datos EXIF incrustados para él.';
$lang['oj_exif_data_overwrite_help'] = 'Configurar esta opción hará que el campo especificado tenga cualquier valor existente sobrescrito por datos EXIF incrustados, si están presentes en el archivo.';
$lang['oj_purge_duplicates_intro'] = '<strong>Advertencia: Este script permite eliminar recursos de forma PERMANENTE - por favor, usa la opción de prueba en seco para validar tus configuraciones si no estás seguro.</strong>';
$lang['oj_purge_duplicates_manage_method'] = 'Método de gestión';
$lang['oj_purge_duplicates_lifo'] = 'Mantener los más antiguos y eliminar los duplicados más recientes';
$lang['oj_purge_duplicates_fifo'] = 'Mantener los más nuevos y eliminar los duplicados más antiguos';
$lang['oj_purge_duplicates_dry_run'] = 'Prueba en seco';
$lang['oj_purge_duplicates_delete_perm'] = 'Eliminar permanentemente';
$lang['oj_purge_duplicates_delete_error'] = 'La eliminación permanente no es posible durante una prueba en seco';
$lang['oj_purge_duplicates_collection_refs_help'] = 'Establece las colecciones como el alcance de la detección de duplicados. No es necesario que todos los duplicados estén en las colecciones, solo uno de ellos será suficiente. Los duplicados se procesarán a nivel del sistema y se purgarán mediante el método de gestión seleccionado. Las colecciones pueden especificarse usando una lista separada por comas así como rangos, por ejemplo 100,105,110-115.';
$lang['oj_purge_duplicates_manage_method_help'] = 'Configurar esta opción controla cómo el script manejará la eliminación de duplicados.';
$lang['oj_purge_duplicates_dry_run_help'] = 'Configurar esta opción realizará una prueba sin hacer cambios en ningún recurso. El archivo de registro con los resultados de la prueba puede descargarse para revisión.';
$lang['oj_purge_duplicates_delete_perm_help'] = 'Configurar esta opción hará que los recursos duplicados se eliminen permanentemente, de lo contrario, los recursos se moverán al estado de eliminación configurado.';
$lang['oj_reindex_field_refs_help'] = 'Configurar esta opción limitará qué campos se reindexarán, se puede usar una lista separada por comas para especificar los campos, por ejemplo 1,3,5. Si no se ingresan campos, TODOS los campos serán reindexados.';
$lang['oj_checksums_recreate'] = 'Recrear todas las sumas de verificación';
$lang['oj_checksums_recreate_help'] = 'Configurar esta opción forzará a que TODAS las sumas de verificación de recursos se vuelvan a crear en lugar de solo aquellas que actualmente no tengan una suma de verificación existente.';
$lang['oj_extracted_text_update_all'] = 'Actualizar incluso si ya existe datos, y sobrescribir valores antiguos';
$lang['oj_extracted_text_collection_refs_help'] = 'Configurar esta opción limitará los recursos procesados a aquellos en las colecciones listadas únicamente. Si no se especifican colecciones, el texto extraído se actualizará para TODOS los recursos adecuados. Las colecciones pueden especificarse usando una lista separada por comas así como rangos, por ejemplo 100,105,110-115.';
$lang['oj_extracted_text_update_all_help'] = 'Configurar esta opción ejecutará la extracción incluso si ya hay datos existentes, y sobrescribirá el valor antiguo.';
$lang['requiredfield_multiple'] = 'Este es un campo requerido al cambiar el estado del archivo';
$lang['reorder_invalid'] = 'La colección no puede reordenarse a menos que el orden de clasificación sea por orden de colección';
$lang['reorder_permissions_fail'] = 'La colección no puede reordenarse ya que no tienes acceso a todos los recursos en esta colección';
$lang['resource-card-menu-delete'] = '¿Estás seguro de que deseas eliminar este recurso?';
$lang['resource-card-menu-delete-button'] = 'Sí, eliminar recurso';
$lang['resource-card-menu-delete-perm'] = '¿Estás seguro? Esta acción no se puede revertir.';
$lang['resource-card-menu-delete-perm-button'] = 'Sí, eliminar permanentemente';
$lang['blue'] = 'Azul';
$lang['green'] = 'Verde';
$lang['red'] = 'Rojo';
$lang['purple'] = 'Morado';
$lang['fieldtype-geo_location'] = 'Geolocalización';
$lang['property-geomapping'] = 'Tipo de geolocalización';
$lang['information-geomapping'] = 'Almacene la geolocalización en este campo como latitud, longitud o ambos.<br \\/>Solo se puede configurar un campo para ambos o un campo para cada uno.<br \\/>Disponible solo para campos de texto de línea única.';
$lang['disabled-geomapping-title'] = 'La geolocalización está configurada en un campo diferente o en campos diferentes, para cambiarla a este campo debe eliminarse de otros campos';
$lang['geo_location-none'] = 'Ninguno';
$lang['geo_location-latitude'] = 'Latitud';
$lang['geo_location-longitude'] = 'Longitud';
$lang['geo_location-both'] = 'Ambos';
$lang['knowledgebase'] = 'Base de conocimientos';
$lang['search_filter_panel_toggle'] = 'Alternar filtros de búsqueda';
$lang['search_resources'] = 'Buscar recursos';
$lang['clear_filters'] = 'Borrar filtros';
$lang['save-error-invalid-latlong'] = 'Error al guardar automáticamente - geolocalización inválida, Use: latitud, longitud (ej. 40.7128, -74.0060). La ubicación del recurso no ha sido actualizada.';
$lang['save-error-invalid-lat'] = 'Error al guardar automáticamente - latitud de geolocalización inválida, debe estar entre -90 y 90. La ubicación del recurso no ha sido actualizada.';
$lang['save-error-invalid-long'] = 'Error al guardar automáticamente - longitud de geolocalización inválida, debe estar entre -180 y 180. La ubicación del recurso no ha sido actualizada.';
$lang['or'] = 'o';
$lang['view_all_fcs'] = 'Ver todas las colecciones destacadas';
$lang['dashtile_upload'] = 'Agregar recursos a tu sistema';
$lang['knowledgebase-tooltip'] = 'Ver la documentación de ResourceSpace (Base de conocimientos)';
$lang['noresources_collection'] = 'No hay recursos en la colección';
$lang['hide_collection_bar'] = 'Oculto';
$lang['minimal_collection_bar'] = 'Barra mínima';
$lang['thumbnails_collection_bar'] = 'Miniaturas';
$lang['language-bg'] = 'Búlgaro';
$lang['language-zh-TW'] = 'Chino tradicional';

$lang["home__welcometext"] = 'El principal sistema de gestión de activos digitales empresarial de código abierto.';
$lang["language-ku"] = 'Kurdo';