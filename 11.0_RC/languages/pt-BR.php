...
$lang['upload_failed_for_path'] = 'Envio falhou para %path%';
...
$lang['emailcollectionmessage'] = 'enviou um coleção por email para você com o conteúdo do [applicationname]. Esta coleção foi adicionada à sua página "Minhas Coleções".';
...
$lang['rightclicktodownload'] = 'Clique com o botão direito do mouse e escolha "Salvar Como..." para baixar o conteúdo...';
...
$lang['matchingresources'] = 'conteúdos';
...
$lang['youfound'] = 'Você encontrou';
$lang['youfoundresources'] = 'conteúdos';
...
$lang['hasemailedyouaresource'] = 'enviou um email com conteúdo para você.';
...
$lang['unassigned'] = 'Não Associada';
$lang['requeststatus0'] = 'Não Associada';
...
$lang['haspostedresearchrequest'] = 'enviou uma requisição de pesquisa';
...
$lang['newlogindetails'] = 'Os detalhes da sua conta estão abaixo.';
$lang['youraccountdetails'] = 'Detalhes da Conta';
$lang['copyfromcollection'] = 'Copiar da coleção';
$lang['donotcopycollection'] = 'Não copiar da coleção';
$lang['resourcesincollection'] = 'conteúdos nesta coleção';
...
$lang['collectionlog-d'] = 'Conteúdo apagado';
...
$lang['information-sort_method'] = 'Ordem a ser usada ao exibir os resultados da pesquisa ordenados por este campo.';
$lang['exiftoolconflictingversions'] = 'Versões conflitantes do Exiftool detectadas';
$lang['editgroupconfigoverrides'] = 'Editar substituições de configuração do grupo';
...
$lang['action-title_usergroup_override_detail'] = 'Qualquer configuração feita aqui substituirá as configurações padrão do sistema para os usuários deste grupo.';
$lang['team_resource_non_ingested_search'] = 'Visualizar recursos não ingeridos';
...
$lang['page-title_csv_export_results_metadata'] = 'Exportação CSV';
$lang['page-title_dash_tile'] = 'Editar bloco do painel';
$lang['page-title_done'] = 'Concluído';
...
$lang['page-title_preview'] = 'Prévia';
...
$lang['page-title_admin_download_config'] = 'Configuração do Sistema de Download';
$lang['page-title_admin_filter_edit'] = 'Editar Filtro';
$lang['page-title_admin_filter_manage'] = 'Gerenciar Filtro';
$lang['page-title_admin_group_config_edit'] = 'Editar Configurações de Sobrescrita do Grupo de Usuários';
...
$lang['page-title_team_dash_admin'] = 'Gerenciar Painel';
$lang['page-title_team_dash_tile'] = 'Azulejos do Painel';
$lang['page-title_team_dash_tile_special'] = 'Criar Tile de Painel Especial';
...
$lang['page-title_team_mail'] = 'Enviar E-mail em Massa';
...
$lang['systemconfig_category_tree_search_use_and'] = 'Selecionar um valor em uma árvore de categorias na página de pesquisa selecionará automaticamente todos os valores pai';
...
$lang['systemconfig_resource_share_expire_days_default'] = 'Número padrão de dias para selecionar para expiração do compartilhamento (defina 0 para usar a primeira opção)';
$lang['systemconfig_restricted_share'] = 'Aqueles com acesso "restrito" a um recurso podem compartilhar o recurso';
$lang['systemconfig_blank_edit_template'] = 'Ao fazer upload de recursos (upload em lote) e editar o modelo, redefinir valores para vazio ou o valor padrão toda vez';
$lang['systemconfig_enable_copy_data_from'] = 'Ao fazer upload em lote, habilitar o recurso "Copiar dados do recurso existente"';
...
$lang['systemconfig_upload_collection_name_required'] = 'Exigir que um nome de coleção seja inserido para uploads em lote. Substituirá o comportamento padrão do Upload[timestamp]';
...
$lang['systemconfig_session_autologout'] = 'Encerrar automaticamente a sessão do usuário ao final da sessão (tempo ocioso igual à duração da sessão)';
...
$lang['jq_create_alt_previews_failure_text'] = 'Falha ao criar pré-visualizações para arquivo alternativo #%ALTFILE';
$lang['error_report_execution'] = 'Ocorreu um erro ao executar o relatório, por favor, verifique se a consulta é válida';
$lang['error_save_not_allowed_dash_tile_set_public'] = 'Não foi possível salvar a alteração. Certifique-se de que não há painéis de dash configurados para todos ou múltiplos usuários vinculados a esta coleção';
$lang['error_upload_replace_alternative_file_not_found'] = 'Falha ao atualizar arquivo alternativo. Nenhum registro de arquivo alternativo correspondente encontrado com o nome de arquivo [filename]';
$lang['error_upload_replace_alternative_multiple_found'] = 'Falha ao atualizar arquivo alternativo. Foram encontrados múltiplos registros de arquivo alternativo correspondentes com o nome de arquivo [filename], limite por ID de recurso ou coleção';
$lang['oj-batch-replace-local-alternatives-success-text'] = 'Substituição em lote realizada com sucesso. Foram substituídos %TOTALFILES arquivos alternativos';
...
$lang['int_ranges_range_below_1'] = 'Números devem ser 1 ou maiores na faixa %%PART%%';
$lang['int_ranges_range_reversed'] = 'Início da faixa %%PART%% não pode ser maior que o fim';
$lang['int_ranges_range_above_max'] = 'Faixa %%PART%% excede o número máximo de %%MAX_VAL%%';
$lang['int_ranges_single_below_1'] = 'Números devem ser 1 ou maiores (%%PART%%)';
...
$lang['jobs_action_stream_log'] = 'Exibir arquivo de log';
...
$lang['oj_common_create_job'] = 'Criar Tarefa';
...
$lang['oj_recreate_previews_target'] = 'Qual tipo de Referências são fornecidas?';
...
$lang['oj_recreate_previews_refs_help'] = 'Configurar esta opção controla quais referências (referências de recurso ou coleção) serão usadas para processamento. Entradas válidas incluem listas separadas por vírgula, intervalos e curingas, por exemplo * processaria todas as referências, 1-100 processaria as primeiras 100 referências, 101-* processaria referências 101 em diante e 1,3,5 processaria referências 1, 3 e 5. Estes podem ser combinados para atingir exatamente as referências necessárias, por exemplo 1,5-10,15-* atingiria 1, 5 a 10 e 15 em diante.';
$lang['oj_recreate_previews_use_existing_help'] = 'Ao ativar esta opção, o sistema tentará preservar as pré-visualizações que foram substituídas manualmente nos recursos. Se não for usada, quaisquer pré-visualizações carregadas manualmente serão substituídas por pré-visualizações derivadas do arquivo original.';
$lang['oj_recreate_previews_video_update_help'] = 'Ao ativar esta opção, vídeos que não correspondem à extensão \'$ffmpeg_preview_extension\' configurada atualmente serão atualizados. Isso é útil quando essa configuração foi alterada, para direcionar apenas os recursos que precisam de uma nova pré-visualização.';
...
$lang['oj_exif_data_blanks'] = 'Valor de campo em branco onde não há dados EXIF';
$lang['oj_exif_data_overwrite'] = 'Sobrescrever valores de campo existentes onde há dados EXIF';
$lang['oj_exif_data_field_refs_help'] = 'Estes são os refs dos campos para os quais você deseja extrair dados EXIF. Esses campos devem ter "Campo Exiftool" configurado. Uma lista separada por vírgulas pode ser usada para especificar os campos, por exemplo, 1,3,5.';
...
$lang['oj_exif_data_overwrite_help'] = 'Ao ativar esta opção, o valor do campo especificado será sobrescrito por dados EXIF incorporados, se presentes no arquivo.';
$lang['oj_purge_duplicates_intro'] = '<strong>Aviso: Este script permite que recursos sejam EXCLUÍDOS PERMANENTEMENTE - por favor, use a opção de Execução de Teste para validar suas configurações se estiver em dúvida.<\\/strong>';
...
$lang['oj_purge_duplicates_dry_run'] = 'Execução de teste';
...
$lang['oj_checksums_recreate_help'] = 'Configurar esta opção forçará a recriação de TODAS as somas de verificação de recursos, ao invés de apenas aquelas que atualmente não possuem uma soma de verificação existente.';
$lang['oj_extracted_text_update_all'] = 'Atualizar mesmo se já houver dados existentes, e sobrescrever valores antigos';
...
$lang['oj_extracted_text_update_all_help'] = 'Configurar esta opção executará a extração mesmo se já houver dados existentes, e sobrescreverá o valor antigo.';
$lang['requiredfield_multiple'] = 'Este é um campo obrigatório ao alterar o estado do arquivo';
$lang['reorder_invalid'] = 'A ordenação da coleção não pode ser alterada a menos que a ordem de classificação seja a ordem da coleção';
...
$lang['information-geomapping'] = 'Armazene a geolocalização neste campo como latitude, longitude ou ambos.<br \\/>Somente um único campo pode ser definido como ambos ou um campo para cada latitude e longitude.<br \\/>Disponível apenas para campos de texto de linha única.';
...
$lang['save-error-invalid-latlong'] = 'Erro ao salvar automaticamente - geolocalização inválida, Use: latitude, longitude (ex. 40.7128, -74.0060). Localização do recurso não foi atualizada.';
