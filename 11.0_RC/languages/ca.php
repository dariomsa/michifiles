...
$lang['upload_failed_for_path'] = 'La càrrega no ha finalitzat per %path%';
...
$lang['emailcollectionmessage'] = 't\'ha enviat una col·lecció de materials de [applicationname] i s\'ha afegit a la teva secció \'Les meves col·leccions\'.';
...
$lang['matchingresources'] = 'materials iguals';
...
$lang['youfound'] = 'Has trobat';
$lang['youfoundresources'] = 'materials';
...
$lang['enteringfewerkeywords'] = 'introduint menys paraules claus per la cerca.';
...
$lang['hasemailedyouaresource'] = 't\'ha enviat aquest material';
$lang['clicktoviewresource'] = 'Clica l\'enllaç de sota per veure el Log.';
...
$lang['max'] = 'Max';
$lang['statisticsfor'] = 'Estadístiques del';
$lang['printallforyear'] = 'Imprimir totes les estadístiques per aquest any';
...
$lang['haspostedresearchrequest'] = 'has enviat una petició de material';
...
$lang['researchrequestcomplete'] = 'Petició de cerca realitzada';
...
$lang['columnheader-resource_id'] = 'Codi de material';
$lang['id'] = 'Codi';
$lang['date'] = 'Data';
$lang['todate'] = 'Fins';
...
$lang['newlogindetails'] = 'A continuació es mostren els detalls del teu usuari.';
$lang['youraccountdetails'] = 'Els detalls del teu compte';
$lang['copyfromcollection'] = 'Copiar des de la col·lecció';
$lang['donotcopycollection'] = 'No copiar des de la col·lecció';
$lang['resourcesincollection'] = 'materials d\'aquesta col·lecció';
...
$lang['enterantispamcode'] = 'Introduïu el codi següent';
...
$lang['group_config_inherit'] = 'La configuració del grup s\'hereta del grup d\'usuaris pare. No hi ha res a configurar aquí.';
$lang['property-group_preferences_inherit'] = 'Heretar del grup pare';
$lang['property-sort_method'] = 'Mètode de classificació';
$lang['information-sort_method'] = 'Ordre a utilitzar quan es mostren els resultats de la cerca ordenats per aquest camp.';
$lang['exiftoolconflictingversions'] = 'S\'han detectat versions en conflicte d\'Exiftool';
$lang['editgroupconfigoverrides'] = 'Edita les sobrescripcions de configuració del grup';
$lang['sort-method_default'] = 'Per defecte - Alfanumèric';
$lang['sort-method_dot-notation'] = 'Número d\'accés - notació de punts';
$lang['save-error-invalid'] = 'Error en l\'auto desament - si us plau, revisa el contingut i torna a provar';
$lang['fieldtitle-usergroup_config'] = 'Overrides de grup';
$lang['page-title_usergroup_config'] = 'Edita les sobrescripts de configuració del grup';
$lang['action-title_usergroup_override_detail'] = 'Qualsevol configuració establerta aquí substituirà els valors predeterminats del sistema per als usuaris d\'aquest grup.';
$lang['team_resource_non_ingested_search'] = 'Veure recursos no ingestats';
$lang['language-ms'] = 'Malaià';
$lang['language-tl'] = 'Filipí';
$lang['upgrade_028_notify_config_not_set'] = 'No es pot establir l\'opció de configuració (a nivell del sistema) %name% a %value%';
$lang['annotate_tagging_fields'] = 'Camp de etiquetatge';
$lang['annotate_text_adds_comment'] = 'Afegir comentari per a les anotacions de text dels recursos. (N/A per a les anotacions de camps de llista fixa)';
$lang['annotate_public_view'] = 'Les anotacions són visibles públicament (per exemple, comparticions externes)?';
$lang['annotate_show_author'] = 'Mostrar l\'autor de l\'annotació?';
$lang['annotate_exclude_restypes'] = 'Tipus de recursos a excloure (marca per excloure i no ser anotat)';
$lang['annotate_pseudo_rtf_comment_title'] = 'Comentaris (mode)';
$lang['annotorious_add_a_comment'] = 'Afegir un comentari...';
$lang['annotorious_type_to_search_field'] = 'Escriu per cercar...';
$lang['annotate_pdf_sheet_tool'] = 'Annotations PDF';
$lang['annotate_pdf_intro_text'] = 'Seleccioneu la mida de pàgina per al vostre PDF d\'Annotations.';
$lang['annotate_pdf_no_annotations'] = 'No hi ha anotacions.';
$lang['statusinvalid'] = 'Invàlid';
$lang['accessinvalid'] = 'Invàlid';
$lang['requiredfields-status-required_fields'] = 'Els camps obligatoris han de ser completats per canviar l\'estat a %%STATUS%%. Si us plau, establiu els següents camps i torneu a provar: %%FIELDS%%';
$lang['error_file_upload_cond-InvalidMimeType'] = 'Tipus MIME no vàlid';
$lang['error-edit_status_change_missing_required_fields'] = 'No és possible canviar l\'estat d\'archivament de tots els recursos. Els següents recursos han estat saltats ja que tenen dades mancants en camps requerits:';
$lang['missing_required_fields'] = 'Recursos amb camps obligatoris incomplets';
$lang['missing_required_fields_intro'] = 'Els recursos de la col·lecció apareixen a continuació ordenats per camps requerits incomplets.';
$lang['action_update_now'] = 'Actualitza ara';
$lang['errors'] = 'Errors';
$lang['error_savefirst'] = 'Si us plau, desa els teus canvis';
$lang['language-be'] = 'Belarús';
...
$lang['years'] = 'Anys';
$lang['ago'] = 'fa';
$lang['action-selectresource'] = 'Selecciona el recurs';
$lang['addremove'] = 'Seleccionar';
$lang['expand'] = 'Expandir';
$lang['error_fieldidnotfound'] = 'Camp id no trobat.';
$lang['page-title_login'] = 'Iniciar sessió';
$lang['page-title_about'] = 'Sobre nosaltres';
$lang['page-title_alternative_file'] = 'Fitxer Alternatiu';
$lang['page-title_alternative_files'] = 'Fitxers alternatius';
...
$lang['page-title_change_language'] = 'Canvia l\'idioma';
$lang['page-title_check'] = 'Comprovació de la instal·lació';
$lang['page-title_collection_comment'] = 'Comentaris de la col·lecció';
$lang['page-title_collection_copy_resources'] = 'Copia Recursos de la Col·lecció';
$lang['page-title_collection_download'] = 'Descarrega de col·lecció';
$lang['page-title_collection_edit'] = 'Editar Col·lecció';
$lang['page-title_collection_edit_previews'] = 'Editar les previsualitzacions de la col·lecció';
$lang['page-title_collection_email'] = 'Col·lecció d\'Email';
$lang['page-title_collection_feedback'] = 'Comentaris de la col·lecció';
$lang['page-title_collection_log'] = 'Registre de Col·leccions';
$lang['page-title_collection_manage'] = 'Gestionar Col·leccions';
$lang['page-title_collection_public'] = 'Col·leccions Públiques';
$lang['page-title_collection_request'] = 'Sol·licitar col·lecció';
$lang['page-title_collection_set_category'] = 'Estableix la categoria de la col·lecció';
$lang['page-title_collections_featured'] = 'Col·leccions destacades';
$lang['page-title_collection_share'] = 'Comparteix la col·lecció';
$lang['page-title_collections'] = 'Col·leccions';
$lang['page-title_contact'] = 'Contacta\'ns';
$lang['page-title_contactsheet_settings'] = 'Configuració de la Fulla de Contacte';
$lang['page-title_content'] = 'Previsualitzar el contingut del lloc';
$lang['page-title_contribute'] = 'Contribucions';
$lang['page-title_csv_export_results_metadata'] = 'Exportar CSV';
$lang['page-title_dash_tile'] = 'Editar el mosaic del tauler';
$lang['page-title_done'] = 'Fet';
$lang['page-title_download'] = 'Descarregar';
$lang['page-title_download_progress'] = 'Progrés de la descàrrega';
$lang['page-title_download_usage'] = 'Descarregar ús';
$lang['page-title_edit_fields'] = 'Editar el camp de metadades';
$lang['page-title_edit'] = 'Editar Recurso';
$lang['page-title_geo_edit'] = 'Editar ubicació';
$lang['page-title_geo_search'] = 'Cerca per ubicació';
$lang['page-title_graph'] = 'Gràfic';
$lang['page-title_help'] = 'Ajuda';
$lang['page-title_home'] = 'Dash';
$lang['page-title_job_details'] = 'Detalls de la feina fora de línia';
$lang['page-title_log_entry'] = 'Registre de Recursos';
$lang['page-title_log'] = 'Registre de Recursos';
$lang['page-title_manage_external_shares'] = 'Gestionar Accions';
$lang['page-title_manage_jobs'] = 'Gestionar Feines Offline';
$lang['page-title_metadata_download'] = 'Descarregar Metadades';
$lang['page-title_mp3_play'] = 'Reproduir fitxer d\'àudio';
$lang['page-title_no_uploads'] = 'Pujant no disponible';
$lang['page-title_preview'] = 'Previsualització';
$lang['page-title_request_log'] = 'Registre de sol·licituds';
$lang['page-title_requests'] = 'Sol·licituds';
$lang['page-title_research_request'] = 'Sol·licitud de Recerca';
$lang['page-title_resource_collection_list'] = 'Llista de Col·leccions';
$lang['page-title_resource_email'] = 'Correu electrònic del recurs';
$lang['page-title_resource_request'] = 'Sol·licitar Recurso';
$lang['page-title_resource_share'] = 'Comparteix el recurs';
$lang['page-title_search_advanced'] = 'Cerca avançada';
$lang['page-title_search_disk_usage'] = 'Ús del disc';
$lang['page-title_search'] = 'Cerca';
$lang['page-title_setup'] = 'Configuració';
$lang['page-title_share_access'] = 'Compartir Accés';
$lang['page-title_share_upload'] = 'Pujar Compartir';
$lang['page-title_simple_search'] = 'Cerca';
$lang['page-title_system_down'] = 'Sistema fora de servei';
$lang['page-title_terms'] = 'Termes d\'ús';
$lang['page-title_themes'] = 'Col·leccions destacades';
$lang['page-title_upload_batch'] = 'Pujar Recursos';
$lang['page-title_upload_preview'] = 'Pujar Vista Prèvia';
$lang['page-title_upload_replace_batch'] = 'Substitució en massa de recursos';
$lang['page-title_user_password'] = 'Canviar la contrasenya';
$lang['page-title_user_ratings'] = 'Estadístiques de valoració d\'usuari per a recursos';
$lang['page-title_user_request'] = 'Sol·licitar Usuari';
$lang['page-title_video_player'] = 'Reproductor de vídeo';
$lang['page-title_view_alternative_files'] = 'Veure fitxer alternatiu';
$lang['page-title_view_metadata'] = 'Veure Metadades del Recurso';
$lang['page-title_view'] = 'Veure Recurso';
$lang['page-title_view_shares'] = 'Veure Compartir';
$lang['page-title_admin_content_edit'] = 'Editar el contingut del lloc';
$lang['page-title_admin_content'] = 'Contingut del lloc';
$lang['page-title_admin_copy_field'] = 'Copia del camp de tipus de recurs';
$lang['page-title_admin_download_config'] = 'Descarregar la configuració del sistema';
$lang['page-title_admin_filter_edit'] = 'Editar filtre';
$lang['page-title_admin_filter_manage'] = 'Gestionar filtre';
$lang['page-title_admin_group_config_edit'] = 'Editar les configuracions d\'override del grup d\'usuaris';
$lang['page-title_admin_group_management_edit'] = 'Editar grup d\'usuari';
$lang['page-title_admin_group_management'] = 'Grups d\'Usuaris';
$lang['page-title_admin_group_permissions'] = 'Editar permisos del grup d\'usuaris';
$lang['page-title_admin_home'] = 'Menú del sistema';
$lang['page-title_admin_manage_field_options'] = 'Gestionar les opcions de camp';
$lang['page-title_admin_manage_slideshow'] = 'Gestionar la presentació de diapositives';
$lang['page-title_admin_report_management_edit'] = 'Editar informe';
$lang['page-title_admin_report_management'] = 'Gestionar Informes';
$lang['page-title_admin_resource_type_edit'] = 'Editar Tipus de Recurso';
$lang['page-title_admin_resource_type_field_edit'] = 'Editar el camp de tipus de recurs';
$lang['page-title_admin_resource_type_fields'] = 'Camp de Tipus de Recursos';
$lang['page-title_admin_resource_types'] = 'Tipus de recursos';
$lang['page-title_admin_size_management_edit'] = 'Editar la mida de la imatge';
$lang['page-title_admin_size_management'] = 'Mides d\'imatge';
$lang['page-title_admin_system_config'] = 'Configuració del sistema';
$lang['page-title_admin_system_log'] = 'Registre del sistema';
$lang['page-title_admin_system_performance'] = 'Rendiment del sistema';
$lang['page-title_tabs'] = 'Gestionar pestanyes';
$lang['page-title_team_analytics_edit'] = 'Editar Informe d\'Analítica';
$lang['page-title_team_analytics'] = 'Informe d\'analítica';
$lang['page-title_team_archive'] = 'Arxivar Recursos';
$lang['page-title_team_copy'] = 'Copia de recurs';
$lang['page-title_team_dash_admin'] = 'Gestionar el tauler';
$lang['page-title_team_dash_tile'] = 'Fitxes del Tauler';
$lang['page-title_team_dash_tile_special'] = 'Crear Fitxa de Tauler Especial';
$lang['page-title_team_export'] = 'Exportar dades del sistema';
$lang['page-title_team_external_shares'] = 'Gestionar Comparticions Externes';
$lang['page-title_team_home'] = 'Menú d\'Administració';
$lang['page-title_team_mail'] = 'Enviar correu massiu';
$lang['page-title_team_plugins_groups'] = 'Gestionar l\'accés al plugin del grup d\'usuaris';
$lang['page-title_team_plugins'] = 'Gestionar plugins';
$lang['page-title_team_related_keywords_edit'] = 'Editar paraules clau relacionades';
$lang['page-title_team_related_keywords'] = 'Paraules clau relacionades';
$lang['page-title_team_report'] = 'Veure Informe';
$lang['page-title_team_request_edit'] = 'Sol·licitud d\'edició';
$lang['page-title_team_request'] = 'Sol·licituds';
$lang['page-title_team_research_edit'] = 'Editar sol·licitud de recerca';
$lang['page-title_team_research'] = 'Sol·licitud de Recerca';
$lang['page-title_team_resource'] = 'Menú de Recursos';
$lang['page-title_team_user_edit'] = 'Editar Usuari';
$lang['page-title_team_user'] = 'Gestionar Usuaris';
$lang['page-title_team_user_purge'] = 'Netejar Usuaris';
$lang['page-title_user_actions'] = 'Accions de l\'usuari';
$lang['page-title_user_api_session'] = 'Accés API del Sistema Remot';
$lang['page-title_user_change_password'] = 'Canviar la contrasenya';
$lang['page-title_user_dash_admin'] = 'Gestionar el tauler d\'usuari';
$lang['page-title_user_home'] = 'Menú d\'usuari';
$lang['page-title_user_message'] = 'Missatge d\'usuari';
$lang['page-title_user_messages'] = 'Missatges d\'usuari';
$lang['page-title_user_preferences'] = 'Preferències d\'usuari';
$lang['page-title_user_profile_edit'] = 'El meu perfil';
$lang['page-title_user_profile'] = 'Perfil d\'usuari';
$lang['backtomessages'] = 'Tornar als Missatges';
$lang['viewallmessages'] = 'Veure tots els missatges';
$lang['min_ago'] = 'fa %TIME% minuts';
$lang['mins_ago'] = 'fa %TIME% minuts';
$lang['hour_ago'] = 'fa %TIME% hores';
$lang['hours_ago'] = 'fa %TIME% hores';
$lang['day_ago'] = 'fa %TIME% dies';
$lang['days_ago'] = 'fa %TIME% dies';
$lang['week_ago'] = 'fa %TIME% setmanes';
$lang['weeks_ago'] = 'fa %TIME% setmanes';
$lang['month_ago'] = 'fa %TIME% mesos';
$lang['months_ago'] = 'fa %TIME% mesos';
$lang['random'] = 'Aleatori';
$lang['log-sf'] = 'Fitxer Staticsync modificat';
$lang['log_code_J'] = 'Treball afegit';
$lang['log_code_JC'] = 'Treball completat';
$lang['log_code_JD'] = 'Treball eliminat';
$lang['email_username'] = 'Correu electrònic / nom d\'usuari';
$lang['request_new_password'] = 'Si heu oblidat la vostra contrasenya, utilitzeu l\'enllaç a continuació per sol·licitar-ne una de nova.';
$lang['enter_username_or_email'] = 'Introdueix un nom d\'usuari o una adreça de correu electrònic';
$lang['enter_a_password'] = 'Introdueix una contrasenya';
$lang['enter_a_full_name'] = 'Introdueix un nom complet';
$lang['enter_an_email_address'] = 'Introdueix una adreça de correu electrònic';
$lang['new_to_resourcespace'] = 'Nou a [applicationname]?';
$lang['show_password'] = 'Mostra la contrasenya';
$lang['hide_password'] = 'Amagar contrasenya';
$lang['select_a_user_group'] = 'Seleccioneu un grup d\'usuaris';
$lang['back_to_login'] = 'Tornar a iniciar sessió';
$lang['required'] = 'requerit';
$lang['select_a'] = 'Selecciona un';
$lang['notsharableresources'] = 'Els següents recursos no són compartibles per aquest usuari i no es poden afegir a una col·lecció compartida:';
$lang['antispam'] = 'Anti-Spam';
$lang['comments_body-placeholder-anon'] = 'Afegir un comentari.';
$lang['batch_replace_alternatives'] = 'Substitueix els fitxers originals o els fitxers alternatius';
$lang['batch_replace_upload_resources'] = 'Fitxers originals';
$lang['batch_replace_upload_alternatives'] = 'Fitxers alternatius';
$lang['userpreference_user_interface'] = 'Interfície d\'usuari';
$lang['systemconfig_watermark_open'] = 'Aplica marca d\'aigua a la miniatura / vista prèvia per a grups amb el permís "w" fins i tot quan l\'accés és "Obert"';
$lang['systemconfig_watermark_open_search'] = 'Si s\'aplica una marca d\'aigua a la miniatura / vista prèvia (opció anterior), també s\'aplicarà la marca d\'aigua a la pàgina de cerca';
$lang['systemconfig_minyear'] = 'Data més antiga a incloure en el selector de dates del formulari de cerca. Normalment any de la primera pujada';
$lang['systemconfig_searchbyday'] = 'Incloure el dia en la cerca a més del mes/any';
$lang['systemconfig_default_collection_sort'] = 'Ordre de classificació per defecte al visualitzar recursos de la col·lecció. Quan els usuaris esperen que els recursos es mostrin en l\'ordre que han proporcionat, això hauria de ser col·lecció';
$lang['systemconfig_systemconfig_searchbyday'] = 'Mostra l\'estat del flux de treball del recurs (icona i text) en els resultats de cerca quan estigui en mode de visualització en miniatura';
$lang['systemconfig_category_tree_search_use_and'] = 'Seleccionar un valor en un camp de l\'arbre de categories a la pàgina de cerca seleccionarà automàticament tots els valors pare.';
$lang['systemconfig_category_tree_search_use_and_logic'] = 'Tots els valors de l\'arbre de categories seleccionats han d\'estar presents perquè la cerca retorni resultats (seleccionar cap trobarà coincidències per a qualsevol valor seleccionat)';
$lang['systemconfig_recent_search_quantity'] = 'Nombre de recursos a mostrar amb els enllaços Recent i Veure nou material';
$lang['systemconfig_general'] = 'General';
$lang['systemconfig_date_yyyy'] = 'Mostra l\'any en un format de quatre dígits';
$lang['systemconfig_imperial_measurements'] = 'Utilitza el sistema imperial en lloc del mètric per a les directrius de mida de descàrrega';
$lang['systemconfig_site_text_custom_create'] = 'Permetre la creació de noves entrades de text del lloc des de Gestionar Contingut (destinat a desenvolupar noves pàgines)';
$lang['systemconfig_no_welcometext'] = 'Amaga el text de benvinguda a la pàgina d\'inici';
$lang['systemconfig_internal_preview_sizes_editable'] = 'Permetre l\'edició de les mides internes';
$lang['systemconfig_edit_autosave'] = 'Desar automàticament els canvis a la pàgina d\'edició. Si no, s\'ha d\'utilitzar el botó Desar';
$lang['systemconfig_resource_request_reason_required'] = 'Quan es sol·licita un recurs o recursos, és obligatori el camp "Motiu de la sol·licitud"?';
$lang['systemconfig_research_request'] = 'Habilita la funcionalitat de Sol·licitud de Recerca';
$lang['systemconfig_custom_access'] = 'Habilita el nivell d\'"accés personalitzat" per a un control d\'accés addicional dels recursos';
$lang['systemconfig_enable_related_resources'] = 'Activa el camp "Recursos relacionats" quan edites recursos.';
$lang['systemconfig_user_accounts'] = 'Comptes d\'usuari';
$lang['systemconfig_inactive_user_disable_days'] = 'Desactivar automàticament els usuaris inactius després d\'un nombre establert de dies (0 desactiva aquesta funció)';
$lang['systemconfig_sharing'] = 'Compartir';
$lang['systemconfig_external_share_groups_config_options'] = 'Honorar les opcions de configuració del grup quan es comparteix externament com a un grup d\'usuaris específic';
$lang['systemconfig_resource_share_expire_days_default'] = 'Nombre de dies per defecte per seleccionar per a l\'expiració de la compartició (establiu 0 per utilitzar la primera opció)';
$lang['systemconfig_restricted_share'] = 'Haurien de poder compartir el recurs aquells amb accés "restrictiu" a un recurs?';
$lang['systemconfig_blank_edit_template'] = 'En pujar recursos (pujada per lots) i editar la plantilla, restableix els valors a blanc o al valor per defecte cada vegada';
$lang['systemconfig_enable_copy_data_from'] = 'Quan s\'afegeixen recursos per lots, habiliteu la funció "Copiar dades del recurs d\'un recurs existent"';
$lang['systemconfig_resource_view'] = 'Vista de recursos';
$lang['systemconfig_show_resourceid'] = 'Mostra l\'ID del recurs a la pàgina de visualització';
$lang['systemconfig_show_resource_type'] = 'Mostra el tipus de recurs a la pàgina de visualització';
$lang['systemconfig_show_access_field'] = 'Mostra l\'accés a recursos a la pàgina de visualització';
$lang['systemconfig_show_contributed_by'] = 'Mostra l\'usuari "contribuït per" a la pàgina de visualització';
$lang['systemconfig_show_related_themes'] = 'Mostra el panell de col·leccions relacionades i col·leccions públiques a la pàgina de visualització';
$lang['systemconfig_metadata_download'] = 'Mostra l\'opció "Descarregar metadades" a la pàgina de visualització';
$lang['systemconfig_uploading'] = 'Pujant';
$lang['systemconfig_upload_add_to_new_collection'] = 'L\'opció "Afegir a Nova Col·lecció" s\'utilitzarà per a càrregues en lot. Desactiveu per defecte "No afegir a la Col·lecció"';
$lang['systemconfig_upload_add_to_new_collection_opt'] = 'Per a les càrregues en lot, habilita l\'opció "Afegir a Nova Col·lecció"';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = 'Per a les càrregues en lot, habiliteu l\'opció "No afegir a la nova col·lecció" (si no està habilitada, forçarà la càrrega a una col·lecció)';
$lang['systemconfig_upload_collection_name_required'] = 'Requereix que s\'introdueixi un nom de col·lecció per a les càrregues en massa. Substituirà el comportament per defecte d\'Upload[timestamp]';
$lang['systemconfig_allow_password_change'] = 'Permetre el canvi de contrasenya';
$lang['systemconfig_allow_password_reset'] = 'Permetre als usuaris sol·licitar una nova contrasenya a través de la pantalla d\'inici de sessió';
$lang['systemconfig_allow_keep_logged_in'] = 'Mostra l\'opció "Mantenir-me connectat en aquest dispositiu" a la pantalla d\'inici de sessió';
$lang['systemconfig_remember_me_checked'] = 'Mantingueu-me connectat en aquest dispositiu seleccionat per defecte';
$lang['systemconfig_session_length'] = 'Durada de la sessió d\'usuari (minuts)';
$lang['systemconfig_session_autologout'] = 'Desconnectar automàticament l\'usuari al final de la sessió (temps d\'inactivitat igual a la durada de la sessió)';
$lang['systemconfig_slideshow_photo_delay'] = 'Nombre de segons que la presentació ha d\'esperar abans de canviar d\'imatge';
$lang['config_integer_invalid_range'] = 'Valor invàlid. Introduïu un número entre %MIN% i %MAX%';
$lang['alternative_file_replaced'] = 'Fitxer alternatiu substituït amb èxit';
$lang['jq_create_alt_previews_success_text'] = 'Previsualitzacions creades per al fitxer alternatiu #%ALTFILE amb èxit';
$lang['jq_create_alt_previews_failure_text'] = 'No s\'ha pogut crear les previsualitzacions per al fitxer alternatiu #%ALTFILE';
$lang['error_report_execution'] = 'S\'ha produït un error en executar l\'informe, si us plau, comproveu que la consulta és vàlida';
$lang['error_save_not_allowed_dash_tile_set_public'] = 'No es pot desar el canvi. Assegureu-vos que no hi hagi cap tauleta de tauler establerta per a tots o múltiples usuaris que estiguin vinculats a aquesta col·lecció';
$lang['error_upload_replace_alternative_file_not_found'] = 'No s\'ha pogut actualitzar el fitxer alternatiu. No s\'ha trobat cap registre de fitxer alternatiu que coincideixi amb el nom de fitxer [filename]';
$lang['error_upload_replace_alternative_multiple_found'] = 'No s\'ha pogut actualitzar el fitxer alternatiu. S\'han trobat diversos registres de fitxers alternatius que coincideixen amb el nom de fitxer [filename], limita per ID de recurs o col·lecció';
$lang['oj-batch-replace-local-alternatives-success-text'] = 'El reemplaçament per lots ha substituït amb èxit %TOTALFILES fitxers alternatius';
$lang['replacebatch_collection_alternatives'] = 'Introdueix un ID de col·lecció si només vols afegir o substituir fitxers alternatius a recursos dins d\'aquesta col·lecció';
$lang['replacebatch_resource_min_alternatives'] = 'ID de recurs més baix per substituir fitxers alternatius per a (ignorats si s\'especifica una col·lecció)';
$lang['replacebatch_resource_max_alternatives'] = 'ID de recurs més alt per substituir fitxers alternatius per';
$lang['system_config_search_engines'] = 'Motors de cerca';
$lang['int_ranges_empty'] = 'L\'entrada està buida';
$lang['int_ranges_range_below_1'] = 'Els números han de ser 1 o més en el rang %%PART%%';
$lang['int_ranges_range_reversed'] = 'L\'inici del rang %%PART%% no pot ser més gran que el final';
$lang['int_ranges_range_above_max'] = 'El rang %%PART%% supera el nombre màxim de %%MAX_VAL%%';
$lang['int_ranges_single_below_1'] = 'Els números han de ser 1 o més (%%PART%%)';
$lang['int_ranges_single_above_max'] = '%%PART%% supera el nombre màxim de %%MAX_VAL%%';
$lang['int_ranges_not_valid'] = '%%PART%% no és un número o un rang vàlid (utilitzeu formats com 3 o 5-9)';
$lang['job_trigger'] = 'Activar una feina';
$lang['job_configure'] = 'Configura la feina';
$lang['jobs_action_stream_log'] = 'Fitxer de registre de flux';
$lang['jobs_action_download_log'] = 'Descarregar fitxer de registre';
$lang['jobs_action_not_started'] = 'La feina encara no ha començat';
$lang['jobs_action_missing_job_progress'] = 'No es pot carregar el progrés de la feina';
$lang['job_action_not_found'] = 'Treball no trobat.';
$lang['job_list_core'] = 'Nucli';
$lang['job_list_recreate_previews'] = 'Recrear les previsualitzacions';
$lang['job_list_exif_data'] = 'Regenerar dades EXIF';
$lang['job_list_purge_duplicates'] = 'Netejar recursos duplicats';
$lang['job_list_reindex'] = 'Reindexar dades';
$lang['job_list_checksums'] = 'Actualitzar sumes de control';
$lang['job_list_extracted_text'] = 'Actualitzar el text extret';
$lang['oj_common_create_job'] = 'Crear feina';
$lang['oj_common_field_refs'] = 'Referències de camp';
$lang['oj_common_collection_refs'] = 'Referències de la col·lecció';
$lang['oj_common_error_required'] = 'Camp requerit';
$lang['oj_common_error_invalid'] = 'Valor invàlid passat per al camp';
$lang['oj_common_error_invalid_field_ref'] = '%FIELD_REF% no fa referència a un camp vàlid';
$lang['oj_recreate_previews_target'] = 'Quin tipus de Refs s\'ofereixen?';
$lang['oj_recreate_previews_refs'] = 'Refs';
$lang['oj_recreate_previews_image_sizes'] = 'Mides d\'imatge a generar';
$lang['oj_recreate_previews_resource_types'] = 'Tipus de recursos a objectiu';
$lang['oj_recreate_previews_use_existing'] = 'Utilitzar les previsualitzacions pujada existents?';
$lang['oj_recreate_previews_video_update'] = 'Actualitza les previsualitzacions de tots els recursos de vídeo que no tenen l\'extensió requerida \'$ffmpeg_preview_extension\'?';
$lang['oj_recreate_previews_delete_existing'] = 'Esborra totes les previsualitzacions existents';
$lang['oj_recreate_previews_refs_help'] = 'Establir aquesta opció controla quines referències (ja sigui referències de recursos o de col·leccions) s\'utilitzaran per al processament. Les entrades vàlides inclouen llistes separades per comes, rangs i comodins, per exemple * processaria totes les referències, 1-100 processaria les primeres 100 referències, 101-* processaria les referències 101 en endavant i 1,3,5 processaria les referències 1, 3 i 5. Aquestes es poden combinar per dirigir-se exactament a les referències requerides, per exemple 1,5-10,15-* dirigiria a 1, de 5 a 10 i 15 en endavant.';
$lang['oj_recreate_previews_use_existing_help'] = 'Establir aquesta opció intentarà preservar qualsevol vista prèvia que hagi estat reemplaçada manualment en els recursos. Si no s\'utilitza, qualsevol vista prèvia carregada manualment serà reemplaçada per vistes prèvies derivades del fitxer original.';
$lang['oj_recreate_previews_video_update_help'] = 'Establir aquesta opció actualitzarà qualsevol vídeo que no coincideixi amb l\'extensió \'$ffmpeg_preview_extension\' configurada actualment. Això és útil quan aquesta configuració ha estat canviada, per dirigir-se només a aquells recursos que necessiten generar una nova vista prèvia.';
$lang['oj_recreate_previews_delete_existing_help'] = 'Establir aquesta opció eliminarà totes les previsualitzacions existents abans de tornar-les a crear.';
$lang['oj_exif_data_blanks'] = 'Valor de camp buit on no existeix dades EXIF';
$lang['oj_exif_data_overwrite'] = 'Sobreescriure els valors de camp existents on hi ha dades EXIF';
$lang['oj_exif_data_field_refs_help'] = 'Aquests són els refs dels camps per als quals voldríeu que s\'extreguessin les dades EXIF. Aquests camps han de tenir configurat "Exiftool field". Es pot utilitzar una llista separada per comes per especificar els camps, per exemple 1,3,5.';
$lang['oj_exif_data_collection_refs_help'] = 'Establir aquesta opció significarà que només es faran actualitzacions als recursos de les col·leccions enumerades. Si no s\'especifiquen col·leccions, llavors les dades EXIF s\'actualitzaran per a TOTS els recursos adequats. Les col·leccions es poden especificar mitjançant una llista separada per comes així com rangs, per exemple 100,105,110-115';
$lang['oj_exif_data_blanks_help'] = 'Establir aquesta opció farà que el camp especificat es buidi si el fitxer no té dades EXIF incrustades per a ell.';
$lang['oj_exif_data_overwrite_help'] = 'Establir aquesta opció farà que el camp especificat tingui qualsevol valor existent sobreescrit per les dades EXIF incrustades, si estan presents al fitxer.';
$lang['oj_purge_duplicates_intro'] = '<strong>Advertència: Aquest script permet que els recursos siguin ELIMINATS PERMANENTMENT - si no esteu segurs, si us plau, utilitzeu l\'opció de prova per validar la vostra configuració.</strong>';
$lang['oj_purge_duplicates_manage_method'] = 'Gestionar mètode';
$lang['oj_purge_duplicates_lifo'] = 'Mantingueu els més antics i elimineu els duplicats més nous';
$lang['oj_purge_duplicates_fifo'] = 'Mantingueu els més nous i elimineu els duplicats més antics';
$lang['oj_purge_duplicates_dry_run'] = 'Prova en buit';
$lang['oj_purge_duplicates_delete_perm'] = 'Eliminar permanentment';
$lang['oj_purge_duplicates_delete_error'] = 'La eliminació permanent no és possible durant una prova en sec';
$lang['oj_purge_duplicates_collection_refs_help'] = 'Estableix les col·leccions com l\'abast de la detecció de duplicats. No cal que tinguis tots els duplicats a les col·leccions, només un d\'ells serà suficient. Els duplicats es processaran a nivell de sistema i es netejaran mitjançant el mètode de gestió seleccionat. Les col·leccions es poden especificar mitjançant una llista separada per comes així com rangs, per exemple 100,105,110-115';
$lang['oj_purge_duplicates_manage_method_help'] = 'Ajustar aquesta opció controla com el script gestionarà l\'eliminació de duplicats.';
$lang['oj_purge_duplicates_dry_run_help'] = 'Establir aquesta opció realitzarà una prova sense fer canvis a cap recurs. El fitxer de registre que conté els resultats de la prova es pot descarregar per a la seva revisió.';
$lang['oj_purge_duplicates_delete_perm_help'] = 'Establir aquesta opció farà que els recursos duplicats siguin eliminats de manera permanent, d\'altra banda, els recursos seran moguts a l\'estat de eliminació de recursos configurat.';
$lang['oj_reindex_field_refs_help'] = 'Establir aquesta opció limitarà quins camps es reindexaran, es pot utilitzar una llista separada per comes per especificar els camps, per exemple 1,3,5. Si no s\'introdueixen camps, TOTS els camps seran reindexats.';
$lang['oj_checksums_recreate'] = 'Torna a crear totes les sumes de control';
$lang['oj_checksums_recreate_help'] = 'Establir aquesta opció forçarà a recrear TOTS els sumaris de recursos en comptes de només aquells que actualment no tenen un sumari existent.';
$lang['oj_extracted_text_update_all'] = 'Actualitza fins i tot si hi ha dades existents, i sobrescriu els valors antics';
$lang['oj_extracted_text_collection_refs_help'] = 'Establir aquesta opció limitarà els recursos processats només als que es troben a les col·leccions enumerades. Si no s\'especifiquen col·leccions, el text extret s\'actualitzarà per a TOTS els recursos adequats. Les col·leccions es poden especificar mitjançant una llista separada per comes així com per intervals, per exemple 100,105,110-115';
$lang['oj_extracted_text_update_all_help'] = 'Establir aquesta opció executarà l\'extracció fins i tot si hi ha dades existents, i sobreescriurà el valor antic.';
$lang['requiredfield_multiple'] = 'Aquest és un camp obligatori quan es canvia l\'estat d\'arxiu';
$lang['reorder_invalid'] = 'La col·lecció no es pot reordenar a menys que l\'ordre de classificació sigui l\'ordre de col·lecció';
$lang['reorder_permissions_fail'] = 'La col·lecció no es pot reorganitzar ja que no tens accés a tots els recursos d\'aquesta col·lecció';
$lang['resource-card-menu-delete'] = 'Estàs segur que vols eliminar aquest recurs?';
$lang['resource-card-menu-delete-button'] = 'Sí, elimina el recurs';
$lang['resource-card-menu-delete-perm'] = 'Estàs segur? Aquesta acció no es pot desfer.';
$lang['resource-card-menu-delete-perm-button'] = 'Sí, elimina permanentment';
$lang['blue'] = 'Blau';
$lang['green'] = 'Verd';
$lang['red'] = 'Vermell';
$lang['purple'] = 'Porpra';
$lang['fieldtype-geo_location'] = 'Geolocalització';
$lang['property-geomapping'] = 'Tipus de geolocalització';
$lang['information-geomapping'] = 'Emmagatzema la geolocalització en aquest camp com a latitud, longitud, o ambdós.<br \\/>Només un camp pot estar configurat per ambdós o un per a cada una de les dues.<br \\/>Disponible només per a camps de text d\'una sola línia.';
$lang['disabled-geomapping-title'] = 'La geolocalització està configurada en un altre camp o camps, per canviar-la a aquest camp s\'ha de treure dels altres camps';
$lang['geo_location-none'] = 'Cap';
$lang['geo_location-latitude'] = 'Latitud';
$lang['geo_location-longitude'] = 'Longitud';
$lang['geo_location-both'] = 'Tots dos';
$lang['knowledgebase'] = 'Base de Coneixement';
$lang['search_filter_panel_toggle'] = 'Activa/desactiva els filtres de cerca';
$lang['search_resources'] = 'Cerca recursos';
$lang['clear_filters'] = 'Neteja els filtres';
$lang['save-error-invalid-latlong'] = 'Error en desar automàtic - geolocalització no vàlida, utilitza: latitud, longitud (p. ex. 40.7128, -74.0060). La ubicació del recurs no s\'ha actualitzat.';
$lang['save-error-invalid-lat'] = 'Error en desar automàtic - latitud de geolocalització no vàlida, ha de ser entre -90 i 90. La ubicació del recurs no s\'ha actualitzat.';
$lang['save-error-invalid-long'] = 'Error en desar automàtic - longitud de geolocalització no vàlida, ha de ser entre -180 i 180. La ubicació del recurs no s\'ha actualitzat.';
$lang['or'] = 'o';
$lang['view_all_fcs'] = 'Veure totes les col·leccions destacades';
$lang['dashtile_upload'] = 'Afegeix recursos al teu sistema';
$lang['knowledgebase-tooltip'] = 'Veure la documentació de ResourceSpace (Base de Coneixement)';
$lang['noresources_collection'] = 'No hi ha recursos a la col·lecció';
$lang['hide_collection_bar'] = 'Amagat';
$lang['minimal_collection_bar'] = 'Barra mínima';
$lang['thumbnails_collection_bar'] = 'Miniatures';
$lang['language-bg'] = 'Búlgar';
