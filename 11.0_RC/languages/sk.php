...
$lang["group_config_inherit"] = 'Konfigurácia skupiny je zdedená z nadradenej používateľskej skupiny. Nie je čo konfigurovať.';
$lang["property-group_preferences_inherit"] = 'Dedičstvo z rodičovskej skupiny';
$lang["property-sort_method"] = 'Metóda triedenia';
$lang["information-sort_method"] = 'Poradie, ktoré sa má použiť pri zobrazovaní výsledkov vyhľadávania usporiadaných podľa tohto poľa.';
$lang["exiftoolconflictingversions"] = 'Zistené konfliktné verzie Exiftool';
$lang["editgroupconfigoverrides"] = 'Upraviť konfiguráciu pre skupiny';
$lang["sort-method_default"] = 'Predvolené - Alfanumerické';
$lang["sort-method_dot-notation"] = 'Číslo prístupu - bodková notácia';
$lang["save-error-invalid"] = 'Chyba pri automatickom uložení - prosím skontrolujte obsah a skúste to znova';
$lang["fieldtitle-usergroup_config"] = 'Prekrytia skupiny';
$lang["page-title_usergroup_config"] = 'Upraviť prekonania konfigurácie skupiny';
$lang["action-title_usergroup_override_detail"] = 'Akékoľvek nastavenia nakonfigurované tu prepisujú systémové predvolené hodnoty pre používateľov v tejto skupine.';
$lang["team_resource_non_ingested_search"] = 'Zobraziť neimportované zdroje';
$lang["language-ms"] = 'Malajščina';
$lang["language-tl"] = 'Filipínčina';
$lang["upgrade_028_notify_config_not_set"] = 'Nemožno nastaviť (systémovú) konfiguračnú možnosť %name% na %value%';
$lang["annotate_tagging_fields"] = 'Polia na označovanie';
$lang["annotate_text_adds_comment"] = 'Pridať komentár k textovým anotáciám zdroja. (N/A pre anotácie s pevne stanoveným zoznamom)';
$lang["annotate_public_view"] = 'Sú anotácie verejne viditeľné (napr. externé zdieľania)?';
$lang["annotate_show_author"] = 'Zobraziť autora anotácie?';
$lang["annotate_exclude_restypes"] = 'Typy zdrojov na vylúčenie (zaškrtnite na vylúčenie a nebudú anotované)';
$lang["annotate_pseudo_rtf_comment_title"] = 'Komentáre (režim)';
$lang["annotorious_add_a_comment"] = 'Pridať komentár...';
$lang["annotorious_type_to_search_field"] = 'Zadajte do vyhľadávacieho poľa...';
$lang["annotate_pdf_sheet_tool"] = 'Poznámky PDF';
$lang["annotate_pdf_intro_text"] = 'Vyberte veľkosť stránky pre váš PDF s anotáciami.';
$lang["annotate_pdf_no_annotations"] = 'Nie sú žiadne anotácie.';
$lang["statusinvalid"] = 'Neplatné';
$lang["accessinvalid"] = 'Neplatné';
$lang["requiredfields-status-required_fields"] = 'Povinné polia musia byť vyplnené, aby sa zmenil stav na %%STATUS%%. Prosím, nastavte nasledujúce polia a skúste to znova: %%FIELDS%%';
$lang["error_file_upload_cond-InvalidMimeType"] = 'Neplatný MIME typ';
$lang["error-edit_status_change_missing_required_fields"] = 'Nie je možné zmeniť archívny stav všetkých zdrojov. Nasledujúce zdroje boli preskočené, pretože im chýbajú údaje v povinných poliach:';
$lang["missing_required_fields"] = 'Zdroje s neúplnými povinnými poli';
$lang["missing_required_fields_intro"] = 'Zdroje v kolekcii sa zobrazujú nižšie, usporiadané podľa neúplných požadovaných polí.';
$lang["action_update_now"] = 'Aktualizovať teraz';
$lang["errors"] = 'Chyby';
...
$lang["years"] = 'Roky';
$lang["ago"] = 'pred';
$lang["action-selectresource"] = 'Vyberte zdroj';
$lang["addremove"] = 'Vybrať';
$lang["expand"] = 'Rozšíriť';
$lang["error_fieldidnotfound"] = 'Pole nebolo nájdené.';
$lang["page-title_login"] = 'Prihlásenie';
$lang["page-title_about"] = 'O nás';
$lang["page-title_alternative_file"] = 'Alternatívny súbor';
$lang["page-title_alternative_files"] = 'Alternatívne súbory';
$lang["page-title_annotate_pdf_config"] = 'Annotovať PDF';
$lang["page-title_annotate_pdf_gen"] = 'Annotovať PDF';
$lang["page-title_api_test"] = 'API Test';
$lang["page-title_change_language"] = 'Zmeniť jazyk';
$lang["page-title_check"] = 'Kontrola inštalácie';
$lang["page-title_collection_comment"] = 'Komentáre k zbierke';
$lang["page-title_collection_copy_resources"] = 'Kopírovať zdroje kolekcie';
$lang["page-title_collection_download"] = 'Stiahnutie kolekcie';
$lang["page-title_collection_edit"] = 'Upraviť kolekciu';
$lang["page-title_collection_edit_previews"] = 'Upraviť náhľady kolekcií';
$lang["page-title_collection_email"] = 'Zbierka e-mailov';
$lang["page-title_collection_feedback"] = 'Spätná väzba na kolekciu';
$lang["page-title_collection_log"] = 'Záznam kolekcie';
$lang["page-title_collection_manage"] = 'Spravovať zbierky';
$lang["page-title_collection_public"] = 'Verejné zbierky';
$lang["page-title_collection_request"] = 'Žiadosť o kolekciu';
$lang["page-title_collection_set_category"] = 'Nastavi kategóriu zbierky';
$lang["page-title_collections_featured"] = 'Zvýraznené kolekcie';
$lang["page-title_collection_share"] = 'Zdieľať kolekciu';
$lang["page-title_collections"] = 'Zbierky';
$lang["page-title_contact"] = 'Kontaktujte nás';
$lang["page-title_contactsheet_settings"] = 'Konfigurácia kontaktného listu';
$lang["page-title_content"] = 'Náhľad obsahu stránky';
$lang["page-title_contribute"] = 'Príspevky';
$lang["page-title_csv_export_results_metadata"] = 'CSV export';
$lang["page-title_dash_tile"] = 'Upraviť dlaždicu na paneli';
$lang["page-title_done"] = 'Hotovo';
$lang["page-title_download"] = 'Stiahnuť';
$lang["page-title_download_progress"] = 'Pokrok sťahovania';
$lang["page-title_download_usage"] = 'Stiahnutie použitia';
$lang["page-title_edit_fields"] = 'Upraviť pole metadát';
$lang["page-title_edit"] = 'Upraviť zdroj';
$lang["page-title_geo_edit"] = 'Upraviť lokalitu';
$lang["page-title_geo_search"] = 'Hľadanie polohy';
$lang["page-title_graph"] = 'Graf';
$lang["page-title_help"] = 'Pomoc';
$lang["page-title_home"] = 'Dash';
$lang["page-title_job_details"] = 'Podrobnosti o offline úlohe';
$lang["page-title_log_entry"] = 'Záznam zdrojov';
$lang["page-title_log"] = 'Záznam zdrojov';
$lang["page-title_manage_external_shares"] = 'Spravovať zdieľania';
$lang["page-title_manage_jobs"] = 'Spravovať offline úlohy';
$lang["page-title_metadata_download"] = 'Stiahnuť metadata';
$lang["page-title_mp3_play"] = 'Prehrať zvukový súbor';
$lang["page-title_no_uploads"] = 'Nahrávanie nedostupné';
$lang["page-title_preview"] = 'Náhľad';
$lang["page-title_request_log"] = 'Záznam požiadaviek';
$lang["page-title_requests"] = 'Žiadosti';
$lang["page-title_research_request"] = 'Žiadosť o výskum';
$lang["page-title_resource_collection_list"] = 'Zoznam zbierok';
$lang["page-title_resource_email"] = 'E-mailová zdroj';
$lang["page-title_resource_request"] = 'Požiadať o zdroj';
$lang["page-title_resource_share"] = 'Zdieľať zdroj';
$lang["page-title_search_advanced"] = 'Pokročilé vyhľadávanie';
$lang["page-title_search_disk_usage"] = 'Využitie disku';
$lang["page-title_search"] = 'Hľadať';
$lang["page-title_setup"] = 'Nastavenie';
$lang["page-title_share_access"] = 'Zdieľať prístup';
$lang["page-title_share_upload"] = 'Nahrať zdieľanie';
$lang["page-title_simple_search"] = 'Hľadať';
$lang["page-title_system_down"] = 'Systém je mimo prevádzku';
$lang["page-title_terms"] = 'Podmienky používania';
$lang["page-title_themes"] = 'Zvýraznené kolekcie';
$lang["page-title_upload_batch"] = 'Nahrať zdroje';
$lang["page-title_upload_preview"] = 'Nahráť náhľad';
$lang["page-title_upload_replace_batch"] = 'Hromadná výmena zdrojov';
$lang["page-title_user_password"] = 'Zmeniť heslo';
$lang["page-title_user_ratings"] = 'Štatistiky hodnotenia používateľa pre zdroj';
$lang["page-title_user_request"] = 'Požiadať o používateľa';
$lang["page-title_video_player"] = 'Prehrávač videa';
$lang["page-title_view_alternative_files"] = 'Zobraziť alternatívny súbor';
$lang["page-title_view_metadata"] = 'Zobraziť metadata zdroja';
$lang["page-title_view"] = 'Zobraziť zdroj';
$lang["page-title_view_shares"] = 'Zobraziť zdieľanie';
$lang["page-title_admin_content_edit"] = 'Upraviť obsah stránky';
$lang["page-title_admin_content"] = 'Obsah stránky';
$lang["page-title_admin_copy_field"] = 'Kopírovať pole typu zdroja';
$lang["page-title_admin_download_config"] = 'Stiahnuť systémovú konfiguráciu';
$lang["page-title_admin_filter_edit"] = 'Upraviť filter';
$lang["page-title_admin_filter_manage"] = 'Spravovať filter';
$lang["page-title_admin_group_config_edit"] = 'Upraviť konfiguráciu pre skupiny používateľov';
$lang["page-title_admin_group_management_edit"] = 'Upraviť skupinu používateľov';
$lang["page-title_admin_group_management"] = 'Skupiny používateľov';
$lang["page-title_admin_group_permissions"] = 'Upraviť povolenia skupiny používateľov';
$lang["page-title_admin_home"] = 'Systémové menu';
$lang["page-title_admin_manage_field_options"] = 'Spravovať možnosti polí';
$lang["page-title_admin_manage_slideshow"] = 'Spravovať prezentáciu';
$lang["page-title_admin_report_management_edit"] = 'Upraviť správu';
$lang["page-title_admin_report_management"] = 'Spravovať správy';
$lang["page-title_admin_resource_type_edit"] = 'Upraviť typ zdroja';
$lang["page-title_admin_resource_type_field_edit"] = 'Upraviť pole typu zdroja';
$lang["page-title_admin_resource_type_fields"] = 'Polia typu zdrojov';
$lang["page-title_admin_resource_types"] = 'Typy zdrojov';
$lang["page-title_admin_size_management_edit"] = 'Upraviť veľkosť obrázka';
$lang["page-title_admin_size_management"] = 'Veľkosti obrázkov';
$lang["page-title_admin_system_config"] = 'Konfigurácia systému';
$lang["page-title_admin_system_log"] = 'Systémový záznam';
$lang["page-title_admin_system_performance"] = 'Výkon systému';
$lang["page-title_tabs"] = 'Spravovať karty';
$lang["page-title_team_analytics_edit"] = 'Upraviť analytickú správu';
$lang["page-title_team_analytics"] = 'Analytická správa';
$lang["page-title_team_archive"] = 'Archívovať zdroje';
$lang["page-title_team_copy"] = 'Kopírovať zdroj';
$lang["page-title_team_dash_admin"] = 'Spravovať panel';
$lang["page-title_team_dash_tile"] = 'Dlaždice na paneli';
$lang["page-title_team_dash_tile_special"] = 'Vytvoriť špeciálnu dlaždicu na paneli';
$lang["page-title_team_export"] = 'Exportovať systémové údaje';
$lang["page-title_team_external_shares"] = 'Spravovať externé zdieľania';
$lang["page-title_team_home"] = 'Admin ponuka';
$lang["page-title_team_mail"] = 'Odoslať hromadný email';
$lang["page-title_team_plugins_groups"] = 'Spravovať prístup k pluginom skupiny používateľov';
$lang["page-title_team_plugins"] = 'Spravovať pluginy';
$lang["page-title_team_related_keywords_edit"] = 'Upraviť súvisiace kľúčové slová';
$lang["page-title_team_related_keywords"] = 'Súvisiace kľúčové slová';
$lang["page-title_team_report"] = 'Zobraziť správu';
$lang["page-title_team_request_edit"] = 'Žiadosť o úpravu';
$lang["page-title_team_request"] = 'Žiadosti';
$lang["page-title_team_research_edit"] = 'Upraviť žiadosť o výskum';
$lang["page-title_team_research"] = 'Žiadosť o výskum';
$lang["page-title_team_resource"] = 'Menu zdrojov';
$lang["page-title_team_user_edit"] = 'Upraviť používateľa';
$lang["page-title_team_user"] = 'Spravovať používateľov';
$lang["page-title_team_user_purge"] = 'Vymazať používateľov';
$lang["page-title_user_actions"] = 'Akcie používateľa';
$lang["page-title_user_api_session"] = 'Prístup k API vzdialeného systému';
$lang["page-title_user_change_password"] = 'Zmeniť heslo';
$lang["page-title_user_dash_admin"] = 'Spravovať používateľský panel';
$lang["page-title_user_home"] = 'Ponuka používateľa';
$lang["page-title_user_message"] = 'Správa používateľa';
$lang["page-title_user_messages"] = 'Správy používateľov';
$lang["page-title_user_preferences"] = 'Preferencie používateľa';
$lang["page-title_user_profile_edit"] = 'Môj profil';
$lang["page-title_user_profile"] = 'Profil používateľa';
$lang["backtomessages"] = 'Späť na správy';
$lang["viewallmessages"] = 'Zobraziť všetky správy';
$lang["min_ago"] = '%TIME% minútu dozadu';
$lang["mins_ago"] = '%TIME% minútami dozadu';
$lang["hour_ago"] = '%TIME% hodín dozadu';
$lang["hours_ago"] = '%TIME% hodín dozadu';
$lang["day_ago"] = '%TIME% dňom dozadu';
$lang["days_ago"] = '%TIME% dní dozadu';
$lang["week_ago"] = '%TIME% pred týždňom';
$lang["weeks_ago"] = '%TIME% týždňov dozadu';
$lang["month_ago"] = '%TIME% mesiac dozadu';
$lang["months_ago"] = '%TIME% mesiacov dozadu';
$lang["random"] = 'Náhodné';
$lang["log-sf"] = 'Súbor Staticsync bol upravený';
$lang["log_code_J"] = 'Práca pridaná';
$lang["log_code_JC"] = 'Práca dokončená';
$lang["log_code_JD"] = 'Práca odstránená';
$lang["email_username"] = 'Email / používateľské meno';
$lang["request_new_password"] = 'Ak ste zabudli heslo, použite nižšie uvedený odkaz na požiadanie nového hesla.';
$lang["enter_username_or_email"] = 'Zadajte používateľské meno alebo emailovú adresu';
$lang["enter_a_password"] = 'Zadajte heslo';
$lang["enter_a_full_name"] = 'Zadajte celé meno';
$lang["enter_an_email_address"] = 'Zadajte emailovú adresu';
$lang["new_to_resourcespace"] = 'Nový v [applicationname]?';
$lang["show_password"] = 'Zobraziť heslo';
$lang["hide_password"] = 'Skryť heslo';
$lang["select_a_user_group"] = 'Vyberte skupinu používateľov';
$lang["back_to_login"] = 'Späť na prihlásenie';
$lang["required"] = 'povinné';
$lang["select_a"] = 'Vyberte si';
$lang["notsharableresources"] = 'Nasledujúce zdroje nie sú zdieľateľné týmto používateľom a nemôžu byť pridané do zdieľanej kolekcie: ';
$lang["antispam"] = 'Antispam';
$lang["comments_body-placeholder-anon"] = 'Pridať komentár.';
$lang["batch_replace_alternatives"] = 'Nahradiť pôvodné súbory alebo alternatívne súbory';
$lang["batch_replace_upload_resources"] = 'Pôvodné súbory';
$lang["batch_replace_upload_alternatives"] = 'Alternatívne súbory';
$lang["userpreference_user_interface"] = 'Používateľské rozhranie';
$lang["systemconfig_watermark_open"] = 'Použiť vodoznak na náhľade / ukážke pre skupiny s oprávnením "w" aj keď je prístup "Open"';
$lang["systemconfig_watermark_open_search"] = 'Ak je na náhľade / ukážke použitý vodoznak (vyššie uvedená možnosť), tiež aplikujte vodoznak na stránku vyhľadávania';
$lang["systemconfig_minyear"] = 'Najskorší dátum na zahrnutie do výberu dátumu vo vyhľadávacom formulári. Zvyčajne rok prvého nahrania';
$lang["systemconfig_searchbyday"] = 'Zahrnúť deň do vyhľadávania okrem mesiaca / roka';
$lang["systemconfig_default_collection_sort"] = 'Predvolené zoradenie pri prezeraní zdrojov v kolekcii. Keď používateľ očakáva, že zdroje budú zobrazené v poradí, v akom boli poskytnuté, malo by to byť zoradenie kolekcie';
$lang["systemconfig_systemconfig_searchbyday"] = 'Zobraziť stav pracovného postupu zdroja (ikona a text) vo výsledkoch vyhľadávania pri režime zobrazenia náhľadov';
$lang["systemconfig_category_tree_search_use_and"] = 'Výber hodnoty v poli stromu kategórií na stránke vyhľadávania automaticky vyberie všetky nadriadené hodnoty';
$lang["systemconfig_category_tree_search_use_and_logic"] = 'Pre vyhľadanie musia byť prítomné všetky vybrané hodnoty stromu kategórií (nevybranie žiadnej bude hľadať zhody pre akúkoľvek vybranú hodnotu)';
$lang["systemconfig_recent_search_quantity"] = 'Počet zobrazených zdrojov s odkazmi na Nedávne a Nové materiály';
$lang["systemconfig_general"] = 'Všeobecné';
$lang["systemconfig_date_yyyy"] = 'Zobraziť rok v štyrmi číslicami';
$lang["systemconfig_imperial_measurements"] = 'Použiť imperiálne namiesto metrických jednotiek pre smernice veľkosti sťahovania';
$lang["systemconfig_site_text_custom_create"] = 'Povoliť vytváranie nových záznamov textu stránky z Manage Content (určené na vývoj nových stránok)';
$lang["systemconfig_no_welcometext"] = 'Skryť uvítací text na domovskej stránke';
$lang["systemconfig_internal_preview_sizes_editable"] = 'Povoliť úpravu vnútorných veľkostí';
$lang["systemconfig_edit_autosave"] = 'Automaticky ukladať zmeny na stránke úprav. Ak nie, tlačidlo Uložiť musí byť použité';
$lang["systemconfig_resource_request_reason_required"] = 'Pri žiadosti o zdroj alebo zdroje je pole "Dôvod žiadosti" povinné';
$lang["systemconfig_research_request"] = 'Povoliť funkciu Výskumná žiadosť';
$lang["systemconfig_custom_access"] = 'Povoliť úroveň "vlastný prístup" pre dodatočnú kontrolu prístupu k zdrojom';
$lang["systemconfig_enable_related_resources"] = 'Povoliť pole "Súvisiace zdroje" pri úprave zdrojov';
$lang["systemconfig_user_accounts"] = 'Užívateľské účty';
$lang["systemconfig_inactive_user_disable_days"] = 'Automaticky deaktivovať neaktívnych používateľov po stanovenom počte dní (0 vypne túto funkciu)';
$lang["systemconfig_sharing"] = 'Zdieľanie';
$lang["systemconfig_external_share_groups_config_options"] = 'Rešpektovať možnosti konfigurácie skupín pri zdieľaní externe ako konkrétna skupina používateľov';
$lang["systemconfig_resource_share_expire_days_default"] = 'Predvolený počet dní na výber pre vypršanie zdieľania (nastavte 0 na použitie prvej možnosti)';
$lang["systemconfig_restricted_share"] = 'Mali by mať tí, ktorí majú "obmedzený" prístup k zdroju, možnosť zdieľať zdroj';
$lang["systemconfig_blank_edit_template"] = 'Pri nahrávaní zdrojov (hromadné nahrávanie) a úprave šablóny, resetovať hodnoty na prázdne alebo predvolenú hodnotu pri každom nahrávaní';
$lang["systemconfig_enable_copy_data_from"] = 'Pri hromadnom nahrávaní povoliť funkciu "Kopírovať údaje o zdroji z existujúceho zdroja"';
$lang["systemconfig_resource_view"] = 'Zobrazenie zdroja';
$lang["systemconfig_show_resourceid"] = 'Zobraziť ID zdroja na stránke zobrazenia';
$lang["systemconfig_show_resource_type"] = 'Zobraziť typ zdroja na stránke zobrazenia';
$lang["systemconfig_show_access_field"] = 'Zobraziť prístup k zdroju na stránke zobrazenia';
$lang["systemconfig_show_contributed_by"] = 'Zobraziť používateľa "prispel" na stránke zobrazenia';
$lang["systemconfig_show_related_themes"] = 'Zobraziť súvisiace kolekcie a panel verejných kolekcií na stránke zobrazenia';
$lang["systemconfig_metadata_download"] = 'Zobraziť možnosť "Stiahnuť metadata" na stránke zobrazenia';
$lang["systemconfig_uploading"] = 'Nahrávam';
$lang["systemconfig_upload_add_to_new_collection"] = '"Pridať do novej zbierky" bude použitá pre dávkové nahrávanie. Vypnite, aby sa predvolene použilo "Nepridať do zbierky"';
$lang["systemconfig_upload_add_to_new_collection_opt"] = 'Pre dávkové nahrávanie povolte možnosť "Pridať do novej zbierky"';
$lang["systemconfig_upload_do_not_add_to_new_collection_opt"] = 'Pre dávkové nahrávanie povolte možnosť "Nepridať do zbierky" (ak nebude povolené, nahrávanie bude vynútené do zbierky)';
$lang["systemconfig_upload_collection_name_required"] = 'Vyžadovať zadanie názvu zbierky pre dávkové nahrávanie. Prehmatne predvolené správanie Upload[timestamp]';
$lang["systemconfig_allow_password_change"] = 'Povoliť zmenu hesla';
$lang["systemconfig_allow_password_reset"] = 'Povoliť používateľom požadovať nové heslo cez prihlasovaciu obrazovku';
$lang["systemconfig_allow_keep_logged_in"] = 'Zobraziť možnosť "Zostať prihlásený na tomto zariadení" na prihlasovacej obrazovke';
$lang["systemconfig_remember_me_checked"] = 'Možnosť "Zostať prihlásený na tomto zariadení" je predvolene vybraná';
$lang["systemconfig_session_length"] = 'Dĺžka používateľskej relácie (minúty)';
$lang["systemconfig_session_autologout"] = 'Automaticky odhlásiť používateľa na konci relácie (neaktívny čas rovný dĺžke relácie)';
$lang["systemconfig_slideshow_photo_delay"] = 'Počet sekúnd, ktoré má slideshow čakať pred zmenou obrázka';
$lang["config_integer_invalid_range"] = 'Neplatná hodnota. Zadajte číslo medzi %MIN% a %MAX%';
$lang["alternative_file_replaced"] = 'Alternatívny súbor bol úspešne nahradený';
$lang["jq_create_alt_previews_success_text"] = 'Náhľady boli úspešne vytvorené pre alternatívny súbor #%ALTFILE';
$lang["jq_create_alt_previews_failure_text"] = 'Nepodarilo sa vytvoriť náhľady pre alternatívny súbor #%ALTFILE';
$lang["error_report_execution"] = 'Pri spúšťaní správy došlo k chybe, skontrolujte, či je dotaz platný';
$lang["error_save_not_allowed_dash_tile_set_public"] = 'Uloženie zmeny nie je povolené. Uistite sa, že pre všetkých alebo viacerých používateľov nie sú nastavené dlaždice panelu, ktoré sú prepojené s touto kolekciou';
$lang["error_upload_replace_alternative_file_not_found"] = 'Nepodarilo sa aktualizovať alternatívny súbor. Nenašiel sa žiadny zodpovedajúci záznam o alternatívnom súbore s názvom [filename]';
$lang["error_upload_replace_alternative_multiple_found"] = 'Nepodarilo sa aktualizovať alternatívny súbor. Nájdených je viacero zodpovedajúcich záznamov o alternatívnom súbore s názvom [filename], obmedzené na ID zdroja alebo kolekciu';
$lang["oj-batch-replace-local-alternatives-success-text"] = 'Hromadná výmena úspešne nahradila %TOTALFILES alternatívnych súborov';
$lang["replacebatch_collection_alternatives"] = 'Zadajte ID kolekcie, ak chcete pridať alebo nahradiť alternatívne súbory iba pre zdroje v tejto kolekcii';
$lang["replacebatch_resource_min_alternatives"] = 'Najnižšie ID zdroja na výmenu alternatívnych súborov (ignoruje sa, ak je zadaná kolekcia)';
$lang["replacebatch_resource_max_alternatives"] = 'Najvyššie ID zdroja na výmenu alternatívnych súborov';
$lang["system_config_search_engines"] = 'Vyhľadávacie nástroje';
$lang["int_ranges_empty"] = 'Vstup je prázdny';
$lang["int_ranges_range_below_1"] = 'Čísla musia byť 1 alebo väčšie v rozsahu %%PART%%';
$lang["int_ranges_range_reversed"] = 'Začiatok rozsahu %%PART%% nemôže byť väčší ako koniec';
$lang["int_ranges_range_above_max"] = 'Rozsah %%PART%% prekračuje maximálnu hodnotu %%MAX_VAL%%';
$lang["int_ranges_single_below_1"] = 'Čísla musia byť 1 alebo väčšie (%%PART%%)';
$lang["int_ranges_single_above_max"] = '%%PART%% presahuje maximálny počet %%MAX_VAL%%';
$lang["int_ranges_not_valid"] = '%%PART%% nie je platné číslo alebo rozsah (použite formáty ako 3 alebo 5-9)';
$lang["job_trigger"] = 'Spustiť úlohu';
$lang["job_configure"] = 'Konfigurovať úlohu';
$lang["jobs_action_stream_log"] = 'Sledovať protokol súboru';
$lang["jobs_action_download_log"] = 'Stiahnuť protokol súboru';
$lang["jobs_action_not_started"] = 'Úloha ešte nezačala';
$lang["jobs_action_missing_job_progress"] = 'Nemožno načítať priebeh úlohy';
$lang["job_action_not_found"] = 'Úloha nebola nájdená.';
$lang["job_list_core"] = 'Jadro';
$lang["job_list_recreate_previews"] = 'Znova vytvoriť náhľady';
$lang["job_list_exif_data"] = 'Znovu generovať údaje EXIF';
$lang["job_list_purge_duplicates"] = 'Odstrániť duplicitné zdroje';
$lang["job_list_reindex"] = 'Preindexovať údaje';
$lang["job_list_checksums"] = 'Aktualizovať kontrolné súčty';
$lang["job_list_extracted_text"] = 'Aktualizovať extrahovaný text';
$lang["oj_common_create_job"] = 'Vytvoriť úlohu';
$lang["oj_common_field_refs"] = 'Odkazy na polia';
$lang["oj_common_collection_refs"] = 'Odkazy na zbierky';
$lang["oj_common_error_required"] = 'Povinné pole';
$lang["oj_common_error_invalid"] = 'Neplatná hodnota zadaná pre pole';
$lang["oj_common_error_invalid_field_ref"] = '%FIELD_REF% neodkazuje na platné pole';
$lang["oj_recreate_previews_target"] = 'Aký typ odkazov je poskytnutý?';
$lang["oj_recreate_previews_refs"] = 'Odkazy';
$lang["oj_recreate_previews_image_sizes"] = 'Veľkosti obrázkov na generovanie';
$lang["oj_recreate_previews_resource_types"] = 'Typy zdrojov na cielenie';
$lang["oj_recreate_previews_use_existing"] = 'Použiť existujúce nahrané náhľady?';
$lang["oj_recreate_previews_video_update"] = 'Aktualizovať náhľady pre všetky video zdroje, ktoré nemajú požadované rozšírenie \'$ffmpeg_preview_extension\'?';
$lang["oj_recreate_previews_delete_existing"] = 'Vymazať všetky existujúce náhľady';
$lang["oj_recreate_previews_refs_help"] = 'Nastavenie tejto možnosti riadi, aké odkazy (buď odkazy na zdroje alebo zbierky) budú použité na spracovanie. Platné vstupy zahŕňajú zoznamy oddelené čiarkou, rozsahy a zástupné znaky, napr. * by spracoval všetky odkazy, 1-100 by spracoval prvých 100 odkazov, 101-* by spracoval odkazy od 101 a ďalej a 1,3,5 by spracoval odkazy 1, 3 a 5. Tieto môžu byť kombinované na presné zacielenie odkazov, napr. 1,5-10,15-* by zacielil 1, 5 až 10 a 15 a ďalej.';
$lang["oj_recreate_previews_use_existing_help"] = 'Nastavením tejto možnosti sa pokúsi zachovať akékoľvek náhľady, ktoré boli manuálne nahradené na zdrojoch. Ak sa nepoužije, akékoľvek manuálne nahrané náhľady budú nahradené náhľadmi odvodenými z pôvodného súboru.';
$lang["oj_recreate_previews_video_update_help"] = 'Nastavením tejto možnosti sa aktualizujú všetky videá, ktoré nezodpovedajú aktuálne nakonfigurovanej prípony \'$ffmpeg_preview_extension\'. To je užitočné, keď bola táto možnosť zmenená, aby sa zamerala iba na tie zdroje, ktoré potrebujú nový náhľad.';
$lang["oj_recreate_previews_delete_existing_help"] = 'Nastavením tejto možnosti sa odstránia všetky existujúce náhľady pred ich opätovným vytvorením.';
$lang["oj_exif_data_blanks"] = 'Prázdna hodnota poľa, ak neexistujú žiadne údaje EXIF';
$lang["oj_exif_data_overwrite"] = 'Prepísať existujúce hodnoty poľa, ak existujú údaje EXIF';
$lang["oj_exif_data_field_refs_help"] = 'Toto sú referencie na polia, pre ktoré chcete extrahovať údaje EXIF. Tieto polia musia mať nakonfigurované "Exiftool field". Môže sa použiť čiarkou oddelený zoznam na špecifikáciu polí, napr. 1,3,5.';
$lang["oj_exif_data_collection_refs_help"] = 'Nastavením tejto možnosti sa aktualizujú iba zdroje v uvedených zbierkach. Ak nie sú uvedené žiadne zbierky, budú aktualizované údaje EXIF pre VŠETKY vhodné zdroje. Zbierky môžu byť špecifikované pomocou zoznamu oddeleného čiarkami alebo rozsahov, napr. 100,105,110-115.';
$lang["oj_exif_data_blanks_help"] = 'Nastavením tejto možnosti sa dané pole vyčistí, ak súbor neobsahuje žiadne vložené údaje EXIF pre toto pole.';
$lang["oj_exif_data_overwrite_help"] = 'Nastavením tejto možnosti sa dané pole prepíše akoukoľvek existujúcou hodnotou vložených údajov EXIF, ak sú v súbore prítomné.';
$lang["oj_purge_duplicates_intro"] = '<strong>Upozornenie: Tento skript umožňuje TRVALÉ MAZANIE zdrojov - ak si nie ste istí, použite možnosť Suchý beh na overenie nastavení.<\\/strong>';
$lang["oj_purge_duplicates_manage_method"] = 'Metóda správy';
$lang["oj_purge_duplicates_lifo"] = 'Zachovať najstaršie a odstrániť novšie duplikáty';
$lang["oj_purge_duplicates_fifo"] = 'Zachovať najnovšie a odstrániť staršie duplikáty';
$lang["oj_purge_duplicates_dry_run"] = 'Suchý beh';
$lang["oj_purge_duplicates_delete_perm"] = 'Trvalo odstrániť';
$lang["oj_purge_duplicates_delete_error"] = 'Trvalé odstránenie nie je možné počas suchého behu';
$lang["oj_purge_duplicates_collection_refs_help"] = 'Nastaví zbierky ako rozsah detekcie duplikátov. Nie je potrebné mať všetky duplikáty v zbierkach, postačí jeden z nich. Duplikáty budú následne spracované systémovo a odstránené pomocou vybranej metódy správy. Zbierky je možné špecifikovať pomocou zoznamu oddeleného čiarkami alebo rozsahov, napríklad 100,105,110-115';
$lang["oj_purge_duplicates_manage_method_help"] = 'Nastavenie tejto možnosti riadi, ako skript zaobchádza s odstraňovaním duplikátov.';
$lang["oj_purge_duplicates_dry_run_help"] = 'Nastavenie tejto možnosti vykoná skúšobný beh bez akýchkoľvek zmien na akýchkoľvek zdrojoch. Súbor s logom obsahujúcim výsledky skúšobného behu je možné stiahnuť na prehliadanie.';
$lang["oj_purge_duplicates_delete_perm_help"] = 'Nastavenie tejto možnosti spôsobí, že duplikované zdroje budú trvalo odstránené, inak budú presunuté do nastaveného stavu vymazania zdrojov.';
$lang["oj_reindex_field_refs_help"] = 'Nastavenie tejto možnosti obmedzí, ktoré polia budú reindexované, môže sa použiť zoznam oddelený čiarkami na špecifikáciu polí, napríklad 1,3,5. Ak nie sú zadané žiadne polia, budú reindexované VŠETKY polia.';
$lang["oj_checksums_recreate"] = 'Znova vytvoriť všetky kontrolné súčty';
$lang["oj_checksums_recreate_help"] = 'Nastavenie tejto možnosti vynúti, aby boli všetky kontrolné súčty zdrojov znovu vytvorené, nie len tie, ktoré momentálne nemajú existujúci kontrolný súčet.';
$lang["oj_extracted_text_update_all"] = 'Aktualizovať aj v prípade, že existujú údaje, a prepísať staré hodnoty';
$lang["oj_extracted_text_collection_refs_help"] = 'Nastavenie tejto možnosti obmedzí spracované zdroje iba na tie v uvedených zbierkach. Ak nie sú zbierky špecifikované, bude aktualizovaný extrahovaný text pre VŠETKY vhodné zdroje. Zbierky je možné špecifikovať pomocou zoznamu oddeleného čiarkami alebo rozsahov, napríklad 100,105,110-115';
$lang["oj_extracted_text_update_all_help"] = 'Nastavenie tejto možnosti spustí extrakciu aj v prípade, že existujú údaje, a prepíše starú hodnotu.';
$lang["requiredfield_multiple"] = 'Toto je povinné pole pri zmene stavu archívu';
$lang["reorder_invalid"] = 'Zbierku nie je možné preusporiadať, pokiaľ nie je zoradenie podľa poradia zbierky';
$lang["reorder_permissions_fail"] = 'Zbierku nie je možné preusporiadať, pretože nemáte prístup ku všetkým zdrojom v tejto zbierke';
$lang["resource-card-menu-delete"] = 'Ste si istí, že chcete odstrániť tento zdroj?';
...
$lang["red"] = 'Červená';
$lang["purple"] = 'Fialová';
$lang["fieldtype-geo_location"] = 'Geolokácia';
$lang["property-geomapping"] = 'Typ geolokácie';
$lang["information-geomapping"] = 'Uložte geolokáciu do tohto poľa ako šírku, dĺžku alebo oboje.<br \\/>Môže byť nastavené iba jedno pole na oboje alebo jedno pole na šírku a jedno na dĺžku.<br \\/>K dispozícii iba pre textové polia na jeden riadok.';
$lang["disabled-geomapping-title"] = 'Geolokácia je nastavená na iné pole alebo polia, na jej zmenu ju musíte odstrániť z iných polí';
$lang["geo_location-none"] = 'Žiadne';
$lang["geo_location-latitude"] = 'Šírka';
$lang["geo_location-longitude"] = 'Dĺžka';
$lang["geo_location-both"] = 'Oboje';
$lang["knowledgebase"] = 'Znalostná báza';
$lang["search_filter_panel_toggle"] = 'Prepnúť filtre vyhľadávania';
$lang["search_resources"] = 'Hľadať zdroje';
$lang["clear_filters"] = 'Vymazať filtre';
$lang["save-error-invalid-latlong"] = 'Chyba pri automatickom ukladaní - neplatná geolokácia, Použite: šírka, dĺžka (napr. 40.7128, -74.0060). Poloha zdroja nebola aktualizovaná.';
$lang["save-error-invalid-lat"] = 'Chyba pri automatickom ukladaní - neplatná šírka, musí byť medzi -90 a 90. Poloha zdroja nebola aktualizovaná.';
$lang["save-error-invalid-long"] = 'Chyba pri automatickom ukladaní - neplatná dĺžka, musí byť medzi -180 a 180. Poloha zdroja nebola aktualizovaná.';
$lang["or"] = 'alebo';
$lang["view_all_fcs"] = 'Zobraziť všetky zvýraznené kolekcie';
$lang["dashtile_upload"] = 'Pridať zdroje do systému';
$lang["knowledgebase-tooltip"] = 'Zobraziť dokumentáciu ResourceSpace (Znalostná báza)';
$lang["noresources_collection"] = 'V kolekcii nie sú žiadne zdroje';
$lang["hide_collection_bar"] = 'Skryté';
$lang["minimal_collection_bar"] = 'Minimálna lišta';
$lang["thumbnails_collection_bar"] = 'Náhľady';
$lang["language-bg"] = 'Bulharčina';
