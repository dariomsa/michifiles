...
$lang["csv_upload_create_new"] = 'Crear nous recursos';
$lang["csv_upload_create_alternatives"] = 'Crear registres de fitxers alternatius';
$lang["csv_upload_create_alternatives_title"] = 'Crear registres de fitxers alternatius';
$lang["csv_upload_create_alternatives_notes"] = 'Selecciona les opcions necessàries per crear nous registres de fitxers alternatius';
$lang["csv_upload_multiple_match_all"] = 'Actualitzar tot el que coincideix';
$lang["csv_upload_multiple_match_none"] = 'No actualitzar cap';
$lang["csv_upload_alternative_file_filename_column"] = 'Selecciona la columna que conté el nom de fitxer per a l\'alternativa';
$lang["csv_upload_alternative_file_name_column"] = 'Selecciona la columna que conté el nom per utilitzar per al registre de fitxer alternatiu (opcional)';
$lang["csv_upload_alternative_file_description_column"] = 'Selecciona la columna que conté la descripció per al registre de fitxer alternatiu (opcional)';
$lang["csv_upload_condition9"] = 'Per actualitzar la ubicació, els valors de latitud i longitud s\'han de combinar en una sola columna amb un separador de comes o en dos camps diferents.';
$lang["csv_upload_location"] = 'Selecciona la columna que conté la ubicació de la recurs, o Latitud si s\'utilitzen columnes separades';
$lang["csv_upload_longitude"] = 'Selecciona la columna de Longitud si és separada de la columna anterior';
