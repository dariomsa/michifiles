...
$lang["processing_batch_edit_save"] = 'række [row_number] af [rows_count]';
$lang["page-title_csv_upload_csv_upload"] = 'Upload CSV';
$lang["csv_upload_create_new"] = 'Opret nye ressourcer';
$lang["csv_upload_create_alternatives"] = 'Opret alternative filoplysninger';
$lang["csv_upload_create_alternatives_title"] = 'Opret alternative filoplysninger';
$lang["csv_upload_create_alternatives_notes"] = 'Vælg de muligheder, der skal bruges til at oprette nye alternative filoplysninger';
$lang["csv_upload_multiple_match_all"] = 'Opdater alle matchende';
$lang["csv_upload_multiple_match_none"] = 'Opdater ingen';
$lang["csv_upload_alternative_file_filename_column"] = 'Vælg kolonnen, der indeholder filnavnet til den alternative fil';
$lang["csv_upload_alternative_file_name_column"] = 'Vælg kolonnen, der indeholder navnet til brug for den alternative filoplysning (valgfrit)';
$lang["csv_upload_alternative_file_description_column"] = 'Vælg kolonnen, der indeholder beskrivelsen for den alternative filoplysning (valgfrit)';
$lang["csv_upload_condition9"] = 'For at opdatere placering skal værdierne for breddegrad og længdegrad kombineres i én kolonne med komma som separator eller i to forskellige felter.';
$lang["csv_upload_location"] = 'Vælg den kolonne, der indeholder placeringen for ressourcen, eller Breddegrad, hvis der bruges separate kolonner';
$lang["csv_upload_longitude"] = 'Vælg kolonnen for Længdegrad, hvis den er adskilt fra ovenstående kolonne';
