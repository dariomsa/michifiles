...
$lang["csv_upload_create_new"] = 'Создать новые ресурсы';
$lang["csv_upload_create_alternatives"] = 'Создать записи альтернативных файлов';
$lang["csv_upload_create_alternatives_title"] = 'Создать записи альтернативных файлов';
$lang["csv_upload_create_alternatives_notes"] = 'Выберите необходимые параметры для создания новых записей альтернативных файлов';
$lang["csv_upload_multiple_match_all"] = 'Обновить все совпадения';
$lang["csv_upload_multiple_match_none"] = 'Не обновлять';
$lang["csv_upload_alternative_file_filename_column"] = 'Выберите столбец, содержащий имя файла для альтернативного файла';
$lang["csv_upload_alternative_file_name_column"] = 'Выберите столбец, содержащий имя для записи альтернативного файла (опционально)';
$lang["csv_upload_alternative_file_description_column"] = 'Выберите столбец, содержащий описание для записи альтернативного файла (опционально)';
$lang["csv_upload_condition9"] = 'Чтобы обновить местоположение, значения широты и долготы должны быть объединены в один столбец с разделителем запятой или в два разных поля.';
$lang["csv_upload_location"] = 'Выберите столбец, содержащий местоположение ресурса, или широту, если используются отдельные столбцы';
$lang["csv_upload_longitude"] = 'Выберите столбец для долготы, если он отделён от вышеуказанного столбца';
