...
$lang["csv_upload_create_new"] = 'Vytvoriť nové zdroje';
$lang["csv_upload_create_alternatives"] = 'Vytvoriť záznamy alternatívnych súborov';
$lang["csv_upload_create_alternatives_title"] = 'Vytvoriť záznamy alternatívnych súborov';
$lang["csv_upload_create_alternatives_notes"] = 'Vyberte požadované možnosti na vytvorenie nových záznamov alternatívnych súborov';
$lang["csv_upload_multiple_match_all"] = 'Aktualizovať všetky zodpovedajúce';
$lang["csv_upload_multiple_match_none"] = 'Neaktualizovať žiadne';
$lang["csv_upload_alternative_file_filename_column"] = 'Vyberte stĺpec, ktorý obsahuje názov súboru pre alternatívny súbor';
$lang["csv_upload_alternative_file_name_column"] = 'Vyberte stĺpec, ktorý obsahuje názov, ktorý sa má použiť pre záznam alternatívneho súboru (voliteľné)';
$lang["csv_upload_alternative_file_description_column"] = 'Vyberte stĺpec, ktorý obsahuje popis pre záznam alternatívneho súboru (voliteľné)';
$lang["csv_upload_condition9"] = 'Na aktualizáciu umiestnenia musia byť hodnoty zemepisnej šírky a dĺžky kombinované v jednom stĺpci s čiarkou ako oddeľovač alebo v dvoch rôznych poliach.';
$lang["csv_upload_location"] = 'Vyberte stĺpec, ktorý obsahuje umiestnenie zdroja, alebo Zemepisnú šírku, ak používate samostatné stĺpce';
$lang["csv_upload_longitude"] = 'Vyberte stĺpec pre Dĺžku, ak je oddelený od vyššie uvedeného stĺpca';
