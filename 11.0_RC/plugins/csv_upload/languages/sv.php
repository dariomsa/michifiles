...
$lang["csv_upload_create_new"] = 'Skapa nya resurser';
$lang["csv_upload_create_alternatives"] = 'Skapa alternativa filposter';
$lang["csv_upload_create_alternatives_title"] = 'Skapa alternativa filposter';
$lang["csv_upload_create_alternatives_notes"] = 'Välj de alternativ som krävs för att skapa nya alternativa filposter';
$lang["csv_upload_multiple_match_all"] = 'Uppdatera alla matchande';
$lang["csv_upload_multiple_match_none"] = 'Uppdatera ingen';
$lang["csv_upload_alternative_file_filename_column"] = 'Välj kolumnen som innehåller filnamnet för den alternativa filen';
$lang["csv_upload_alternative_file_name_column"] = 'Välj kolumnen som innehåller namnet att använda för den alternativa filposten (valfritt)';
$lang["csv_upload_alternative_file_description_column"] = 'Välj kolumnen som innehåller beskrivningen för den alternativa filposten (valfritt)';
$lang["csv_upload_condition9"] = 'För att uppdatera plats, latitud och longitud måste värdena kombineras i en kolumn med kommatecken som separator eller i två olika fält.';
$lang["csv_upload_location"] = 'Välj kolumnen som innehåller platsen för resursen, eller Latitude om du använder separata kolumner';
$lang["csv_upload_longitude"] = 'Välj kolumnen för Longitud om den är separat från kolumnen ovan';
