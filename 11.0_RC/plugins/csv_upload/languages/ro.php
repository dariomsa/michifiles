...
$lang["csv_upload_create_new"] = 'Creează resurse noi';
$lang["csv_upload_create_alternatives"] = 'Creează înregistrări de fișiere alternative';
$lang["csv_upload_create_alternatives_title"] = 'Creează înregistrări de fișiere alternative';
$lang["csv_upload_create_alternatives_notes"] = 'Selectați opțiunile necesare pentru a crea înregistrări de fișiere alternative noi';
$lang["csv_upload_multiple_match_all"] = 'Actualizează pe toate cele care se potrivesc';
$lang["csv_upload_multiple_match_none"] = 'Nu actualizați nimic';
$lang["csv_upload_alternative_file_filename_column"] = 'Selectați coloana care conține numele fișierului pentru fișierul alternativ';
$lang["csv_upload_alternative_file_name_column"] = 'Selectați coloana care conține numele de utilizat pentru înregistrarea fișierului alternativ (opțional)';
$lang["csv_upload_alternative_file_description_column"] = 'Selectați coloana care conține descrierea pentru înregistrarea fișierului alternativ (opțional)';
$lang["csv_upload_condition9"] = 'Pentru a actualiza locația, valorile de latitudine și longitudine trebuie combinate într-o singură coloană, separate prin virgulă, sau în două câmpuri diferite.';
$lang["csv_upload_location"] = 'Selectați coloana care conține locația pentru resursă sau Latitudine dacă utilizați coloane separate';
$lang["csv_upload_longitude"] = 'Selectați coloana pentru Longitudine dacă este separată de cea de mai sus';
