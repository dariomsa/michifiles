...
$lang["page-title_csv_upload_csv_upload"] = 'Завантажити CSV';
$lang["csv_upload_create_new"] = 'Створити нові ресурси';
$lang["csv_upload_create_alternatives"] = 'Створити записи альтернативних файлів';
$lang["csv_upload_create_alternatives_title"] = 'Створити записи альтернативних файлів';
$lang["csv_upload_create_alternatives_notes"] = 'Виберіть необхідні параметри для створення нових записів альтернативних файлів';
$lang["csv_upload_multiple_match_all"] = 'Оновити всі відповідності';
$lang["csv_upload_multiple_match_none"] = 'Не оновлювати';
$lang["csv_upload_alternative_file_filename_column"] = 'Виберіть стовпець, що містить ім\'я файлу для альтернативного файлу';
$lang["csv_upload_alternative_file_name_column"] = 'Виберіть стовпець, що містить ім\'я для запису альтернативного файлу (необов\'язково)';
$lang["csv_upload_alternative_file_description_column"] = 'Виберіть стовпець, що містить опис для запису альтернативного файлу (необов\'язково)';
$lang["csv_upload_condition9"] = 'Щоб оновити місцезнаходження, значення широти та довготи повинні бути об’єднані в один стовпець із комою або в двох різних полях.';
$lang["csv_upload_location"] = 'Виберіть стовпець, що містить місцезнаходження ресурсу, або Широту, якщо використовуються окремі стовпці';
$lang["csv_upload_longitude"] = 'Виберіть стовпець для Довготи, якщо він окремий від вищезазначеного стовпця';
