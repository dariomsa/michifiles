...
$lang["page-title_csv_upload_csv_upload"] = 'Télécharger CSV';
$lang["csv_upload_create_new"] = 'Créer de nouvelles ressources';
$lang["csv_upload_create_alternatives"] = 'Créer des enregistrements de fichiers alternatifs';
$lang["csv_upload_create_alternatives_title"] = 'Créer des enregistrements de fichiers alternatifs';
$lang["csv_upload_create_alternatives_notes"] = 'Sélectionnez les options nécessaires pour créer de nouveaux enregistrements de fichiers alternatifs';
$lang["csv_upload_multiple_match_all"] = 'Mettre à jour tout ce qui correspond';
$lang["csv_upload_multiple_match_none"] = 'Ne rien mettre à jour';
$lang["csv_upload_alternative_file_filename_column"] = 'Sélectionnez la colonne contenant le nom de fichier pour le fichier alternatif';
$lang["csv_upload_alternative_file_name_column"] = 'Sélectionnez la colonne contenant le nom à utiliser pour l\'enregistrement du fichier alternatif (optionnel)';
$lang["csv_upload_alternative_file_description_column"] = 'Sélectionnez la colonne contenant la description pour l\'enregistrement du fichier alternatif (optionnel)';
$lang["csv_upload_condition9"] = 'Pour mettre à jour l\'emplacement, les valeurs de latitude et de longitude doivent être combinées dans une seule colonne avec un séparateur virgule ou dans deux champs différents.';
$lang["csv_upload_location"] = 'Sélectionnez la colonne qui contient l\'emplacement de la ressource, ou Latitude si vous utilisez des colonnes séparées';
$lang["csv_upload_longitude"] = 'Sélectionnez la colonne pour la Longitude si elle est séparée de la colonne ci-dessus';
