...
$lang["csv_upload_processing"] = 'Procesando';
$lang["processing_batch_edit_save"] = 'fila [row_number] de [rows_count]';
$lang["page-title_csv_upload_csv_upload"] = 'Cargar CSV';
$lang["csv_upload_create_new"] = 'Crear nuevos recursos';
$lang["csv_upload_create_alternatives"] = 'Crear registros de archivos alternativos';
$lang["csv_upload_create_alternatives_title"] = 'Crear registros de archivos alternativos';
$lang["csv_upload_create_alternatives_notes"] = 'Selecciona las opciones necesarias para crear nuevos registros de archivos alternativos';
$lang["csv_upload_multiple_match_all"] = 'Actualizar todos los que coincidan';
$lang["csv_upload_multiple_match_none"] = 'No actualizar ninguno';
$lang["csv_upload_alternative_file_filename_column"] = 'Selecciona la columna que contiene el nombre del archivo para el archivo alternativo';
$lang["csv_upload_alternative_file_name_column"] = 'Selecciona la columna que contiene el nombre a usar para el registro de archivo alternativo (opcional)';
$lang["csv_upload_alternative_file_description_column"] = 'Selecciona la columna que contiene la descripción para el registro de archivo alternativo (opcional)';
$lang["csv_upload_condition9"] = 'Para actualizar la ubicación, los valores de latitud y longitud deben estar combinados en una sola columna con un separador de coma o en dos campos diferentes.';
$lang["csv_upload_location"] = 'Seleccione la columna que contiene la ubicación de los recursos, o Latitud si usa columnas separadas';
$lang["csv_upload_longitude"] = 'Seleccione la columna de Longitud si es separada de la columna anterior';
