...
$lang["csv_upload_create_new"] = '新しいリソースを作成';
$lang["csv_upload_create_alternatives"] = '代替ファイルレコードを作成';
$lang["csv_upload_create_alternatives_title"] = '代替ファイルレコードを作成';
$lang["csv_upload_create_alternatives_notes"] = '新しい代替ファイルレコードを作成するために必要なオプションを選択してください';
$lang["csv_upload_multiple_match_all"] = 'すべて一致するものを更新';
$lang["csv_upload_multiple_match_none"] = '何も更新しない';
$lang["csv_upload_alternative_file_filename_column"] = '代替ファイルのファイル名を含む列を選択';
$lang["csv_upload_alternative_file_name_column"] = '代替ファイルレコードに使用する名前を含む列を選択（任意）';
$lang["csv_upload_alternative_file_description_column"] = '代替ファイルレコードの説明を含む列を選択（任意）';
$lang["csv_upload_condition9"] = '場所を更新するには、緯度と経度の値をカンマ区切りの1つの列にまとめるか、別々のフィールドにしてください。';
$lang["csv_upload_location"] = 'リソースの場所を含む列を選択してください。別々の列を使用している場合は緯度を選択してください。';
$lang["csv_upload_longitude"] = '別の列に経度がある場合は、その列を選択してください。';
$lang["latitude"] = '緯度';
$lang["longitude"] = '経度';