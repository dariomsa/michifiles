...
$lang["csv_upload_create_new"] = 'Maak nieuwe bronnen aan';
$lang["csv_upload_create_alternatives"] = 'Maak alternatieve bestandsrecords aan';
$lang["csv_upload_create_alternatives_title"] = 'Maak alternatieve bestandsrecords aan';
$lang["csv_upload_create_alternatives_notes"] = 'Selecteer de opties die nodig zijn om nieuwe alternatieve bestandsrecords te maken';
$lang["csv_upload_multiple_match_all"] = 'Werk alle overeenkomende bij';
$lang["csv_upload_multiple_match_none"] = 'Werk geen enkele bij';
$lang["csv_upload_alternative_file_filename_column"] = 'Selecteer de kolom die de bestandsnaam voor het alternatieve bestand bevat';
$lang["csv_upload_alternative_file_name_column"] = 'Selecteer de kolom die de naam bevat die gebruikt moet worden voor het alternatieve bestandsrecord (optioneel)';
$lang["csv_upload_alternative_file_description_column"] = 'Selecteer de kolom die de beschrijving bevat voor het alternatieve bestandsrecord (optioneel)';
$lang["csv_upload_condition9"] = 'Om de locatie bij te werken, moeten de waarden voor locatie, breedtegraad en lengtegraad worden gecombineerd in één kolom met een komma-alscheiding of in twee verschillende velden.';
$lang["csv_upload_location"] = 'Selecteer de kolom die de locatie voor de bron bevat, of Breedtegraad als u aparte kolommen gebruikt';
$lang["csv_upload_longitude"] = 'Selecteer de kolom voor Lengtegraad als deze apart is van de bovenstaande kolom';
