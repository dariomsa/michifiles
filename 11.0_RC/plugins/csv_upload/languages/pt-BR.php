...
$lang["csv_upload_create_new"] = 'Criar novos recursos';
$lang["csv_upload_create_alternatives"] = 'Criar registros de arquivos alternativos';
$lang["csv_upload_create_alternatives_title"] = 'Criar registros de arquivos alternativos';
$lang["csv_upload_create_alternatives_notes"] = 'Selecione as opções necessárias para criar novos registros de arquivos alternativos';
$lang["csv_upload_multiple_match_all"] = 'Atualizar todos os correspondentes';
$lang["csv_upload_multiple_match_none"] = 'Não atualizar nenhum';
$lang["csv_upload_alternative_file_filename_column"] = 'Selecione a coluna que contém o nome do arquivo para o arquivo alternativo';
$lang["csv_upload_alternative_file_name_column"] = 'Selecione a coluna que contém o nome a ser usado para o registro de arquivo alternativo (opcional)';
$lang["csv_upload_alternative_file_description_column"] = 'Selecione a coluna que contém a descrição para o registro de arquivo alternativo (opcional)';
$lang["csv_upload_condition9"] = 'Para atualizar a localização, os valores de latitude e longitude devem estar combinados em uma única coluna com separador de vírgula ou em dois campos diferentes.';
$lang["csv_upload_location"] = 'Selecione a coluna que contém a localização do recurso, ou Latitude se usar colunas separadas';
$lang["csv_upload_longitude"] = 'Selecione a coluna de Longitude se for separada da coluna acima';
