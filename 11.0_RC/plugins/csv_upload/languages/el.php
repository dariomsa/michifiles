...
$lang["csv_upload_create_new"] = 'Δημιουργία νέων πόρων';
$lang["csv_upload_create_alternatives"] = 'Δημιουργία εναλλακτικών αρχείων';
$lang["csv_upload_create_alternatives_title"] = 'Δημιουργία εναλλακτικών αρχείων';
$lang["csv_upload_create_alternatives_notes"] = 'Επιλέξτε τις επιλογές που απαιτούνται για τη δημιουργία νέων εναλλακτικών αρχείων';
$lang["csv_upload_multiple_match_all"] = 'Ενημέρωση όλων των ταιριασμάτων';
$lang["csv_upload_multiple_match_none"] = 'Καμία ενημέρωση';
$lang["csv_upload_alternative_file_filename_column"] = 'Επιλέξτε τη στήλη που περιέχει το όνομα αρχείου για το εναλλακτικό αρχείο';
$lang["csv_upload_alternative_file_name_column"] = 'Επιλέξτε τη στήλη που περιέχει το όνομα που θα χρησιμοποιηθεί για την εγγραφή εναλλακτικού αρχείου (προαιρετικό)';
$lang["csv_upload_alternative_file_description_column"] = 'Επιλέξτε τη στήλη που περιέχει την περιγραφή για την εγγραφή εναλλακτικού αρχείου (προαιρετικό)';
$lang["csv_upload_condition9"] = 'Για να ενημερώσετε την τοποθεσία, οι τιμές γεωγραφικού πλάτους και μήκους πρέπει να συνδυαστούν σε μια στήλη με διαχωριστικό κόμμα ή σε δύο διαφορετικά πεδία.';
$lang["csv_upload_location"] = 'Επιλέξτε τη στήλη που περιέχει την τοποθεσία για τον πόρο, ή το Γεωγραφικό πλάτος εάν χρησιμοποιούνται ξεχωριστές στήλες';
$lang["csv_upload_longitude"] = 'Επιλέξτε τη στήλη για το Μήκος εάν είναι ξεχωριστή από την παραπάνω στήλη';
