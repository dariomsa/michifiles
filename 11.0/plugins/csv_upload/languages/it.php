...
$lang["csv_upload_validating"] = 'Validazione';
$lang["csv_upload_processing"] = 'Elaborazione';
$lang["processing_batch_edit_save"] = 'riga [row_number] di [rows_count]';
$lang["page-title_csv_upload_csv_upload"] = 'Carica CSV';
$lang["csv_upload_create_new"] = 'Crea nuove risorse';
$lang["csv_upload_create_alternatives"] = 'Crea record di file alternativi';
$lang["csv_upload_create_alternatives_title"] = 'Crea record di file alternativi';
$lang["csv_upload_create_alternatives_notes"] = 'Seleziona le opzioni necessarie per creare nuovi record di file alternativi';
$lang["csv_upload_multiple_match_all"] = 'Aggiorna tutto ciò che corrisponde';
$lang["csv_upload_multiple_match_none"] = 'Non aggiornare nulla';
$lang["csv_upload_alternative_file_filename_column"] = 'Seleziona la colonna che contiene il nome del file per il file alternativo';
$lang["csv_upload_alternative_file_name_column"] = 'Seleziona la colonna che contiene il nome da usare per il record del file alternativo (opzionale)';
$lang["csv_upload_alternative_file_description_column"] = 'Seleziona la colonna che contiene la descrizione per il record del file alternativo (opzionale)';
$lang["csv_upload_condition9"] = 'Per aggiornare la posizione, i valori di latitudine e longitudine devono essere combinati in una singola colonna con un separatore di virgola o in due campi diversi.';
$lang["csv_upload_location"] = 'Seleziona la colonna che contiene la posizione della risorsa, o Latitudine se si utilizzano colonne separate';
$lang["csv_upload_longitude"] = 'Seleziona la colonna per la Longitudine se separata dalla colonna sopra';
