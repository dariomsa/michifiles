...
$lang["page-title_csv_upload_csv_upload"] = 'Nahrát CSV';
$lang["csv_upload_create_new"] = 'Vytvořit nové zdroje';
$lang["csv_upload_create_alternatives"] = 'Vytvořit záznamy alternativních souborů';
$lang["csv_upload_create_alternatives_title"] = 'Vytvořit záznamy alternativních souborů';
$lang["csv_upload_create_alternatives_notes"] = 'Vyberte požadované možnosti pro vytvoření nových záznamů alternativních souborů';
$lang["csv_upload_multiple_match_all"] = 'Aktualizovat všechny shody';
$lang["csv_upload_multiple_match_none"] = 'Neaktualizovat žádné';
$lang["csv_upload_alternative_file_filename_column"] = 'Vyberte sloupec obsahující název souboru pro alternativní soubor';
$lang["csv_upload_alternative_file_name_column"] = 'Vyberte sloupec obsahující název, který se má použít pro záznam alternativního souboru (volitelné)';
$lang["csv_upload_alternative_file_description_column"] = 'Vyberte sloupec obsahující popis pro záznam alternativního souboru (volitelné)';
$lang["csv_upload_condition9"] = 'Pro aktualizaci polohy musí být hodnoty zeměpisné šířky a délky sloučeny v jednom sloupci odděleném čárkou nebo ve dvou různých polích.';
$lang["csv_upload_location"] = 'Vyberte sloupec, který obsahuje polohu zdroje, nebo Zeměpisná šířka, pokud používáte samostatné sloupce';
$lang["csv_upload_longitude"] = 'Vyberte sloupec pro Délku, pokud je oddělen od výše uvedeného sloupce';
