...
$lang["csv_upload_create_new"] = 'Luo uusia resursseja';
$lang["csv_upload_create_alternatives"] = 'Luo vaihtoehtoiset tiedostorivit';
$lang["csv_upload_create_alternatives_title"] = 'Luo vaihtoehtoiset tiedostorivit';
$lang["csv_upload_create_alternatives_notes"] = 'Valitse tarvittavat asetukset uusien vaihtoehtoisten tiedostorivien luomiseen';
$lang["csv_upload_multiple_match_all"] = 'Päivitä kaikki vastaavat';
$lang["csv_upload_multiple_match_none"] = 'Älä päivitä mitään';
$lang["csv_upload_alternative_file_filename_column"] = 'Valitse sarake, joka sisältää tiedostonimen vaihtoehtoiselle tiedostolle';
$lang["csv_upload_alternative_file_name_column"] = 'Valitse sarake, joka sisältää nimen, jota käytetään vaihtoehtoiselle tiedostoriville (valinnainen)';
$lang["csv_upload_alternative_file_description_column"] = 'Valitse sarake, joka sisältää kuvauksen vaihtoehtoiselle tiedostoriville (valinnainen)';
$lang["csv_upload_condition9"] = 'Paikantamisen päivittämiseksi sijainti, leveys- ja pituusasteet on yhdistettävä yhteen sarakkeeseen pilkkuerottimella tai ne on asetettava kahteen eri kenttään.';
$lang["csv_upload_location"] = 'Valitse sarake, joka sisältää resurssin sijainnin, tai Leveysaste, jos käytetään erillisiä sarakkeita';
$lang["csv_upload_longitude"] = 'Valitse Pituusaste-sarake, jos se on erillinen yllä olevaan sarakkeeseen';
