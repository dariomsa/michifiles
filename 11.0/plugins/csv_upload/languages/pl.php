...
$lang["csv_upload_validating"] = 'Walidacja';
$lang["csv_upload_processing"] = 'Przetwarzanie';
$lang["processing_batch_edit_save"] = 'wiersz [row_number] z [rows_count]';
$lang["page-title_csv_upload_csv_upload"] = 'Prześlij CSV';
$lang["csv_upload_create_new"] = 'Utwórz nowe zasoby';
$lang["csv_upload_create_alternatives"] = 'Utwórz rekordy plików alternatywnych';
$lang["csv_upload_create_alternatives_title"] = 'Utwórz rekordy plików alternatywnych';
$lang["csv_upload_create_alternatives_notes"] = 'Wybierz opcje wymagane do utworzenia nowych rekordów plików alternatywnych';
$lang["csv_upload_multiple_match_all"] = 'Zaktualizuj wszystko pasujące';
$lang["csv_upload_multiple_match_none"] = 'Nie aktualizuj niczego';
$lang["csv_upload_alternative_file_filename_column"] = 'Wybierz kolumnę zawierającą nazwę pliku dla pliku alternatywnego';
$lang["csv_upload_alternative_file_name_column"] = 'Wybierz kolumnę zawierającą nazwę do użycia dla rekordu pliku alternatywnego (opcjonalnie)';
$lang["csv_upload_alternative_file_description_column"] = 'Wybierz kolumnę zawierającą opis dla rekordu pliku alternatywnego (opcjonalnie)';
$lang["csv_upload_condition9"] = 'Aby zaktualizować lokalizację, wartości szerokości i długości geograficznej muszą być połączone w jednej kolumnie z separatorem przecinka lub w dwóch różnych polach.';
$lang["csv_upload_location"] = 'Wybierz kolumnę zawierającą lokalizację zasobu lub szerokość geograficzną, jeśli używasz oddzielnych kolumn';
$lang["csv_upload_longitude"] = 'Wybierz kolumnę dla długości geograficznej, jeśli jest oddzielna od powyższej kolumny';
