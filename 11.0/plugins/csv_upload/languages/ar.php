...
$lang["csv_upload_create_new"] = 'إنشاء موارد جديدة';
$lang["csv_upload_create_alternatives"] = 'إنشاء سجلات ملفات بديلة';
$lang["csv_upload_create_alternatives_title"] = 'إنشاء سجلات ملفات بديلة';
$lang["csv_upload_create_alternatives_notes"] = 'اختر الخيارات المطلوبة لإنشاء سجلات ملفات بديلة جديدة';
$lang["csv_upload_multiple_match_all"] = 'تحديث الكل المطابق';
$lang["csv_upload_multiple_match_none"] = 'عدم التحديث';
$lang["csv_upload_alternative_file_filename_column"] = 'اختر العمود الذي يحتوي على اسم الملف للملف البديل';
$lang["csv_upload_alternative_file_name_column"] = 'اختر العمود الذي يحتوي على الاسم لاستخدامه في سجل الملف البديل (اختياري)';
$lang["csv_upload_alternative_file_description_column"] = 'اختر العمود الذي يحتوي على الوصف لسجل الملف البديل (اختياري)';
$lang["csv_upload_condition9"] = 'لتحديث الموقع، يجب دمج قيم خطوط الطول والعرض في عمود واحد بفاصل فاصلة أو في حقلين مختلفين.';
$lang["csv_upload_location"] = 'اختر العمود الذي يحتوي على الموقع للموارد، أو خط العرض إذا كنت تستخدم أعمدة منفصلة';
$lang["csv_upload_longitude"] = 'اختر العمود الخاص بخط الطول إذا كان منفصلاً عن العمود أعلاه';
