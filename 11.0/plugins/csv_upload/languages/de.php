...
$lang["csv_upload_validating"] = 'Validierung';
$lang["csv_upload_processing"] = 'Verarbeitung';
$lang["processing_batch_edit_save"] = 'Zeile [row_number] von [rows_count]';
$lang["page-title_csv_upload_csv_upload"] = 'CSV hochladen';
$lang["csv_upload_create_new"] = 'Neue Ressourcen erstellen';
$lang["csv_upload_create_alternatives"] = 'Alternativdateien erstellen';
$lang["csv_upload_create_alternatives_title"] = 'Alternativdateien erstellen';
$lang["csv_upload_create_alternatives_notes"] = 'Wählen Sie die erforderlichen Optionen, um neue Alternativdateien zu erstellen';
$lang["csv_upload_multiple_match_all"] = 'Alle Übereinstimmungen aktualisieren';
$lang["csv_upload_multiple_match_none"] = 'Keine Aktualisierungen vornehmen';
$lang["csv_upload_alternative_file_filename_column"] = 'Wählen Sie die Spalte, die den Dateinamen der Alternativdatei enthält';
$lang["csv_upload_alternative_file_name_column"] = 'Wählen Sie die Spalte, die den Namen für die Alternativdatei enthält (optional)';
$lang["csv_upload_alternative_file_description_column"] = 'Wählen Sie die Spalte, die die Beschreibung für die Alternativdatei enthält (optional)';
$lang["csv_upload_condition9"] = 'Um den Standort zu aktualisieren, müssen die Werte für Breiten- und Längengrad in einer einzigen Spalte mit Komma getrennt oder in zwei verschiedenen Feldern zusammengeführt werden.';
$lang["csv_upload_location"] = 'Wählen Sie die Spalte aus, die den Standort der Ressource enthält, oder Breite, wenn separate Spalten verwendet werden';
$lang["csv_upload_longitude"] = 'Wählen Sie die Spalte für Längengrad, falls diese getrennt von der oben genannten Spalte ist';
