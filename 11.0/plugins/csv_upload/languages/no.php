...
$lang["page-title_csv_upload_csv_upload"] = 'Last opp CSV';
$lang["csv_upload_create_new"] = 'Opprett nye ressurser';
$lang["csv_upload_create_alternatives"] = 'Opprett alternative filposter';
$lang["csv_upload_create_alternatives_title"] = 'Opprett alternative filposter';
$lang["csv_upload_create_alternatives_notes"] = 'Velg alternativene som kreves for å opprette nye alternative filposter';
$lang["csv_upload_multiple_match_all"] = 'Oppdater alle som stemmer';
$lang["csv_upload_multiple_match_none"] = 'Oppdater ingen';
$lang["csv_upload_alternative_file_filename_column"] = 'Velg kolonnen som inneholder filnavnet for den alternative filen';
$lang["csv_upload_alternative_file_name_column"] = 'Velg kolonnen som inneholder navnet som skal brukes for den alternative filposten (valgfritt)';
$lang["csv_upload_alternative_file_description_column"] = 'Velg kolonnen som inneholder beskrivelsen for den alternative filposten (valgfritt)';
$lang["csv_upload_condition9"] = 'For å oppdatere plassering må verdier for breddegrad og lengdegrad være kombinert i én kolonne med komma som separator, eller i to separate felt.';
$lang["csv_upload_location"] = 'Velg kolonnen som inneholder plasseringen for ressursen, eller Breddegrad hvis du bruker separate kolonner';
$lang["csv_upload_longitude"] = 'Velg kolonnen for Lengdegrad hvis den er separat fra kolonnen over';
