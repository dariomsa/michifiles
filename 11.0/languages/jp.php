...
$lang['emailcollectionmessage'] = '[applicationname] から\'マイコレクション\'のページに追加するリソースのコレクションをメールしました。';
...
$lang['rightclicktodownload'] = '本リンクを右クリックし\'名前を付けてリンク先を保存\'を選んでリソースをダウンロード...';
...
$lang['enteringfewerkeywords'] = 'より少ない検索キーワードを入力することによって';
$lang['match'] = '適合';
$lang['matches'] = '適合';
...
$lang['hasemailedyouaresource'] = 'あなたにリソースをEメールしました';
...
$lang['edituser'] = 'ユーザ編集';
$lang['fullname'] = 'フルネーム';
$lang['columnheader-full_name'] = 'フルネーム';
$lang['email'] = 'Eメール';
...
$lang['unassigned'] = '未アサイン';
$lang['requeststatus0'] = '未アサイン';
...
$lang['haspostedresearchrequest'] = '調査依頼を投稿';
...
$lang['resourceid'] = 'リソースID';
$lang['columnheader-resource_id'] = 'リソースID';
$lang['id'] = 'ID';
$lang['date'] = '日付';
$lang['todate'] = 'まで';
$lang['fromdate'] = 'から';
...
$lang['newlogindetails'] = 'あなたの新規ログイン詳細を以下より見つけて下さい。';
$lang['youraccountdetails'] = 'あなたのアカウント詳細';
$lang['copyfromcollection'] = 'コレクションからコピー';
$lang['donotcopycollection'] = 'コレクションからコピーしない';
$lang['resourcesincollection'] = 'リソース数(本コレクション内)';
...
$lang['collectionlog-d'] = '削除されたリソース';
...
$lang['enterantispamcode'] = '次のコードを入力してください';
...
$lang['group_config_inherit'] = 'グループ設定は親ユーザーグループから継承されます。ここで設定するものはありません。';
$lang['property-group_preferences_inherit'] = '親グループから継承する';
$lang['property-sort_method'] = 'ソート方法';
$lang['information-sort_method'] = 'このフィールドで並べ替えられた検索結果を表示する際に使用する順序。';
$lang['exiftoolconflictingversions'] = 'Exiftoolの競合バージョンが検出されました';
$lang['editgroupconfigoverrides'] = 'グループ設定のオーバーライドを編集';
$lang['sort-method_default'] = 'デフォルト - アルファベットと数字';
$lang['sort-method_dot-notation'] = '受入番号 - ドット表記';
$lang['save-error-invalid'] = '自動保存中にエラーが発生しました - コンテンツを確認して再試行してください';
$lang['fieldtitle-usergroup_config'] = 'グループオーバーライド';
$lang['page-title_usergroup_config'] = 'グループ設定のオーバーライドを編集する';
$lang['action-title_usergroup_override_detail'] = 'この設定は、グループ内のユーザーに対するシステムのデフォルト設定を上書きします。';
$lang['team_resource_non_ingested_search'] = '非取り込みリソースを表示';
$lang['language-ms'] = 'Malay';
$lang['language-tl'] = 'Filipino';
$lang['upgrade_028_notify_config_not_set'] = '%name%を%value%に設定できませんでした（システム全体の設定オプション）';
$lang['annotate_tagging_fields'] = 'タグ付けフィールド';
$lang['annotate_text_adds_comment'] = 'リソーステキスト注釈にコメントを追加します。（固定リストフィールド注釈には該当しません）';
$lang['annotate_public_view'] = '注釈は公開されていますか（例：外部共有）？';
$lang['annotate_show_author'] = '注釈の作成者を表示しますか？';
$lang['annotate_exclude_restypes'] = '除外するリソースタイプ（除外するにはチェックを入れて、注釈を付けない）';
$lang['annotate_pseudo_rtf_comment_title'] = 'コメント（モード）';
$lang['annotorious_add_a_comment'] = 'コメントを追加...';
$lang['annotorious_type_to_search_field'] = '検索フィールドに入力してください...';
$lang['annotate_pdf_sheet_tool'] = '注釈 PDF';
$lang['annotate_pdf_intro_text'] = '注釈PDFのページサイズを選択してください。';
$lang['annotate_pdf_no_annotations'] = '注釈はありません。';
$lang['statusinvalid'] = '無効';
$lang['accessinvalid'] = '無効';
$lang['requiredfields-status-required_fields'] = 'ステータスを%%STATUS%%に変更するには、必須フィールドをすべて入力する必要があります。次のフィールドを設定して、再試行してください: %%FIELDS%%';
$lang['error_file_upload_cond-InvalidMimeType'] = '無効なMIMEタイプ';
$lang['error-edit_status_change_missing_required_fields'] = 'すべてのリソースのアーカイブステータスを変更することはできません。次のリソースは、必須フィールドにデータが欠けているためスキップされました：';
$lang['missing_required_fields'] = '必須フィールドが未入力のリソース';
$lang['missing_required_fields_intro'] = 'コレクション内のリソースは、不完全な必須フィールドでソートされて以下に表示されます。';
$lang['action_update_now'] = '今すぐ更新';
$lang['errors'] = 'エラー';
$lang['error_savefirst'] = '変更を保存してください';
$lang['language-be'] = 'ベラルーシ語';
...
$lang['years'] = '年数';
$lang['ago'] = '前';
$lang['action-selectresource'] = 'リソースを選択してください';
$lang['addremove'] = '選択してください';
$lang['expand'] = '拡張';
$lang['error_fieldidnotfound'] = 'フィールドIDが見つかりません。';
$lang['page-title_login'] = 'ログイン';
$lang['page-title_about'] = '私たちについて';
$lang['page-title_alternative_file'] = '代替ファイル';
$lang['page-title_alternative_files'] = '代替ファイル';
$lang['page-title_annotate_pdf_config'] = 'PDFに注釈を付ける';
$lang['page-title_annotate_pdf_gen'] = 'PDFに注釈を付ける';
$lang['page-title_api_test'] = 'APIテスト';
$lang['page-title_change_language'] = '言語を変更する';
$lang['page-title_check'] = 'インストールチェック';
$lang['page-title_collection_comment'] = 'コレクションコメント';
$lang['page-title_collection_copy_resources'] = 'コレクションリソースをコピー';
$lang['page-title_collection_download'] = 'コレクションのダウンロード';
$lang['page-title_collection_edit'] = 'コレクションを編集';
$lang['page-title_collection_edit_previews'] = 'コレクションのプレビューを編集';
$lang['page-title_collection_email'] = 'メールコレクション';
$lang['page-title_collection_feedback'] = 'コレクションフィードバック';
$lang['page-title_collection_log'] = 'コレクションログ';
$lang['page-title_collection_manage'] = 'コレクションを管理する';
$lang['page-title_collection_public'] = '公開コレクション';
$lang['page-title_collection_request'] = 'コレクションをリクエストする';
$lang['page-title_collection_set_category'] = 'コレクションカテゴリを設定する';
$lang['page-title_collections_featured'] = '特集コレクション';
$lang['page-title_collection_share'] = 'コレクションを共有';
$lang['page-title_collections'] = 'コレクション';
$lang['page-title_contact'] = 'お問い合わせ';
$lang['page-title_contactsheet_settings'] = '連絡先シートの設定';
$lang['page-title_content'] = 'サイトコンテンツのプレビュー';
$lang['page-title_contribute'] = '貢献';
$lang['page-title_csv_export_results_metadata'] = 'CSVエクスポート';
$lang['page-title_dash_tile'] = 'ダッシュタイルを編集';
$lang['page-title_done'] = '完了';
$lang['page-title_download'] = 'ダウンロード';
$lang['page-title_download_progress'] = 'ダウンロード進行状況';
$lang['page-title_download_usage'] = 'ダウンロード使用';
$lang['page-title_edit_fields'] = 'メタデータフィールドを編集';
$lang['page-title_edit'] = 'リソースを編集';
$lang['page-title_geo_edit'] = '場所を編集';
$lang['page-title_geo_search'] = '場所検索';
$lang['page-title_graph'] = 'グラフ';
$lang['page-title_help'] = 'ヘルプ';
$lang['page-title_home'] = 'ダッシュ';
$lang['page-title_job_details'] = 'オフラインジョブの詳細';
$lang['page-title_log_entry'] = 'リソースログ';
$lang['page-title_log'] = 'リソースログ';
$lang['page-title_manage_external_shares'] = '共有を管理';
$lang['page-title_manage_jobs'] = 'オフラインジョブを管理する';
$lang['page-title_metadata_download'] = 'メタデータをダウンロード';
$lang['page-title_mp3_play'] = 'オーディオファイルを再生';
$lang['page-title_no_uploads'] = 'アップロード不可';
$lang['page-title_preview'] = 'プレビュー';
$lang['page-title_request_log'] = 'リクエストログ';
$lang['page-title_requests'] = 'リクエスト';
$lang['page-title_research_request'] = '研究リクエスト';
$lang['page-title_resource_collection_list'] = 'コレクションリスト';
$lang['page-title_resource_email'] = 'リソースをメールする';
$lang['page-title_resource_request'] = 'リソースをリクエスト';
$lang['page-title_resource_share'] = 'リソースを共有する';
$lang['page-title_search_advanced'] = '高度な検索';
$lang['page-title_search_disk_usage'] = 'ディスク使用量';
$lang['page-title_search'] = '検索';
$lang['page-title_setup'] = 'セットアップ';
$lang['page-title_share_access'] = '共有アクセス';
$lang['page-title_share_upload'] = 'アップロード共有';
$lang['page-title_simple_search'] = '検索';
$lang['page-title_system_down'] = 'システムダウン';
$lang['page-title_terms'] = '利用規約';
$lang['page-title_themes'] = '特集コレクション';
$lang['page-title_upload_batch'] = 'リソースをアップロード';
$lang['page-title_upload_preview'] = 'アップロードプレビュー';
$lang['page-title_upload_replace_batch'] = 'リソースを一括置換';
$lang['page-title_user_password'] = 'パスワードを変更する';
$lang['page-title_user_ratings'] = 'リソースのユーザー評価統計';
$lang['page-title_user_request'] = 'ユーザーをリクエスト';
$lang['page-title_video_player'] = 'ビデオプレーヤー';
$lang['page-title_view_alternative_files'] = '代替ファイルを表示';
$lang['page-title_view_metadata'] = 'リソースメタデータを表示';
$lang['page-title_view'] = 'リソースを表示';
$lang['page-title_view_shares'] = '共有を表示';
$lang['page-title_admin_content_edit'] = 'サイトコンテンツを編集';
$lang['page-title_admin_content'] = 'サイトコンテンツ';
$lang['page-title_admin_copy_field'] = 'リソースタイプフィールドをコピー';
$lang['page-title_admin_download_config'] = 'システム設定のダウンロード';
$lang['page-title_admin_filter_edit'] = 'フィルターを編集';
$lang['page-title_admin_filter_manage'] = 'フィルターを管理';
$lang['page-title_admin_group_config_edit'] = 'ユーザーグループ設定のオーバーライドを編集';
$lang['page-title_admin_group_management_edit'] = 'ユーザーグループを編集';
$lang['page-title_admin_group_management'] = 'ユーザーグループ';
$lang['page-title_admin_group_permissions'] = 'ユーザーグループの権限を編集';
$lang['page-title_admin_home'] = 'システムメニュー';
$lang['page-title_admin_manage_field_options'] = 'フィールドオプションを管理する';
$lang['page-title_admin_manage_slideshow'] = 'スライドショーを管理';
$lang['page-title_admin_report_management_edit'] = 'レポートを編集';
$lang['page-title_admin_report_management'] = 'レポートを管理する';
$lang['page-title_admin_resource_type_edit'] = 'リソースタイプを編集';
$lang['page-title_admin_resource_type_field_edit'] = 'リソースタイプフィールドを編集';
$lang['page-title_admin_resource_type_fields'] = 'リソースタイプフィールド';
$lang['page-title_admin_resource_types'] = 'リソースタイプ';
$lang['page-title_admin_size_management_edit'] = '画像サイズを編集';
$lang['page-title_admin_size_management'] = '画像サイズ';
$lang['page-title_admin_system_config'] = 'システム設定';
$lang['page-title_admin_system_log'] = 'システムログ';
$lang['page-title_admin_system_performance'] = 'システムパフォーマンス';
$lang['page-title_tabs'] = 'タブを管理する';
$lang['page-title_team_analytics_edit'] = '分析レポートを編集';
$lang['page-title_team_analytics'] = '分析レポート';
$lang['page-title_team_archive'] = 'アーカイブリソース';
$lang['page-title_team_copy'] = 'リソースをコピー';
$lang['page-title_team_dash_admin'] = 'ダッシュ管理';
$lang['page-title_team_dash_tile'] = 'ダッシュタイル';
$lang['page-title_team_dash_tile_special'] = '特別なダッシュタイルを作成';
$lang['page-title_team_export'] = 'システムデータをエクスポート';
$lang['page-title_team_external_shares'] = '外部共有を管理する';
$lang['page-title_team_home'] = '管理メニュー';
$lang['page-title_team_mail'] = '一括メールを送信';
$lang['page-title_team_plugins_groups'] = 'ユーザーグループプラグインアクセスの管理';
$lang['page-title_team_plugins'] = 'プラグインを管理する';
$lang['page-title_team_related_keywords_edit'] = '関連キーワードを編集';
$lang['page-title_team_related_keywords'] = '関連キーワード';
$lang['page-title_team_report'] = 'レポートを表示';
$lang['page-title_team_request_edit'] = '編集リクエスト';
$lang['page-title_team_request'] = 'リクエスト';
$lang['page-title_team_research_edit'] = '研究リクエストを編集';
$lang['page-title_team_research'] = '研究リクエスト';
$lang['page-title_team_resource'] = 'リソースメニュー';
$lang['page-title_team_user_edit'] = 'ユーザーを編集';
$lang['page-title_team_user'] = 'ユーザーを管理する';
$lang['page-title_team_user_purge'] = 'ユーザーを削除';
$lang['page-title_user_actions'] = 'ユーザーアクション';
$lang['page-title_user_api_session'] = 'リモートシステムAPIアクセス';
$lang['page-title_user_change_password'] = 'パスワードを変更する';
$lang['page-title_user_dash_admin'] = 'ユーザーダッシュを管理';
$lang['page-title_user_home'] = 'ユーザーメニュー';
$lang['page-title_user_message'] = 'ユーザーメッセージ';
$lang['page-title_user_messages'] = 'ユーザーメッセージ';
$lang['page-title_user_preferences'] = 'ユーザー設定';
$lang['page-title_user_profile_edit'] = 'マイプロフィール';
$lang['page-title_user_profile'] = 'ユーザープロフィール';
$lang['backtomessages'] = 'メッセージに戻る';
$lang['viewallmessages'] = 'すべてのメッセージを表示';
$lang['min_ago'] = '%TIME% 分前';
$lang['mins_ago'] = '%TIME% 分前';
$lang['hour_ago'] = '%TIME% 時間前';
$lang['hours_ago'] = '%TIME% 時間前';
$lang['day_ago'] = '%TIME%日前';
$lang['days_ago'] = '%TIME%日前';
$lang['week_ago'] = '%TIME% 週間前';
$lang['weeks_ago'] = '%TIME% 週間前';
$lang['month_ago'] = '%TIME% ヶ月前';
$lang['months_ago'] = '%TIME%ヶ月前';
$lang['random'] = 'ランダム';
$lang['log-sf'] = 'Staticsyncファイルが変更されました';
$lang['log_code_J'] = 'ジョブが追加されました';
$lang['log_code_JC'] = 'ジョブが完了しました';
$lang['log_code_JD'] = 'ジョブが削除されました';
$lang['email_username'] = 'メール／ユーザー名';
$lang['request_new_password'] = 'パスワードをお忘れの場合は、以下のリンクを使用して新しいパスワードをリクエストしてください。';
$lang['enter_username_or_email'] = 'ユーザー名またはメールアドレスを入力してください';
$lang['enter_a_password'] = 'パスワードを入力してください';
$lang['enter_a_full_name'] = 'フルネームを入力してください';
$lang['enter_an_email_address'] = 'メールアドレスを入力してください';
$lang['new_to_resourcespace'] = '[applicationname]を初めてご利用ですか？';
$lang['show_password'] = 'パスワードを表示';
$lang['hide_password'] = 'パスワードを隠す';
$lang['select_a_user_group'] = 'ユーザーグループを選択';
$lang['back_to_login'] = 'ログインに戻る';
$lang['required'] = '必須';
$lang['select_a'] = '選択してください';
$lang['notsharableresources'] = '以下のリソースはこのユーザーによって共有できず、共有コレクションに追加できません: ';
$lang['antispam'] = '迷惑メール防止';
$lang['comments_body-placeholder-anon'] = 'コメントを追加してください。';
$lang['batch_replace_alternatives'] = '元のファイルまたは代替ファイルを置き換える';
$lang['batch_replace_upload_resources'] = '元のファイル';
$lang['batch_replace_upload_alternatives'] = '代替ファイル';
$lang['userpreference_user_interface'] = 'ユーザーインターフェース';
$lang['systemconfig_watermark_open'] = 'アクセスが"公開"の場合でも、"w"権限を持つグループのサムネイル／プレビューに透かしを適用します';
$lang['systemconfig_watermark_open_search'] = 'サムネイル／プレビューに透かしを適用した場合（上記のオプション）、検索ページにも透かしを適用します';
$lang['systemconfig_minyear'] = '検索フォームの日時選択に含める最も古い日付。通常は最初のアップロード年';
$lang['systemconfig_searchbyday'] = '月／年に加えて日付も検索に含める';
$lang['systemconfig_default_collection_sort'] = 'コレクションのリソースを表示する際のデフォルトの並び順。ユーザーが提供された順序でリソースを表示することを期待している場合はこれをコレクションに設定します';
$lang['systemconfig_systemconfig_searchbyday'] = 'サムネイル表示モードの検索結果にリソースのワークフローステータス（アイコンとテキスト）を表示';
$lang['systemconfig_category_tree_search_use_and'] = '検索ページのカテゴリーツリー項目で値を選択すると、親の値も自動的に選択されます';
$lang['systemconfig_category_tree_search_use_and_logic'] = '検索結果を返すには、選択されたすべてのカテゴリーツリー値が存在する必要があります（何も選択しない場合は、任意の選択値に一致します）';
$lang['systemconfig_recent_search_quantity'] = '最近のリソースと新しい資料リンクとともに表示するリソースの数';
$lang['systemconfig_general'] = '一般';
$lang['systemconfig_date_yyyy'] = '4桁の形式で年を表示';
$lang['systemconfig_imperial_measurements'] = 'ダウンロードサイズのガイドラインにメートル法の代わりにヤード・ポンド法を使用';
$lang['systemconfig_site_text_custom_create'] = 'コンテンツ管理から新しいサイトテキストエントリの作成を許可（新しいページの作成を目的としています）';
$lang['systemconfig_no_welcometext'] = 'ホームページのウェルカムテキストを非表示';
$lang['systemconfig_internal_preview_sizes_editable'] = '内部サイズの編集を許可';
$lang['systemconfig_edit_autosave'] = '編集ページで変更を自動保存します。いいえの場合は、保存ボタンを使用してください';
$lang['systemconfig_resource_request_reason_required'] = 'リソースまたは複数のリソースをリクエストする際に、「リクエスト理由」フィールドは必須です';
$lang['systemconfig_research_request'] = 'リサーチリクエスト機能を有効にする';
$lang['systemconfig_custom_access'] = '追加のリソースアクセス制御のために「カスタムアクセス」レベルを有効にする';
$lang['systemconfig_enable_related_resources'] = 'リソース編集時に「関連リソース」フィールドを有効にする';
$lang['systemconfig_user_accounts'] = 'ユーザーアカウント';
$lang['systemconfig_inactive_user_disable_days'] = '一定期間アクティブでないユーザーを自動的に無効化（0はこの機能を無効化）';
$lang['systemconfig_sharing'] = '共有';
$lang['systemconfig_external_share_groups_config_options'] = '外部に共有する際に特定のユーザーグループとしてグループ設定オプションを尊重';
$lang['systemconfig_resource_share_expire_days_default'] = '共有期限のデフォルト日数（0は最初のオプションを使用）';
$lang['systemconfig_restricted_share'] = 'リソースに"制限"アクセス権を持つユーザーはリソースを共有できるべきか';
$lang['systemconfig_blank_edit_template'] = 'リソースをアップロード（バッチアップロード）し、テンプレートを編集する際に値を空白またはデフォルト値にリセット';
$lang['systemconfig_enable_copy_data_from'] = 'バッチアップロード時に"既存リソースからリソースデータをコピー"機能を有効にする';
$lang['systemconfig_resource_view'] = 'リソースビュー';
$lang['systemconfig_show_resourceid'] = 'ビュー画面にリソースIDを表示';
$lang['systemconfig_show_resource_type'] = 'ビュー画面にリソースタイプを表示';
$lang['systemconfig_show_access_field'] = 'ビュー画面にリソースアクセスを表示';
$lang['systemconfig_show_contributed_by'] = 'ビュー画面に"寄稿者"ユーザーを表示';
$lang['systemconfig_show_related_themes'] = 'ビュー画面に関連コレクションと公開コレクションパネルを表示';
$lang['systemconfig_metadata_download'] = 'ビュー画面に"メタデータをダウンロード"オプションを表示';
$lang['systemconfig_uploading'] = 'アップロード中';
$lang['systemconfig_upload_add_to_new_collection'] = '"新しいコレクションに追加"オプションは一括アップロードに使用されます。オフにするとデフォルトで"コレクションに追加しない"になります';
$lang['systemconfig_upload_add_to_new_collection_opt'] = '一括アップロードの場合、「新しいコレクションに追加」オプションを有効にします';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = '一括アップロードの場合、「コレクションに追加しない」オプションを有効にします（有効でない場合は強制的にコレクションにアップロードされます）';
$lang['systemconfig_upload_collection_name_required'] = '一括アップロード時にコレクション名の入力を必須にします。デフォルトのUpload[timestamp]動作を上書きします';
$lang['systemconfig_allow_password_change'] = 'パスワード変更を許可';
$lang['systemconfig_allow_password_reset'] = 'ユーザーがログイン画面から新しいパスワードをリクエストできるようにします';
$lang['systemconfig_allow_keep_logged_in'] = 'ログイン画面に「このデバイスでログインを維持する」オプションを表示';
$lang['systemconfig_remember_me_checked'] = '「このデバイスでログインを維持する」オプションがデフォルトで選択されています';
$lang['systemconfig_session_length'] = 'ユーザーセッションの長さ（分）';
$lang['systemconfig_session_autologout'] = 'セッション終了時に自動的にログアウト（アイドル時間はセッション長と同じ）';
$lang['systemconfig_slideshow_photo_delay'] = 'スライドショーが画像を変更するまでの秒数';
$lang['config_integer_invalid_range'] = '無効な値です。%MIN%から%MAX%の範囲内の数字を入力してください';
$lang['alternative_file_replaced'] = '代替ファイルが正常に置き換えられました';
$lang['jq_create_alt_previews_success_text'] = '代替ファイル #%ALTFILE のプレビューが正常に作成されました';
$lang['jq_create_alt_previews_failure_text'] = '代替ファイル #%ALTFILE のプレビューの作成に失敗しました';
$lang['error_report_execution'] = 'レポートの実行中にエラーが発生しました。クエリが正しいことを確認してください';
$lang['error_save_not_allowed_dash_tile_set_public'] = '変更を保存できません。すべてのユーザーまたは複数のユーザーに設定されたダッシュタイルがこのコレクションにリンクされていないことを確認してください';
$lang['error_upload_replace_alternative_file_not_found'] = '代替ファイルの更新に失敗しました。ファイル名 [filename] に一致する代替ファイルのレコードが見つかりません';
$lang['error_upload_replace_alternative_multiple_found'] = '代替ファイルの更新に失敗しました。ファイル名 [filename] に一致する複数の代替ファイルのレコードが見つかりました。リソースIDまたはコレクションで制限してください';
$lang['oj-batch-replace-local-alternatives-success-text'] = '一括置換に成功し、%TOTALFILES 件の代替ファイルを置換しました';
$lang['replacebatch_collection_alternatives'] = 'このコレクション内のリソースに対して代替ファイルを追加または置換したい場合は、コレクションIDを入力してください';
$lang['replacebatch_resource_min_alternatives'] = '代替ファイルを置換する最小リソースID（コレクションが指定されていない場合は無視されます）';
$lang['replacebatch_resource_max_alternatives'] = '代替ファイルを置換する最大リソースID';
$lang['system_config_search_engines'] = '検索エンジン';
$lang['int_ranges_empty'] = '入力が空です';
$lang['int_ranges_range_below_1'] = '範囲 %%PART%% の数字は1以上でなければなりません';
$lang['int_ranges_range_reversed'] = '範囲 %%PART%% の開始は終了より大きくできません';
$lang['int_ranges_range_above_max'] = '範囲 %%PART%% は最大値 %%MAX_VAL%% を超えています';
$lang['int_ranges_single_below_1'] = '数字は1以上でなければなりません（%%PART%%）';
$lang['int_ranges_single_above_max'] = '%%PART%% は最大値 %%MAX_VAL%% を超えています';
$lang['int_ranges_not_valid'] = '%%PART%% は有効な数字または範囲ではありません（例：3 または 5-9 のように入力してください）';
$lang['job_trigger'] = 'ジョブをトリガー';
$lang['job_configure'] = 'ジョブを設定';
$lang['jobs_action_stream_log'] = 'ログファイルをストリーム';
$lang['jobs_action_download_log'] = 'ログファイルをダウンロード';
$lang['jobs_action_not_started'] = 'ジョブはまだ開始されていません';
$lang['jobs_action_missing_job_progress'] = 'ジョブの進行状況を読み込めません';
$lang['job_action_not_found'] = 'ジョブが見つかりません。';
$lang['job_list_core'] = 'コア';
$lang['job_list_recreate_previews'] = 'プレビューを再作成';
$lang['job_list_exif_data'] = 'EXIFデータを再生成';
$lang['job_list_purge_duplicates'] = '重複リソースを削除';
$lang['job_list_reindex'] = 'データを再インデックス化';
$lang['job_list_checksums'] = 'チェックサムを更新';
$lang['job_list_extracted_text'] = '抽出されたテキストを更新';
$lang['oj_common_create_job'] = 'ジョブを作成';
$lang['oj_common_field_refs'] = 'フィールド参照';
$lang['oj_common_collection_refs'] = 'コレクション参照';
$lang['oj_common_error_required'] = 'このフィールドは必須です';
$lang['oj_common_error_invalid'] = '無効な値がフィールドに渡されました';
$lang['oj_common_error_invalid_field_ref'] = '%FIELD_REF% は有効なフィールドを指していません';
$lang['oj_recreate_previews_target'] = 'どのタイプの参照を提供しますか？';
$lang['oj_recreate_previews_refs'] = '参照';
$lang['oj_recreate_previews_image_sizes'] = '生成する画像サイズ';
$lang['oj_recreate_previews_resource_types'] = '対象とするリソースタイプ';
$lang['oj_recreate_previews_use_existing'] = '既存のアップロード済みプレビューを使用しますか？';
$lang['oj_recreate_previews_video_update'] = '必要な \'$ffmpeg_preview_extension\' 拡張子がないすべての動画リソースのプレビューを更新しますか？';
$lang['oj_recreate_previews_delete_existing'] = '既存のすべてのプレビューを削除';
$lang['oj_recreate_previews_refs_help'] = 'このオプションを設定すると、処理に使用される参照（リソースまたはコレクションの参照）が制御されます。有効な入力には、カンマ区切りのリスト、範囲、ワイルドカードが含まれます。例：* はすべての参照を処理し、1-100 は最初の100の参照を処理し、101-* は101以降の参照を処理し、1,3,5 は参照1、3、5を処理します。これらは組み合わせて、必要な正確な参照をターゲットにできます。例：1,5-10,15-* は1、5から10、および15以降をターゲットにします。';
$lang['oj_recreate_previews_use_existing_help'] = 'このオプションを設定すると、リソース上で手動で置き換えられたプレビューを保持しようとします。使用しない場合、手動アップロードされたプレビューは元のファイルから派生したプレビューに置き換えられます。';
$lang['oj_recreate_previews_video_update_help'] = 'このオプションを設定すると、現在の設定 \'$ffmpeg_preview_extension\' と一致しない動画を更新します。設定が変更された場合に役立ち、新しいプレビューを生成する必要のあるリソースのみを対象とします。';
$lang['oj_recreate_previews_delete_existing_help'] = 'このオプションを設定すると、再作成前に既存のすべてのプレビューを削除します。';
$lang['oj_exif_data_blanks'] = 'EXIFデータが存在しない場合の空白フィールド値';
$lang['oj_exif_data_overwrite'] = 'EXIFデータが存在する場合、既存のフィールド値を上書き';
$lang['oj_exif_data_field_refs_help'] = 'これらは、EXIFデータを抽出したいフィールドの参照です。これらのフィールドには「Exiftoolフィールド」が設定されている必要があります。カンマ区切りのリストを使用してフィールドを指定できます（例：1,3,5）。';
$lang['oj_exif_data_collection_refs_help'] = 'このオプションを設定すると、リストされたコレクション内のリソースのみが更新されます。コレクションが指定されていない場合、すべての適切なリソースのEXIFデータが更新されます。コレクションはカンマ区切りのリストや範囲（例：100,105,110-115）で指定できます。';
$lang['oj_exif_data_blanks_help'] = 'このオプションを設定すると、ファイルに埋め込まれたEXIFデータがない場合に指定されたフィールドがクリアされます。';
$lang['oj_exif_data_overwrite_help'] = 'このオプションを設定すると、ファイルに埋め込まれたEXIFデータが存在する場合、指定されたフィールドの既存の値が上書きされます。';
$lang['oj_purge_duplicates_intro'] = '<strong>警告：このスクリプトはリソースを永久に削除します。設定に不安がある場合は、ドライランオプションを使用して設定を検証してください。</strong>';
$lang['oj_purge_duplicates_manage_method'] = '管理方法';
$lang['oj_purge_duplicates_lifo'] = '最も古いものを保持し、新しい重複を削除';
$lang['oj_purge_duplicates_fifo'] = '最新のものを保持し、古い重複を削除';
$lang['oj_purge_duplicates_dry_run'] = 'ドライラン';
$lang['oj_purge_duplicates_delete_perm'] = '完全に削除';
$lang['oj_purge_duplicates_delete_error'] = 'ドライラン中は完全削除はできません';
$lang['oj_purge_duplicates_collection_refs_help'] = '重複検出の範囲としてコレクションを設定します。すべての重複をコレクション内に持つ必要はなく、1つだけあれば十分です。重複はシステム全体で処理され、選択された管理方法で一掃されます。コレクションはカンマ区切りのリストや範囲（例：100,105,110-115）で指定できます。';
$lang['oj_purge_duplicates_manage_method_help'] = 'このオプションを設定すると、重複削除の方法を制御します。';
$lang['oj_purge_duplicates_dry_run_help'] = 'このオプションを設定すると、変更を加えずに試行実行が行われます。試行結果を含むログファイルはダウンロードして確認できます。';
$lang['oj_purge_duplicates_delete_perm_help'] = 'このオプションを設定すると、重複したリソースは完全に削除されます。設定しない場合は、リソースは設定された削除状態に移動されます。';
$lang['oj_reindex_field_refs_help'] = 'このオプションを設定すると、再インデックス化するフィールドを制限できます。カンマ区切りのリスト（例：1,3,5）を使用してフィールドを指定します。何も入力しなければ、すべてのフィールドが再インデックス化されます。';
$lang['oj_checksums_recreate'] = 'すべてのチェックサムを再作成';
$lang['oj_checksums_recreate_help'] = 'このオプションを設定すると、既存のチェックサムがないリソースだけでなく、すべてのリソースのチェックサムを再作成します。';
$lang['oj_extracted_text_update_all'] = '既存のデータがあっても更新し、古い値を上書きします';
$lang['oj_extracted_text_collection_refs_help'] = 'このオプションを設定すると、処理対象のリソースをリストされたコレクション内のみに制限します。コレクションが指定されていない場合、すべての適切なリソースの抽出済みテキストが更新されます。コレクションはカンマ区切りや範囲（例：100,105,110-115）で指定できます。';
$lang['oj_extracted_text_update_all_help'] = 'このオプションを設定すると、既存のデータがあっても抽出処理を実行し、古い値を上書きします。';
$lang['requiredfield_multiple'] = 'これはアーカイブ状態を変更する際に必須のフィールドです';
$lang['reorder_invalid'] = 'ソート順がコレクション順でない限り、コレクションの並べ替えはできません';
$lang['reorder_permissions_fail'] = 'このコレクション内のすべてのリソースにアクセスできないため、並べ替えできません';
$lang['resource-card-menu-delete'] = 'このリソースを削除してもよろしいですか？';
$lang['resource-card-menu-delete-button'] = 'はい、リソースを削除';
$lang['resource-card-menu-delete-perm'] = '本当によろしいですか？この操作は取り消せません。';
$lang['resource-card-menu-delete-perm-button'] = 'はい、完全に削除';
$lang['blue'] = '青';
$lang['green'] = '緑';
$lang['red'] = '赤';
$lang['purple'] = '紫';
$lang['fieldtype-geo_location'] = 'ジオロケーション';
$lang['property-geomapping'] = 'ジオロケーションタイプ';
$lang['information-geomapping'] = 'このフィールドに緯度、経度、またはその両方を格納します。<br \\/ >両方またはそれぞれのフィールドに設定できるのは1つだけです。<br \\/ >単一行テキストフィールドでのみ利用可能です。';
$lang['disabled-geomapping-title'] = 'ジオロケーションは別のフィールドに設定されています。これに変更するには、他のフィールドから削除する必要があります。';
$lang['geo_location-none'] = 'なし';
$lang['geo_location-latitude'] = '緯度';
$lang['geo_location-longitude'] = '経度';
$lang['geo_location-both'] = '両方';
$lang['knowledgebase'] = 'ナレッジベース';
$lang['search_filter_panel_toggle'] = '検索フィルターの切り替え';
$lang['search_resources'] = 'リソースを検索';
$lang['clear_filters'] = 'フィルターをクリア';
$lang['save-error-invalid-latlong'] = '自動保存エラー - ジオロケーションが無効です。使用例：緯度、経度（例：40.7128, -74.0060）。リソースの場所は更新されていません。';
$lang['save-error-invalid-lat'] = '自動保存エラー - 緯度が無効です。-90から90の範囲でなければなりません。リソースの場所は更新されていません。';
$lang['save-error-invalid-long'] = '自動保存エラー - 経度が無効です。-180から180の範囲でなければなりません。リソースの場所は更新されていません。';
$lang['or'] = 'または';
$lang['view_all_fcs'] = 'すべての注目コレクションを見る';
$lang['dashtile_upload'] = 'リソースをシステムに追加';
$lang['knowledgebase-tooltip'] = 'ResourceSpace（ナレッジベース）のドキュメントを見る';
$lang['noresources_collection'] = 'コレクションにリソースがありません';
$lang['hide_collection_bar'] = '非表示';
$lang['minimal_collection_bar'] = '最小バー';
$lang['thumbnails_collection_bar'] = 'サムネイル';
$lang['language-bg'] = 'ブルガリア語';
