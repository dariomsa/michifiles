...
$lang['columnheader-full_name'] = 'Ονοματεπώνυμο';
$lang['email'] = 'E-mail';
...
$lang['fieldtype-text_box_formatted_and_tinymce'] = 'Πλαίσιο κειμένου (μορφοποιημένο / TinyMCE)';
...
$lang['enterantispamcode'] = 'Εισάγετε τον παρακάτω κωδικό';
...
$lang['password_reset_email_html'] = 'Όνομα χρήστη: [username]<br /><br />Παρακαλώ κάντε κλικ στον παρακάτω σύνδεσμο για επαναφορά του κωδικού πρόσβασής σας.<br /><br /><a href="[url]" target="_blank" >[url]</a>';
...
$lang['property-options'] = 'Λίστα επιλογών διαχωρισμένων με κόμμα. Η πρώτη επιλογή θα είναι η προεπιλεγμένη επιλογή. Αν δεν επιθυμείτε να ορίσετε προεπιλεγμένη τιμή, χρησιμοποιήστε ένα αρχικό κόμμα για να ορίσετε κενό ως προεπιλογή. Π.χ. <br />,Επιλογή1,Επιλογή2 - θα οριστεί ως κενό.';
...
$lang['accountdoesnotexist'] = 'Αυτός ο λογαριασμός χρήστη δεν υπάρχει.<br /> Αν φτάσατε σε αυτή τη σελίδα λόγω ενός συνδέσμου στην περιοχή μηνυμάτων χρήστη, σημειώστε ότι ένας άλλος διαχειριστής μπορεί να έχει ήδη χειριστεί ένα αίτημα λογαριασμού και να έχει αφαιρέσει αυτόν τον λογαριασμό.';
...
$lang['executecronphp'] = 'Η αντιστοίχιση συνάφειας δεν θα είναι αποτελεσματική και οι περιοδικές αναφορές μέσω e-mail δεν θα αποστέλλονται. Βεβαιωθείτε ότι το <a href=\'../batch/cron.php\'>batch/cron.php</a> εκτελείται τουλάχιστον μία φορά την ημέρα μέσω μιας εργασίας cron ή παρόμοιας.';
...
$lang['collectiondownloadinprogress'] = 'Παρακαλώ περιμένετε ενώ δημιουργούμε το αρχείο. Αυτό μπορεί να πάρει λίγο χρόνο, ανάλογα με το συνολικό μέγεθος των πόρων σας.<br /><br />Για να συνεχίσετε να εργάζεστε, μπορείτε να <a href=\\"home.php\\" target=\\"_blank\\">> Ανοίξετε ένα Νέο Παράθυρο Περιηγητή</a><br /><br />';
...
$lang['tagcloudtext'] = 'Με ποιους όρους μεταδεδομένων έχουν επισημάνει οι χρήστες τους πόρους; Όσο περισσότερο έχει χρησιμοποιηθεί ένας όρος, τόσο μεγαλύτερος εμφανίζεται στο σύννεφο.<br /><br />Μπορείτε επίσης να κάνετε κλικ σε οποιονδήποτε όρο παρακάτω για να εκτελέσετε την αναζήτηση.';
...
[απόχρήστη] [lang_emailcollectionmessage] <br /><br /> 
[lang_μήνυμα] : [μήνυμα]<br /><br /> 
...
[καλωσόρισμα]<br /><br /> 
[νέες λεπτομέρειες σύνδεσης]<br /><br /> 
[όνομα χρήστη] : [username] <br /><br />
<a href="[url]">[url]</a><br /><br />
[υποσέλιδο κειμένου]';
...
<br /><br />';
$lang['collection_email__introtext'] = 'Παρακαλώ συμπληρώστε την παρακάτω φόρμα.<br />Οι παραλήπτες θα λάβουν ένα email ή μήνυμα συστήματος που θα περιέχει συνδέσμους προς τις συλλογές αντί για συνημμένα αρχεία, ώστε να μπορούν να επιλέξουν και να κατεβάσουν τους κατάλληλους πόρους.';
...
$lang['research_request__introtext'] = 'Οι επαγγελματίες ερευνητές μας είναι εδώ για να σας βοηθήσουν να βρείτε τους καλύτερους πόρους για τα έργα σας. Συμπληρώστε αυτήν τη φόρμα όσο το δυνατόν πιο αναλυτικά ώστε να μπορέσουμε να ανταποκριθούμε στα κριτήριά σας με ακρίβεια. <br /><br />Ένα μέλος της ερευνητικής ομάδας θα αναλάβει το αίτημά σας. Θα διατηρούμε επαφή μέσω email καθ\' όλη τη διάρκεια της διαδικασίας και μόλις ολοκληρώσουμε την έρευνα, θα λάβετε ένα email με έναν σύνδεσμο προς όλους τους πόρους που προτείνουμε.';
$lang['search_advanced__introtext'] = '<strong>Συμβουλή Αναζήτησης</strong><br />Οποιοδήποτε πεδίο αφήσετε κενό ή μη επιλεγμένο θα περιλαμβάνει ΟΛΟΥΣ αυτούς τους όρους στην αναζήτηση. Για παράδειγμα, αν αφήσετε όλα τα πεδία χώρας κενά, η αναζήτηση θα επιστρέψει αποτελέσματα από όλες αυτές τις χώρες. Αν επιλέξετε μόνο την \'Αλγερία\', τότε τα αποτελέσματα θα περιέχουν ΜΟΝΟ πόρους από την \'Αλγερία\'.';
...
$lang['team_research__introtext'] = 'Οργανώστε και διαχειριστείτε τις \'Αιτήσεις Έρευνας\'. <br /><br />Επιλέξτε \'επεξεργασία έρευνας\' για να αναθεωρήσετε τις λεπτομέρειες της αίτησης και να αναθέσετε την έρευνα σε ένα μέλος της ομάδας. Είναι δυνατόν να βασιστεί μια αίτηση έρευνας σε μια προηγούμενη συλλογή εισάγοντας το ID της συλλογής στην οθόνη \'επεξεργασία\'. <br /><br />Μόλις η αίτηση έρευνας ανατεθεί, επιλέξτε \'επεξεργασία συλλογής\' για να προσθέσετε την αίτηση έρευνας στον πίνακα \'Προεπιλεγμένη συλλογή\'. Χρησιμοποιώντας τα τυπικά εργαλεία, είναι στη συνέχεια δυνατόν να προσθέσετε πόρους στην έρευνα. <br /><br />Μόλις η έρευνα ολοκληρωθεί, επιλέξτε \'επεξεργασία έρευνας\', αλλάξτε την κατάσταση σε ολοκληρωμένη και ένα email αποστέλλεται αυτόματα στον χρήστη που ζήτησε την έρευνα. Το email περιέχει έναν σύνδεσμο προς την έρευνα και προστίθεται αυτόματα στον πίνακα \'Προεπιλεγμένη Συλλογή\' τους.';
...
$lang['done__user_password_link_sent'] = 'Εάν η διεύθυνση email σας αναγνωρίστηκε ως ανήκουσα σε έγκυρο λογαριασμό, τότε έχει σταλεί ένα email που περιέχει έναν σύνδεσμο για την επαναφορά του κωδικού πρόσβασής σας.<br /><br /> Εάν δεν λάβετε email και πιστεύετε ότι ο λογαριασμός σας είναι έγκυρος, παρακαλούμε ελέγξτε τα φίλτρα email σας πριν επικοινωνήσετε με τον διαχειριστή του συστήματος σας.';
...
$lang['error-dashactionmissing'] = 'Δεν υποβλήθηκε καμία ενέργεια ή έγκυρα δεδομένα σε αυτήν τη σελίδα. Δεν υπάρχει διαθέσιμο πρότυπο πλακιδίων για δημιουργία. <br />Παρακαλώ επιστρέψτε σε αυτήν τη σελίδα από έναν κατάλληλο σύνδεσμο δημιουργίας / επεξεργασίας';
...
$lang['emailusercollectionrequest'] = 'Το αίτημά σας για πόρο έχει υποβληθεί για έγκριση και θα εξεταστεί σύντομα.:<br /><br />Λόγος αιτήματος: [requestreason]<br /><br />Χρησιμοποιήστε τον παρακάτω σύνδεσμο για να δείτε τους ζητούμενους πόρους.<br /><a href=\'[url]\'>[url]</a>';
...
$lang['iiif'] = 'IIIF';
$lang['api-help'] = 'Παρακαλούμε ανατρέξτε στην <a target="_blank" href="https://www.resourcespace.com/knowledge-base/api">τεκμηρίωση API</a> για λεπτομέρειες σχετικά με τις λειτουργίες. <strong>Προσοχή - οποιεσδήποτε εντολές εισάγετε θα εκτελεστούν χρησιμοποιώντας τα ζωντανά δεδομένα σας.</strong>';
...
$lang['themes__manage'] = 'Οργανώστε και επεξεργαστείτε τις προβαλλόμενες συλλογές που είναι διαθέσιμες online. Οι προβαλλόμενες συλλογές είναι ειδικά προωθημένες συλλογές. <br /><br /> <strong>1 Για να δημιουργήσετε μια νέα καταχώρηση σε μια Προβαλλόμενη συλλογή - δημιουργήστε μια συλλογή</strong><br /> Επιλέξτε <strong>Οι Συλλογές Μου</strong> από το κύριο μενού στην κορυφή και δημιουργήστε μια ολοκαίνουργια <strong>δημόσια</strong> συλλογή. Θυμηθείτε να συμπεριλάβετε ένα όνομα προβαλλόμενης συλλογής κατά τη ρύθμιση. Χρησιμοποιήστε ένα υπάρχον όνομα προβαλλόμενης συλλογής για να ομαδοποιήσετε τη συλλογή κάτω από μια τρέχουσα προβαλλόμενη συλλογή (βεβαιωθείτε ότι το πληκτρολογείτε ακριβώς το ίδιο), ή επιλέξτε έναν νέο τίτλο για να δημιουργήσετε μια ολοκαίνουργια προβαλλόμενη συλλογή. Ποτέ μην επιτρέπετε στους χρήστες να προσθέτουν/αφαιρούν πόρους από προβαλλόμενες συλλογές. <br /> <br /><strong>2 Για να επεξεργαστείτε το περιεχόμενο μιας υπάρχουσας καταχώρησης σε μια προβαλλόμενη συλλογή </strong><br /> Επιλέξτε <strong>επεξεργασία συλλογής</strong>. Τα αντικείμενα σε αυτή τη συλλογή θα εμφανιστούν στο πάνελ <strong>Οι Συλλογές Μου</strong> στο κάτω μέρος της οθόνης. Χρησιμοποιήστε τα τυπικά εργαλεία για να επεξεργαστείτε, αφαιρέσετε ή προσθέσετε πόρους. <br /> <br /><strong>3 Για να αλλάξετε το όνομα μιας προβαλλόμενης συλλογής ή να μετακινήσετε μια συλλογή ώστε να εμφανίζεται κάτω από μια διαφορετική προβαλλόμενη συλλογή</strong><br /> Επιλέξτε <strong>επεξεργασία ιδιοτήτων</strong> και επεξεργαστείτε την κατηγορία προβαλλόμενης συλλογής ή το όνομα της συλλογής. Χρησιμοποιήστε ένα υπάρχον όνομα προβαλλόμενης συλλογής για να ομαδοποιήσετε τη συλλογή κάτω από μια τρέχουσα προβαλλόμενη συλλογή (βεβαιωθείτε ότι το πληκτρολογείτε ακριβώς το ίδιο), ή επιλέξτε έναν νέο τίτλο για να δημιουργήσετε μια ολοκαίνουργια προβαλλόμενη συλλογή. <br /> <br /><strong>4 Για να αφαιρέσετε μια συλλογή από μια προβαλλόμενη συλλογή </strong><br /> Επιλέξτε <strong>επεξεργασία ιδιοτήτων</strong> και διαγράψτε τις λέξεις στο πλαίσιο κατηγορίας προβαλλόμενης συλλογής.';
...
$lang['group_config_inherit'] = 'Η ρύθμιση της ομάδας κληρονομείται από την κύρια ομάδα χρηστών. Δεν υπάρχει τίποτα να ρυθμιστεί εδώ.';
$lang['property-group_preferences_inherit'] = 'Κληρονομήστε από την γονική ομάδα';
$lang['property-sort_method'] = 'Μέθοδος Ταξινόμησης';
$lang['information-sort_method'] = 'Διάταξη που θα χρησιμοποιηθεί κατά την εμφάνιση των αποτελεσμάτων αναζήτησης που είναι ταξινομημένα με βάση αυτό το πεδίο.';
$lang['exiftoolconflictingversions'] = 'Αντικρουόμενες εκδόσεις του Exiftool ανιχνεύθηκαν';
$lang['editgroupconfigoverrides'] = 'Επεξεργασία παραμετροποιήσεων ομάδας';
$lang['sort-method_default'] = 'Προεπιλογή - Αλφαριθμητικός';
$lang['sort-method_dot-notation'] = 'Αριθμός πρόσβασης - σημειογραφία με τελείες';
$lang['save-error-invalid'] = 'Σφάλμα αυτόματης αποθήκευσης - παρακαλώ ελέγξτε το περιεχόμενο και δοκιμάστε ξανά';
$lang['fieldtitle-usergroup_config'] = 'Αντιστάθμιση ομάδας';
$lang['page-title_usergroup_config'] = 'Επεξεργασία παραμετροποιήσεων ομάδας';
$lang['action-title_usergroup_override_detail'] = 'Οποιεσδήποτε ρυθμίσεις έχουν ρυθμιστεί εδώ θα αντικαταστήσουν τις προεπιλεγμένες ρυθμίσεις του συστήματος για τους χρήστες σε αυτήν την ομάδα.';
$lang['team_resource_non_ingested_search'] = 'Δείτε πόρους που δεν έχουν εισαχθεί';
$lang['language-ms'] = 'Μαλαισιανά';
$lang['language-tl'] = 'Filipino';
$lang['upgrade_028_notify_config_not_set'] = 'Αδύνατη η ρύθμιση της επιλογής παραμέτρου (σε επίπεδο συστήματος) %name% σε %value%';
$lang['annotate_tagging_fields'] = 'Πεδία ετικετών';
$lang['annotate_text_adds_comment'] = 'Προσθέστε σχόλιο για τις αναφορές κειμένου πόρου. (N/A για αναφορές πεδίου σταθερής λίστας)';
$lang['annotate_public_view'] = 'Είναι οι σημειώσεις δημόσια ορατές (π.χ. εξωτερικές κοινοποιήσεις);';
$lang['annotate_show_author'] = 'Εμφάνιση συγγραφέα σημείωσης;';
$lang['annotate_exclude_restypes'] = 'Τύποι Πόρων προς εξαίρεση (τσεκάρετε για να εξαιρεθούν και να μην επισημανθούν)';
$lang['annotate_pseudo_rtf_comment_title'] = 'Σχόλια (λειτουργία)';
$lang['annotorious_add_a_comment'] = 'Προσθέστε ένα Σχόλιο...';
$lang['annotorious_type_to_search_field'] = 'Πληκτρολογήστε για να αναζητήσετε...';
$lang['annotate_pdf_sheet_tool'] = 'Σημειώσεις PDF';
$lang['annotate_pdf_intro_text'] = 'Επιλέξτε το μέγεθος σελίδας για το PDF των Σημειώσεών σας.';
$lang['annotate_pdf_no_annotations'] = 'Δεν υπάρχουν σημειώσεις.';
$lang['statusinvalid'] = 'Μη έγκυρο';
$lang['accessinvalid'] = 'Μη έγκυρο';
$lang['requiredfields-status-required_fields'] = 'Τα απαιτούμενα πεδία πρέπει να συμπληρωθούν για να αλλάξει η κατάσταση σε %%STATUS%%. Παρακαλώ ρυθμίστε τα παρακάτω πεδία και δοκιμάστε ξανά: %%FIELDS%%';
$lang['error_file_upload_cond-InvalidMimeType'] = 'Μη έγκυρος τύπος MIME';
$lang['error-edit_status_change_missing_required_fields'] = 'Δεν είναι δυνατόν να αλλάξετε την κατάσταση αρχείου όλων των πόρων. Οι παρακάτω πόροι παραλείφθηκαν καθώς λείπουν δεδομένα σε απαιτούμενα πεδία:';
$lang['missing_required_fields'] = 'Πόροι με ελλιπή υποχρεωτικά πεδία';
$lang['missing_required_fields_intro'] = 'Οι πόροι στη συλλογή εμφανίζονται παρακάτω ταξινομημένοι κατά τα ελλιπή απαιτούμενα πεδία.';
$lang['action_update_now'] = 'Ενημέρωση τώρα';
$lang['errors'] = 'Σφάλματα';
$lang['error_savefirst'] = 'Παρακαλώ αποθηκεύστε τις αλλαγές σας';
$lang['language-be'] = 'Λευκορωσικά';
...
$lang['years'] = 'Χρόνια';
$lang['ago'] = 'πριν';
$lang['action-selectresource'] = 'Επιλέξτε πόρο';
...
$lang['addremove'] = 'Επιλέξτε';
$lang['expand'] = 'Επέκταση';
$lang['error_fieldidnotfound'] = 'Το πεδίο δεν βρέθηκε.';
$lang['page-title_login'] = 'Σύνδεση';
$lang['page-title_about'] = 'Σχετικά με εμάς';
$lang['page-title_alternative_file'] = 'Εναλλακτικό Αρχείο';
$lang['page-title_alternative_files'] = 'Εναλλακτικά Αρχεία';
$lang['page-title_annotate_pdf_config'] = 'Σημειώστε το PDF';
$lang['page-title_annotate_pdf_gen'] = 'Σημειώστε το PDF';
$lang['page-title_api_test'] = 'API Test';
$lang['page-title_change_language'] = 'Αλλαγή Γλώσσας';
$lang['page-title_check'] = 'Έλεγχος Εγκατάστασης';
$lang['page-title_collection_comment'] = 'Σχόλια Συλλογής';
$lang['page-title_collection_copy_resources'] = 'Αντιγραφή Πόρων Συλλογής';
$lang['page-title_collection_download'] = 'Λήψη Συλλογής';
$lang['page-title_collection_edit'] = 'Επεξεργασία Συλλογής';
$lang['page-title_collection_edit_previews'] = 'Επεξεργασία Προεπισκοπήσεων Συλλογών';
$lang['page-title_collection_email'] = 'Συλλογή Email';
$lang['page-title_collection_feedback'] = 'Ανατροφοδότηση Συλλογής';
$lang['page-title_collection_log'] = 'Καταγραφή Συλλογής';
$lang['page-title_collection_manage'] = 'Διαχείριση Συλλογών';
$lang['page-title_collection_public'] = 'Δημόσιες Συλλογές';
$lang['page-title_collection_request'] = 'Αίτηση Συλλογής';
$lang['page-title_collection_set_category'] = 'Ορίστε Κατηγορία Συλλογής';
$lang['page-title_collections_featured'] = 'Επιλεγμένες Συλλογές';
$lang['page-title_collection_share'] = 'Μοιραστείτε τη Συλλογή';
$lang['page-title_collections'] = 'Συλλογές';
$lang['page-title_contact'] = 'Επικοινωνήστε μαζί μας';
$lang['page-title_contactsheet_settings'] = 'Διαμόρφωση Φύλλου Επαφής';
$lang['page-title_content'] = 'Προεπισκόπηση Περιεχομένου Ιστοσελίδας';
$lang['page-title_contribute'] = 'Συμβολές';
$lang['page-title_csv_export_results_metadata'] = 'Εξαγωγή CSV';
$lang['page-title_dash_tile'] = 'Επεξεργασία πλακιδίου Dash';
$lang['page-title_done'] = 'Ολοκληρώθηκε';
$lang['page-title_download'] = 'Λήψη';
$lang['page-title_download_progress'] = 'Πρόοδος Λήψης';
$lang['page-title_download_usage'] = 'Λήψη Χρήσης';
$lang['page-title_edit_fields'] = 'Επεξεργασία Πεδίου Μεταδεδομένων';
$lang['page-title_edit'] = 'Επεξεργασία Πόρου';
$lang['page-title_geo_edit'] = 'Επεξεργασία Τοποθεσίας';
$lang['page-title_geo_search'] = 'Αναζήτηση Τοποθεσίας';
$lang['page-title_graph'] = 'Γράφημα';
$lang['page-title_help'] = 'Βοήθεια';
$lang['page-title_home'] = 'Πίνακας Ελέγχου';
$lang['page-title_job_details'] = 'Λεπτομέρειες Εργασίας Εκτός Σύνδεσης';
$lang['page-title_log_entry'] = 'Καταγραφή Πόρων';
$lang['page-title_log'] = 'Καταγραφή Πόρων';
$lang['page-title_manage_external_shares'] = 'Διαχείριση Μετοχών';
$lang['page-title_manage_jobs'] = 'Διαχείριση Εργασιών Εκτός Σύνδεσης';
$lang['page-title_metadata_download'] = 'Λήψη Μεταδεδομένων';
$lang['page-title_mp3_play'] = 'Αναπαραγωγή Αρχείου Ήχου';
$lang['page-title_no_uploads'] = 'Ανεβάζοντας Μη Διαθέσιμο';
$lang['page-title_preview'] = 'Προεπισκόπηση';
$lang['page-title_request_log'] = 'Αρχείο Αιτήσεων';
$lang['page-title_requests'] = 'Αιτήσεις';
$lang['page-title_research_request'] = 'Αίτημα Έρευνας';
$lang['page-title_resource_collection_list'] = 'Λίστα Συλλογών';
$lang['page-title_resource_email'] = 'Email Πόρος';
$lang['page-title_resource_request'] = 'Αίτηση Πόρου';
$lang['page-title_resource_share'] = 'Μοιραστείτε το Πόρο';
$lang['page-title_search_advanced'] = 'Σύνθετη Αναζήτηση';
$lang['page-title_search_disk_usage'] = 'Χρήση Δίσκου';
$lang['page-title_search'] = 'Αναζήτηση';
$lang['page-title_setup'] = 'Ρύθμιση';
$lang['page-title_share_access'] = 'Μοιραστείτε Πρόσβαση';
$lang['page-title_share_upload'] = 'Ανέβασμα Κοινής Χρήσης';
$lang['page-title_simple_search'] = 'Αναζήτηση';
$lang['page-title_system_down'] = 'Σύστημα εκτός λειτουργίας';
$lang['page-title_terms'] = 'Όροι Χρήσης';
$lang['page-title_themes'] = 'Επιλεγμένες Συλλογές';
$lang['page-title_upload_batch'] = 'Ανέβασμα Πόρων';
$lang['page-title_upload_preview'] = 'Ανέβασμα Προεπισκόπησης';
$lang['page-title_upload_replace_batch'] = 'Αντικατάσταση Πόρων Μαζικά';
$lang['page-title_user_password'] = 'Αλλαγή Κωδικού Πρόσβασης';
$lang['page-title_user_ratings'] = 'Στατιστικά Αξιολόγησης Χρήστη για Πόρο';
$lang['page-title_user_request'] = 'Αίτηση Χρήστη';
$lang['page-title_video_player'] = 'Παίκτης Βίντεο';
$lang['page-title_view_alternative_files'] = 'Δείτε Εναλλακτικό Αρχείο';
$lang['page-title_view_metadata'] = 'Δείτε τα Μεταδεδομένα Πόρου';
$lang['page-title_view'] = 'Δείτε Πόρο';
$lang['page-title_view_shares'] = 'Δείτε Κοινή Χρήση';
$lang['page-title_admin_content_edit'] = 'Επεξεργασία Περιεχομένου Ιστοσελίδας';
$lang['page-title_admin_content'] = 'Περιεχόμενο Ιστοσελίδας';
$lang['page-title_admin_copy_field'] = 'Αντιγραφή Πεδίου Τύπου Πόρου';
$lang['page-title_admin_download_config'] = 'Λήψη Ρυθμίσεων Συστήματος';
$lang['page-title_admin_filter_edit'] = 'Επεξεργασία Φίλτρου';
$lang['page-title_admin_filter_manage'] = 'Διαχείριση Φίλτρου';
$lang['page-title_admin_group_config_edit'] = 'Επεξεργασία Υπερβάσεων Ρυθμίσεων Ομάδας Χρηστών';
$lang['page-title_admin_group_management_edit'] = 'Επεξεργασία Ομάδας Χρηστών';
$lang['page-title_admin_group_management'] = 'Ομάδες Χρηστών';
$lang['page-title_admin_group_permissions'] = 'Επεξεργασία Δικαιωμάτων Ομάδας Χρηστών';
$lang['page-title_admin_home'] = 'Μενού Συστήματος';
$lang['page-title_admin_manage_field_options'] = 'Διαχείριση Επιλογών Πεδίου';
$lang['page-title_admin_manage_slideshow'] = 'Διαχείριση Παρουσίασης';
$lang['page-title_admin_report_management_edit'] = 'Επεξεργασία Αναφοράς';
$lang['page-title_admin_report_management'] = 'Διαχείριση Αναφορών';
$lang['page-title_admin_resource_type_edit'] = 'Επεξεργασία Τύπου Πόρου';
$lang['page-title_admin_resource_type_field_edit'] = 'Επεξεργασία Πεδίου Τύπου Πόρου';
$lang['page-title_admin_resource_type_fields'] = 'Πεδία Τύπου Πόρου';
$lang['page-title_admin_resource_types'] = 'Τύποι Πόρων';
$lang['page-title_admin_size_management_edit'] = 'Επεξεργασία Μεγέθους Εικόνας';
$lang['page-title_admin_size_management'] = 'Μέγεθος Εικόνας';
$lang['page-title_admin_system_config'] = 'Ρυθμίσεις Συστήματος';
$lang['page-title_admin_system_log'] = 'Καταγραφή Συστήματος';
$lang['page-title_admin_system_performance'] = 'Απόδοση Συστήματος';
$lang['page-title_tabs'] = 'Διαχείριση Καρτελών';
$lang['page-title_team_analytics_edit'] = 'Επεξεργασία Αναφοράς Αναλύσεων';
$lang['page-title_team_analytics'] = 'Αναφορά Αναλύσεων';
$lang['page-title_team_archive'] = 'Αρχειοθέτηση Πόρων';
$lang['page-title_team_copy'] = 'Αντιγραφή Πόρου';
$lang['page-title_team_dash_admin'] = 'Διαχείριση Πίνακα Ελέγχου';
$lang['page-title_team_dash_tile'] = 'Πλακίδια Πίνακα';
$lang['page-title_team_dash_tile_special'] = 'Δημιουργία Ειδικού Πλαισίου Πίνακα';
$lang['page-title_team_export'] = 'Εξαγωγή Δεδομένων Συστήματος';
$lang['page-title_team_external_shares'] = 'Διαχείριση Εξωτερικών Κοινοποιήσεων';
$lang['page-title_team_home'] = 'Μενού Διαχειριστή';
$lang['page-title_team_mail'] = 'Αποστολή Μαζικής Αλληλογραφίας';
$lang['page-title_team_plugins_groups'] = 'Διαχείριση Πρόσβασης Plugin Ομάδας Χρηστών';
$lang['page-title_team_plugins'] = 'Διαχείριση Πρόσθετων';
$lang['page-title_team_related_keywords_edit'] = 'Επεξεργασία Σχετικών Λέξεων-Κλειδιών';
$lang['page-title_team_related_keywords'] = 'Σχετικές Λέξεις-Κλειδιά';
$lang['page-title_team_report'] = 'Δείτε την Αναφορά';
$lang['page-title_team_request_edit'] = 'Επεξεργασία Αίτησης';
$lang['page-title_team_request'] = 'Αιτήσεις';
$lang['page-title_team_research_edit'] = 'Επεξεργασία Αίτησης Έρευνας';
$lang['page-title_team_research'] = 'Αίτημα Έρευνας';
$lang['page-title_team_resource'] = 'Μενού Πόρων';
$lang['page-title_team_user_edit'] = 'Επεξεργασία Χρήστη';
$lang['page-title_team_user'] = 'Διαχείριση Χρηστών';
$lang['page-title_team_user_purge'] = 'Διαγραφή Χρηστών';
$lang['page-title_user_actions'] = 'Ενέργειες Χρήστη';
$lang['page-title_user_api_session'] = 'Πρόσβαση API Απομακρυσμένου Συστήματος';
$lang['page-title_user_change_password'] = 'Αλλαγή Κωδικού';
$lang['page-title_user_dash_admin'] = 'Διαχείριση Πίνακα Χρηστών';
$lang['page-title_user_home'] = 'Μενού Χρήστη';
$lang['page-title_user_message'] = 'Μήνυμα Χρήστη';
$lang['page-title_user_messages'] = 'Μηνύματα Χρήστη';
$lang['page-title_user_preferences'] = 'Προτιμήσεις Χρήστη';
$lang['page-title_user_profile_edit'] = 'Το Προφίλ Μου';
$lang['page-title_user_profile'] = 'Προφίλ Χρήστη';
$lang['backtomessages'] = 'Πίσω στα Μηνύματα';
$lang['viewallmessages'] = 'Δείτε όλα τα Μηνύματα';
$lang['months'] = 'Μήνες';
$lang['min_ago'] = '%TIME% λεπτό πριν';
$lang['mins_ago'] = '%TIME% λεπτά πριν';
$lang['hour_ago'] = '%TIME% ώρα πριν';
$lang['hours_ago'] = '%TIME% ώρες πριν';
$lang['day_ago'] = '%TIME% ημέρα πριν';
$lang['days_ago'] = '%TIME% ημέρες πριν';
$lang['week_ago'] = '%TIME% εβδομάδα πριν';
$lang['weeks_ago'] = '%TIME% εβδομάδες πριν';
$lang['month_ago'] = '%TIME% μήνα πριν';
$lang['months_ago'] = '%TIME% μήνες πριν';
$lang['random'] = 'Τυχαίο';
$lang['log-sf'] = 'Το αρχείο Staticsync τροποποιήθηκε';
$lang['log_code_J'] = 'Πρόσθεσε εργασία';
$lang['log_code_JC'] = 'Ολοκληρώθηκε εργασία';
$lang['log_code_JD'] = 'Διαγράφηκε εργασία';
$lang['email_username'] = 'Email / όνομα χρήστη';
$lang['request_new_password'] = 'Αν έχετε ξεχάσει τον κωδικό σας, χρησιμοποιήστε τον παρακάτω σύνδεσμο για να ζητήσετε νέο.';
$lang['enter_username_or_email'] = 'Εισάγετε όνομα χρήστη ή διεύθυνση email';
$lang['enter_a_password'] = 'Εισάγετε κωδικό πρόσβασης';
$lang['enter_a_full_name'] = 'Εισάγετε πλήρες όνομα';
$lang['enter_an_email_address'] = 'Εισάγετε διεύθυνση email';
$lang['new_to_resourcespace'] = 'Νέος στο [applicationname]?';
$lang['show_password'] = 'Εμφάνιση κωδικού';
$lang['hide_password'] = 'Απόκρυψη κωδικού';
$lang['select_a_user_group'] = 'Επιλέξτε ομάδα χρηστών';
$lang['back_to_login'] = 'Επιστροφή στη σύνδεση';
$lang['required'] = 'απαιτείται';
$lang['select_a'] = 'Επιλέξτε ένα';
$lang['notsharableresources'] = 'Τα παρακάτω resources δεν μπορούν να μοιραστούν από αυτόν τον χρήστη και δεν μπορούν να προστεθούν σε κοινόχρηστη συλλογή: ';
$lang['antispam'] = 'Αντι-Spam';
$lang['comments_body-placeholder-anon'] = 'Προσθέστε ένα σχόλιο.';
$lang['batch_replace_alternatives'] = 'Αντικατάσταση αρχικών αρχείων ή εναλλακτικών αρχείων';
$lang['batch_replace_upload_resources'] = 'Αρχικά αρχεία';
$lang['batch_replace_upload_alternatives'] = 'Εναλλακτικά αρχεία';
$lang['userpreference_user_interface'] = 'Διεπαφή Χρήστη';
$lang['systemconfig_watermark_open'] = 'Εφαρμόστε υδατογράφημα σε μικρογραφία / προεπισκόπηση για ομάδες με άδεια "w" ακόμη και όταν η πρόσβαση είναι "Ανοιχτή"';
$lang['systemconfig_watermark_open_search'] = 'Εάν το υδατογράφημα εφαρμόζεται στη μικρογραφία / προεπισκόπηση (παραπάνω επιλογή), εφαρμόστε επίσης το υδατογράφημα στη σελίδα αναζήτησης';
$lang['systemconfig_minyear'] = 'Πρώτη ημερομηνία που θα συμπεριληφθεί στον επιλογέα ημερομηνίας στη φόρμα αναζήτησης. Συνήθως το έτος της πρώτης μεταφόρτωσης';
$lang['systemconfig_searchbyday'] = 'Συμπεριλάβετε ημέρα στην αναζήτηση εκτός από μήνα / έτος';
$lang['systemconfig_default_collection_sort'] = 'Προεπιλεγμένη σειρά ταξινόμησης κατά την προβολή πόρων συλλογής. Όταν οι χρήστες αναμένουν να εμφανίζονται οι πόροι με τη σειρά που παρείχαν, αυτό θα πρέπει να είναι συλλογή';
$lang['systemconfig_systemconfig_searchbyday'] = 'Εμφανίστε την κατάσταση ροής εργασίας πόρου (εικόνα και κείμενο) στα αποτελέσματα αναζήτησης όταν βρίσκεστε σε λειτουργία εμφάνισης μικρογραφιών';
$lang['systemconfig_category_tree_search_use_and'] = 'Η επιλογή μιας τιμής σε ένα πεδίο δέντρου κατηγορίας στη σελίδα αναζήτησης θα επιλέγει αυτόματα όλες τις γονικές τιμές';
$lang['systemconfig_category_tree_search_use_and_logic'] = 'Όλες οι επιλεγμένες τιμές δέντρου κατηγορίας πρέπει να υπάρχουν για να επιστρέψει αποτελέσματα η αναζήτηση (η επιλογή καμία θα βρει ταιριάσματα για οποιαδήποτε επιλεγμένη τιμή)';
$lang['systemconfig_recent_search_quantity'] = 'Αριθμός πόρων που θα εμφανίζονται με συνδέσμους Recent και View new material';
$lang['systemconfig_general'] = 'Γενικά';
$lang['systemconfig_date_yyyy'] = 'Εμφάνιση έτους σε τετραψήφια μορφή';
$lang['systemconfig_imperial_measurements'] = 'Χρησιμοποιήστε αγγλικές μονάδες αντί για μετρικές για τις οδηγίες μεγέθους λήψης';
$lang['systemconfig_site_text_custom_create'] = 'Επιτρέψτε τη δημιουργία νέων καταχωρίσεων κειμένου ιστότοπου από Διαχείριση Περιεχομένου (προορίζεται για την ανάπτυξη νέων σελίδων)';
$lang['systemconfig_no_welcometext'] = 'Απόκρυψη κειμένου καλωσορίσματος στην αρχική σελίδα';
$lang['systemconfig_internal_preview_sizes_editable'] = 'Επιτρέψτε την επεξεργασία εσωτερικών μεγεθών';
$lang['systemconfig_edit_autosave'] = 'Αυτόματη αποθήκευση αλλαγών στη σελίδα επεξεργασίας. Αν όχι, πρέπει να χρησιμοποιηθεί το κουμπί Αποθήκευση';
$lang['systemconfig_resource_request_reason_required'] = 'Όταν ζητάτε πόρο ή πόρους, το πεδίο "Αιτία για το αίτημα" είναι υποχρεωτικό';
$lang['systemconfig_research_request'] = 'Ενεργοποιήστε τη λειτουργία Αίτησης Έρευνας';
$lang['systemconfig_custom_access'] = 'Ενεργοποιήστε το επίπεδο "προσαρμοσμένη πρόσβαση" για πρόσθετο έλεγχο πρόσβασης πόρων';
$lang['systemconfig_enable_related_resources'] = 'Ενεργοποιήστε το πεδίο "Σχετικοί πόροι" κατά την επεξεργασία πόρων.';
$lang['systemconfig_user_accounts'] = 'Λογαριασμοί Χρηστών';
$lang['systemconfig_inactive_user_disable_days'] = 'Αυτόματη απενεργοποίηση ανενεργών χρηστών μετά από καθορισμένο αριθμό ημερών (0 απενεργοποιεί αυτήν τη λειτουργία)';
$lang['systemconfig_sharing'] = 'Κοινή χρήση';
$lang['systemconfig_external_share_groups_config_options'] = 'Τιμήστε τις επιλογές διαμόρφωσης ομάδας κατά την εξωτερική κοινή χρήση ως συγκεκριμένη ομάδα χρηστών';
$lang['systemconfig_resource_share_expire_days_default'] = 'Προεπιλεγμένος αριθμός ημερών πριν από την επιλογή λήξης κοινής χρήσης (ορίστε 0 για χρήση της πρώτης επιλογής)';
$lang['systemconfig_restricted_share'] = 'Θα πρέπει οι χρήστες με "περιορισμένη" πρόσβαση σε πόρο να μπορούν να μοιράζονται τον πόρο';
$lang['systemconfig_blank_edit_template'] = 'Κατά την ανάρτηση πόρων (μαζική ανάρτηση) και την επεξεργασία του προτύπου, επαναφορά τιμών σε κενό ή την προεπιλεγμένη τιμή κάθε φορά';
$lang['systemconfig_enable_copy_data_from'] = 'Κατά την μαζική ανάρτηση, ενεργοποιήστε τη λειτουργία "Αντιγραφή δεδομένων πόρου από υπάρχοντα πόρο"';
$lang['systemconfig_resource_view'] = 'Προβολή πόρου';
$lang['systemconfig_show_resourceid'] = 'Εμφάνιση του αναγνωριστικού πόρου στη σελίδα προβολής';
$lang['systemconfig_show_resource_type'] = 'Εμφάνιση τύπου πόρου στη σελίδα προβολής';
$lang['systemconfig_show_access_field'] = 'Εμφάνιση πρόσβασης πόρου στη σελίδα προβολής';
$lang['systemconfig_show_contributed_by'] = 'Εμφάνιση του χρήστη "συνεισέφερε" στη σελίδα προβολής';
$lang['systemconfig_show_related_themes'] = 'Εμφάνιση σχετικών συλλογών και πάνελ δημόσιων συλλογών στη σελίδα προβολής';
$lang['systemconfig_metadata_download'] = 'Εμφάνιση επιλογής "Λήψη μεταδεδομένων" στη σελίδα προβολής';
$lang['systemconfig_uploading'] = 'Ανάρτηση';
$lang['systemconfig_upload_add_to_new_collection'] = 'Η επιλογή "Προσθήκη σε Νέα Συλλογή" θα χρησιμοποιηθεί για μαζικές αναρτήσεις. Απενεργοποιήστε για προεπιλογή "Μην Προσθέσετε στη Συλλογή"';
$lang['systemconfig_upload_add_to_new_collection_opt'] = 'Για μαζικές αναρτήσεις, ενεργοποιήστε την επιλογή "Προσθήκη σε Νέα Συλλογή"';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = 'Για μαζικές αναρτήσεις, ενεργοποιήστε την επιλογή "Μην Προσθέσετε σε Νέα Συλλογή" (αν δεν ενεργοποιηθεί, θα αναγκαστεί η ανάρτηση σε συλλογή)';
$lang['systemconfig_upload_collection_name_required'] = 'Απαιτείται η εισαγωγή ονόματος συλλογής για μαζικές αναρτήσεις. Θα υπερισχύσει τη συμπεριφορά προεπιλογής Upload[timestamp]';
$lang['systemconfig_allow_password_change'] = 'Επιτρέπεται η αλλαγή κωδικού πρόσβασης';
$lang['systemconfig_allow_password_reset'] = 'Επιτρέπεται στους χρήστες να ζητούν νέο κωδικό μέσω της οθόνης σύνδεσης';
$lang['systemconfig_allow_keep_logged_in'] = 'Εμφάνιση επιλογής "Να με κρατάς συνδεδεμένο σε αυτήν τη συσκευή" στην οθόνη σύνδεσης';
$lang['systemconfig_remember_me_checked'] = 'Η επιλογή "Να με κρατάς συνδεδεμένο σε αυτήν τη συσκευή" είναι προεπιλεγμένη';
$lang['systemconfig_session_length'] = 'Διάρκεια συνεδρίας χρήστη (λεπτά)';
$lang['systemconfig_session_autologout'] = 'Αυτόματη αποσύνδεση χρήστη στο τέλος της συνεδρίας (απενεργοποίηση μετά από χρόνο αδράνειας ίσο με τη διάρκεια συνεδρίας)';
$lang['systemconfig_slideshow_photo_delay'] = 'Αριθμός δευτερολέπτων που περιμένει η παρουσίαση πριν αλλάξει εικόνα';
$lang['config_integer_invalid_range'] = 'Μη έγκυρη τιμή. Εισάγετε έναν αριθμό μεταξύ %MIN% και %MAX%';
$lang['alternative_file_replaced'] = 'Εναλλακτικό αρχείο αντικαταστάθηκε επιτυχώς';
$lang['jq_create_alt_previews_success_text'] = 'Προεπισκοπήσεις δημιουργήθηκαν για το εναλλακτικό αρχείο #%ALTFILE επιτυχώς';
$lang['jq_create_alt_previews_failure_text'] = 'Αποτυχία δημιουργίας προεπισκοπήσεων για το εναλλακτικό αρχείο #%ALTFILE';
$lang['error_report_execution'] = 'Παρουσιάστηκε σφάλμα κατά την εκτέλεση της αναφοράς, ελέγξτε αν η ερώτηση είναι έγκυρη';
$lang['error_save_not_allowed_dash_tile_set_public'] = 'Αδύνατη η αποθήκευση της αλλαγής. Βεβαιωθείτε ότι δεν υπάρχουν πλακίδια πίνακα ελέγχου που να έχουν οριστεί για όλους ή πολλούς χρήστες και να συνδέονται με αυτήν τη συλλογή';
$lang['error_upload_replace_alternative_file_not_found'] = 'Αποτυχία ενημέρωσης εναλλακτικού αρχείου. Δεν βρέθηκε αντίστοιχη εγγραφή εναλλακτικού αρχείου με όνομα αρχείου [filename]';
$lang['error_upload_replace_alternative_multiple_found'] = 'Αποτυχία ενημέρωσης εναλλακτικού αρχείου. Βρέθηκαν πολλαπλές αντίστοιχες εγγραφές εναλλακτικού αρχείου με όνομα αρχείου [filename], περιορισμός με αναγνωριστικό πόρου ή συλλογή';
$lang['oj-batch-replace-local-alternatives-success-text'] = 'Η μαζική αντικατάσταση αντικατέστησε επιτυχώς %TOTALFILES εναλλακτικά αρχεία';
$lang['replacebatch_collection_alternatives'] = 'Εισάγετε ένα αναγνωριστικό συλλογής αν θέλετε μόνο να προσθέσετε ή να αντικαταστήσετε εναλλακτικά αρχεία σε πόρους αυτής της συλλογής';
$lang['replacebatch_resource_min_alternatives'] = 'Το χαμηλότερο αναγνωριστικό πόρου για αντικατάσταση εναλλακτικών αρχείων (αγνοείται αν έχει οριστεί συλλογή)';
$lang['replacebatch_resource_max_alternatives'] = 'Το υψηλότερο αναγνωριστικό πόρου για αντικατάσταση εναλλακτικών αρχείων';
$lang['system_config_search_engines'] = 'Μηχανές Αναζήτησης';
$lang['int_ranges_empty'] = 'Η εισαγωγή είναι κενή';
$lang['int_ranges_range_below_1'] = 'Οι αριθμοί πρέπει να είναι 1 ή μεγαλύτεροι στη σειρά %%PART%%';
$lang['int_ranges_range_reversed'] = 'Η αρχή της σειράς %%PART%% δεν μπορεί να είναι μεγαλύτερη από το τέλος';
$lang['int_ranges_range_above_max'] = 'Η σειρά %%PART%% υπερβαίνει τον μέγιστο αριθμό %%MAX_VAL%%';
$lang['int_ranges_single_below_1'] = 'Οι αριθμοί πρέπει να είναι 1 ή μεγαλύτεροι (%%PART%%)';
$lang['int_ranges_single_above_max'] = 'Το %%PART%% υπερβαίνει τον μέγιστο αριθμό %%MAX_VAL%%';
$lang['int_ranges_not_valid'] = 'Το %%PART%% δεν είναι έγκυρος αριθμός ή σειρά (χρησιμοποιήστε μορφές όπως 3 ή 5-9)';
$lang['job_trigger'] = 'Εκτέλεση εργασίας';
$lang['job_configure'] = 'Ρύθμιση εργασίας';
$lang['jobs_action_stream_log'] = 'Αρχείο καταγραφής ροής';
$lang['jobs_action_download_log'] = 'Λήψη αρχείου καταγραφής';
$lang['jobs_action_not_started'] = 'Η εργασία δεν ξεκίνησε ακόμη';
$lang['jobs_action_missing_job_progress'] = 'Αδύνατη η φόρτωση προόδου εργασίας';
$lang['job_action_not_found'] = 'Η εργασία δεν βρέθηκε.';
$lang['job_list_core'] = 'Βασικό';
$lang['job_list_recreate_previews'] = 'Αναδημιουργία προεπισκοπήσεων';
$lang['job_list_exif_data'] = 'Αναδημιουργία δεδομένων EXIF';
$lang['job_list_purge_duplicates'] = 'Διαγραφή διπλότυπων πόρων';
$lang['job_list_reindex'] = 'Επαναευρετηρίαση δεδομένων';
$lang['job_list_checksums'] = 'Ενημέρωση checksum';
$lang['job_list_extracted_text'] = 'Ενημέρωση εξαγόμενου κειμένου';
$lang['oj_common_create_job'] = 'Δημιουργία εργασίας';
$lang['oj_common_field_refs'] = 'Αναφορές πεδίων';
$lang['oj_common_collection_refs'] = 'Αναφορές συλλογών';
$lang['oj_common_error_required'] = 'Απαιτούμενο πεδίο';
$lang['oj_common_error_invalid'] = 'Μη έγκυρη τιμή που δόθηκε για το πεδίο';
$lang['oj_common_error_invalid_field_ref'] = '%FIELD_REF% δεν αναφέρεται σε έγκυρο πεδίο';
$lang['oj_recreate_previews_target'] = 'Τι τύπου αναφορών παρέχονται;';
$lang['oj_recreate_previews_refs'] = 'Αναφορές';
$lang['oj_recreate_previews_image_sizes'] = 'Μέγεθος εικόνων προς δημιουργία';
$lang['oj_recreate_previews_resource_types'] = 'Τύποι πόρων προς στόχευση';
$lang['oj_recreate_previews_use_existing'] = 'Χρήση υπάρχουσας ανεβασμένης προεπισκόπησης;';
$lang['oj_recreate_previews_video_update'] = 'Ενημέρωση προεπισκοπήσεων για όλους τους βίντεο πόρους που δεν έχουν την απαιτούμενη επέκταση \'$ffmpeg_preview_extension\';';
$lang['oj_recreate_previews_delete_existing'] = 'Διαγραφή όλων των υφιστάμενων προεπισκοπήσεων';
$lang['oj_recreate_previews_refs_help'] = 'Ο ορισμός αυτής της επιλογής ελέγχει ποιες αναφορές (είτε πόρου είτε συλλογής) θα χρησιμοποιηθούν για επεξεργασία. Έγκυρες εισόδους περιλαμβάνουν λίστες διαχωρισμένες με κόμμα, εύρη και χαρακτήρες μπαλαντέρ π.χ * θα επεξεργαστεί όλες τις αναφορές, 1-100 θα επεξεργαστεί τις πρώτες 100 αναφορές, 101-* θα επεξεργαστεί αναφορές από το 101 και μετά και 1,3,5 θα επεξεργαστεί τις αναφορές 1, 3 και 5. Μπορούν να συνδυαστούν για να στοχεύσουν ακριβώς τις απαιτούμενες αναφορές, π.χ 1,5-10,15-* θα στοχεύσει τις 1, 5 έως 10 και 15 και μετά.';
$lang['oj_recreate_previews_use_existing_help'] = 'Ο ορισμός αυτής της επιλογής θα προσπαθήσει να διατηρήσει τυχόν προεπισκοπήσεις που έχουν αντικατασταθεί χειροκίνητα σε πόρους. Αν δεν χρησιμοποιηθεί, οποιεσδήποτε χειροκίνητα ανεβασμένες προεπισκοπήσεις θα αντικατασταθούν με προεπισκοπήσεις που προέρχονται από το αρχικό αρχείο.';
$lang['oj_recreate_previews_video_update_help'] = 'Ο ορισμός αυτής της επιλογής θα ενημερώσει οποιαδήποτε βίντεο που δεν ταιριάζουν με την τρέχουσα διαμορφωμένη επέκταση \'$ffmpeg_preview_extension\'. Αυτό είναι χρήσιμο όταν έχει αλλάξει αυτή η ρύθμιση, για να στοχεύσει μόνο αυτούς τους πόρους που χρειάζονται νέα προεπισκόπηση.';
$lang['oj_recreate_previews_delete_existing_help'] = 'Ο ορισμός αυτής της επιλογής θα διαγράψει όλες τις υπάρχουσες προεπισκοπήσεις πριν τις αναδημιουργήσει.';
$lang['oj_exif_data_blanks'] = 'Κενό πεδίο όταν δεν υπάρχουν δεδομένα EXIF';
$lang['oj_exif_data_overwrite'] = 'Αντικατάσταση υφιστάμενων τιμών πεδίων όπου υπάρχουν δεδομένα EXIF';
$lang['oj_exif_data_field_refs_help'] = 'Αυτές είναι οι αναφορές των πεδίων από τα οποία θέλετε να εξαχθούν δεδομένα EXIF. Τα πεδία αυτά πρέπει να έχουν διαμορφωθεί ως "Exiftool field". Μπορεί να χρησιμοποιηθεί λίστα διαχωρισμένη με κόμμα π.χ 1,3,5.';
$lang['oj_exif_data_collection_refs_help'] = 'Ο ορισμός αυτής της επιλογής σημαίνει ότι θα ενημερωθούν μόνο οι πόροι στις καταχωρημένες συλλογές. Αν δεν οριστούν συλλογές, τότε τα δεδομένα EXIF θα ενημερωθούν για ΟΛΟΥΣ τους κατάλληλους πόρους. Οι συλλογές μπορούν να οριστούν με λίστα διαχωρισμένη με κόμμα και εύρη π.χ 100,105,110-115';
$lang['oj_exif_data_blanks_help'] = 'Ο ορισμός αυτής της επιλογής θα καθαρίσει το συγκεκριμένο πεδίο αν το αρχείο δεν περιέχει ενσωματωμένα δεδομένα EXIF γι\' αυτό.';
$lang['oj_exif_data_overwrite_help'] = 'Ο ορισμός αυτής της επιλογής θα αντικαταστήσει οποιαδήποτε υπάρχουσα τιμή του πεδίου με τα ενσωματωμένα δεδομένα EXIF, αν υπάρχουν στο αρχείο.';
$lang['oj_purge_duplicates_intro'] = '<strong>Προειδοποίηση: Αυτό το σενάριο επιτρέπει την ΜΟΝΙΜΗ ΔΙΑΓΡΑΦΗ πόρων - παρακαλούμε χρησιμοποιήστε την επιλογή Δοκιμαστικής Εκτέλεσης για να επαληθεύσετε τις ρυθμίσεις σας αν δεν είστε σίγουροι.</strong>';
$lang['oj_purge_duplicates_manage_method'] = 'Μέθοδος διαχείρισης';
$lang['oj_purge_duplicates_lifo'] = 'Διατήρηση των παλαιότερων και διαγραφή των νεότερων διπλότυπων';
$lang['oj_purge_duplicates_fifo'] = 'Διατήρηση των νεότερων και διαγραφή των παλαιότερων διπλότυπων';
$lang['oj_purge_duplicates_dry_run'] = 'Δοκιμαστική εκτέλεση';
$lang['oj_purge_duplicates_delete_perm'] = 'Μόνιμη διαγραφή';
$lang['oj_purge_duplicates_delete_error'] = 'Η μόνιμη διαγραφή δεν είναι δυνατή κατά τη διάρκεια δοκιμαστικής εκτέλεσης';
$lang['oj_purge_duplicates_collection_refs_help'] = 'Ορίζει τις συλλογές ως το πεδίο εφαρμογής της ανίχνευσης διπλότυπων. Δεν χρειάζεται να υπάρχουν όλα τα διπλότυπα στις συλλογές, αρκεί ένα από αυτά. Τα διπλότυπα θα επεξεργαστούν συστημικά και θα διαγραφούν μέσω της επιλεγμένης μεθόδου διαχείρισης. Οι συλλογές μπορούν να οριστούν με λίστα διαχωρισμένη με κόμμα και εύρη π.χ 100,105,110-115';
$lang['oj_purge_duplicates_manage_method_help'] = 'Ο ορισμός αυτής της επιλογής ελέγχει πώς θα διαχειριστεί το σενάριο τη διαγραφή διπλότυπων.';
$lang['oj_purge_duplicates_dry_run_help'] = 'Ο ορισμός αυτής της επιλογής θα εκτελέσει μια δοκιμαστική λειτουργία χωρίς να γίνουν αλλαγές σε πόρους. Το αρχείο καταγραφής με τα αποτελέσματα της δοκιμής μπορεί να κατεβαστεί για ανασκόπηση.';
$lang['oj_purge_duplicates_delete_perm_help'] = 'Ο ορισμός αυτής της επιλογής θα διαγράψει μόνιμα τους διπλότυπους πόρους, διαφορετικά οι πόροι θα μετακινηθούν στην διαμορφωμένη κατάσταση διαγραφής πόρων.';
$lang['oj_reindex_field_refs_help'] = 'Ο ορισμός αυτής της επιλογής θα περιορίσει ποια πεδία θα επανευρετηριαστούν, μπορεί να χρησιμοποιηθεί λίστα διαχωρισμένη με κόμμα π.χ 1,3,5. Αν δεν εισαχθούν πεδία, θα επανευρετηριαστούν ΟΛΑ τα πεδία.';
$lang['oj_checksums_recreate'] = 'Αναδημιουργία όλων των checksum';
$lang['oj_checksums_recreate_help'] = 'Ο ορισμός αυτής της επιλογής θα αναγκάσει την αναδημιουργία όλων των checksum πόρων, όχι μόνο αυτών που δεν έχουν ήδη checksum.';
$lang['oj_extracted_text_update_all'] = 'Ενημέρωση ακόμα και αν υπάρχει ήδη δεδομένο, και αντικατάσταση παλαιών τιμών';
$lang['oj_extracted_text_collection_refs_help'] = 'Ο ορισμός αυτής της επιλογής θα περιορίσει την επεξεργασία στους πόρους στις καταχωρημένες συλλογές μόνο. Αν δεν οριστούν συλλογές, τότε το εξαγόμενο κείμενο θα ενημερωθεί για ΟΛΟΥΣ τους κατάλληλους πόρους. Οι συλλογές μπορούν να οριστούν με λίστα διαχωρισμένη με κόμμα και εύρη π.χ 100,105,110-115';
$lang['oj_extracted_text_update_all_help'] = 'Ο ορισμός αυτής της επιλογής θα εκτελέσει την εξαγωγή ακόμα και αν υπάρχει ήδη δεδομένο, και θα αντικαταστήσει την παλιά τιμή.';
$lang['requiredfield_multiple'] = 'Αυτό είναι υποχρεωτικό πεδίο κατά την αλλαγή της κατάστασης αρχειοθέτησης';
$lang['reorder_invalid'] = 'Η συλλογή δεν μπορεί να αναδιαταχθεί εκτός αν η σειρά ταξινόμησης είναι η σειρά συλλογής';
$lang['reorder_permissions_fail'] = 'Η συλλογή δεν μπορεί να αναδιαταχθεί επειδή δεν έχετε πρόσβαση σε όλους τους πόρους αυτής της συλλογής';
$lang['resource-card-menu-delete'] = 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτόν τον πόρο;';
$lang['resource-card-menu-delete-button'] = 'Ναι, διαγραφή πόρου';
$lang['resource-card-menu-delete-perm'] = 'Είστε σίγουροι; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.';
$lang['resource-card-menu-delete-perm-button'] = 'Ναι, διαγραφή οριστικά';
$lang['blue'] = 'Μπλε';
$lang['green'] = 'Πράσινο';
$lang['red'] = 'Κόκκινο';
$lang['purple'] = 'Μωβ';
$lang['fieldtype-geo_location'] = 'Γεωεντοπισμός';
$lang['property-geomapping'] = 'Τύπος γεωεντοπισμού';
$lang['information-geomapping'] = 'Αποθηκεύστε τον γεωεντοπισμό σε αυτό το πεδίο ως είτε γεωγραφικό πλάτος, μήκος ή και τα δύο.<br \\/>Μόνο ένα πεδίο μπορεί να οριστεί και στα δύο ή ένα πεδίο για κάθε γεωγραφικό πλάτος και μήκος.<br \\/>Διαθέσιμο μόνο για πεδία κειμένου μιας γραμμής.';
$lang['disabled-geomapping-title'] = 'Ο γεωεντοπισμός έχει οριστεί σε διαφορετικό πεδίο ή πεδία, για να το αλλάξετε σε αυτό το πεδίο, πρέπει να αφαιρεθεί από άλλα πεδία';
$lang['geo_location-none'] = 'Κανένα';
$lang['geo_location-latitude'] = 'Γεωγραφικό πλάτος';
$lang['geo_location-longitude'] = 'Γεωγραφικό μήκος';
$lang['geo_location-both'] = 'Και τα δύο';
$lang['knowledgebase'] = 'Βάση Γνώσεων';
$lang['search_filter_panel_toggle'] = 'Εναλλαγή φίλτρων αναζήτησης';
$lang['search_resources'] = 'Αναζήτηση πόρων';
$lang['clear_filters'] = 'Καθαρισμός φίλτρων';
$lang['save-error-invalid-latlong'] = 'Σφάλμα αυτόματης αποθήκευσης - μη έγκυρος γεωεντοπισμός, Χρησιμοποιήστε: γεωγραφικό πλάτος, μήκος (π.χ. 40.7128, -74.0060). Η τοποθεσία του πόρου δεν ενημερώθηκε.';
$lang['save-error-invalid-lat'] = 'Σφάλμα αυτόματης αποθήκευσης - μη έγκυρο γεωγραφικό πλάτος, πρέπει να είναι μεταξύ -90 και 90. Η τοποθεσία του πόρου δεν ενημερώθηκε.';
$lang['save-error-invalid-long'] = 'Σφάλμα αυτόματης αποθήκευσης - μη έγκυρο γεωγραφικό μήκος, πρέπει να είναι μεταξύ -180 και 180. Η τοποθεσία του πόρου δεν ενημερώθηκε.';
$lang['or'] = 'ή';
$lang['view_all_fcs'] = 'Προβολή όλων των επιλεγμένων συλλογών';
$lang['dashtile_upload'] = 'Προσθέστε πόρους στο σύστημά σας';
$lang['knowledgebase-tooltip'] = 'Προβολή τεκμηρίωσης ResourceSpace (Βάση Γνώσεων)';
$lang['noresources_collection'] = 'Δεν υπάρχουν πόροι στη συλλογή';
$lang['hide_collection_bar'] = 'Κρυμμένο';
$lang['minimal_collection_bar'] = 'Ελάχιστη γραμμή';
$lang['thumbnails_collection_bar'] = 'Προβολή μικρογραφιών';
$lang['language-bg'] = 'Βουλγαρικά';
$lang['language-zh-TW'] = 'Παραδοσιακά Κινέζικα';

$lang["home__welcometext"] = 'Το κορυφαίο σύστημα διαχείρισης ψηφιακών πόρων ανοιχτού κώδικα για επιχειρήσεις.';
$lang["language-ku"] = 'Κουρδικά';