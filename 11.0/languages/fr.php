...
$lang['upload_failed_for_path'] = 'Dépôt échoué pour %path%';
...
$lang['emailcollectionmessage'] = 'vous a envoyé par mél une collection de documents de [applicationname] qui a été ajoutée à votre page \'Mes Collections\'.';
...
$lang['matchingresources'] = 'documents correspondants';
...
$lang['youfound'] = 'Vous avez trouvé';
$lang['youfoundresources'] = 'documents';
...
$lang['enteringfewerkeywords'] = 'entrant moins de mots-clés.';
...
$lang['hasemailedyouaresource'] = 'vous a envoyé un document par mél';
...
$lang['max'] = 'Max';
$lang['statisticsfor'] = 'Statistiques pour';
...
$lang['columnheader-full_name'] = 'Nom complet';
$lang['email'] = 'Mél';
...
$lang['requeststatus0'] = 'Non-assigné';
...
$lang['haspostedresearchrequest'] = 'a envoyé une demande de recherche';
...
$lang['resourceid'] = 'Numéro de document';
$lang['columnheader-resource_id'] = 'Numéro de document';
$lang['id'] = 'N°';
$lang['date'] = 'Date';
$lang['todate'] = 'Au';
$lang['fromdate'] = 'Du';
...
$lang['newlogindetails'] = 'Veuillez trouver ci-dessous vos informations de connexion.';
$lang['youraccountdetails'] = 'Vos informations de connexion';
$lang['copyfromcollection'] = 'Copier depuis la collection';
$lang['donotcopycollection'] = 'Ne pas copier depuis une collection';
$lang['resourcesincollection'] = 'documents dans cette collection';
...
$lang['enterantispamcode'] = 'Veuillez entrer le code suivant';
...
$lang['group_config_inherit'] = 'La configuration du groupe est héritée du groupe d\'utilisateurs parent. Rien à configurer ici.';
$lang['property-group_preferences_inherit'] = 'Hériter du groupe parent';
$lang['property-sort_method'] = 'Méthode de tri';
$lang['information-sort_method'] = 'Ordre à utiliser lors de l\'affichage des résultats de recherche triés par ce champ.';
$lang['exiftoolconflictingversions'] = 'Versions conflictuelles d\'Exiftool détectées';
$lang['editgroupconfigoverrides'] = 'Modifier les remplacements de configuration du groupe';
$lang['sort-method_default'] = 'Par défaut - Alphanumérique';
$lang['sort-method_dot-notation'] = 'Numéro d\'accès - notation par points';
$lang['save-error-invalid'] = 'Erreur de sauvegarde automatique - veuillez vérifier le contenu et réessayer';
$lang['fieldtitle-usergroup_config'] = 'Remplacements de groupe';
$lang['page-title_usergroup_config'] = 'Modifier les remplacements de configuration du groupe';
$lang['action-title_usergroup_override_detail'] = 'Tous les paramètres configurés ici remplaceront les paramètres par défaut du système pour les utilisateurs de ce groupe.';
$lang['team_resource_non_ingested_search'] = 'Voir les ressources non ingérées';
$lang['language-ms'] = 'Malay';
$lang['language-tl'] = 'Filipino';
$lang['upgrade_028_notify_config_not_set'] = 'Impossible de définir l\'option de configuration (système global) %name% à %value%';
$lang['annotate_tagging_fields'] = 'Champs de balisage';
$lang['annotate_text_adds_comment'] = 'Ajouter un commentaire pour les annotations de texte des ressources. (N/A pour les annotations de champ de liste fixe)';
$lang['annotate_public_view'] = 'Les annotations sont-elles visibles publiquement (par exemple, partages externes) ?';
$lang['annotate_show_author'] = 'Afficher l\'auteur de l\'annotation ?';
$lang['annotate_exclude_restypes'] = 'Types de ressources à exclure (cochez pour exclure et ne pas être annoté)';
$lang['annotate_pseudo_rtf_comment_title'] = 'Commentaires (mode)';
$lang['annotorious_add_a_comment'] = 'Ajouter un commentaire...';
$lang['annotorious_type_to_search_field'] = 'Tapez pour rechercher...';
$lang['annotate_pdf_sheet_tool'] = 'Annotations PDF';
$lang['annotate_pdf_intro_text'] = 'Sélectionnez la taille de page pour votre PDF d\'annotations.';
$lang['annotate_pdf_no_annotations'] = 'Il n\'y a pas d\'annotations.';
$lang['statusinvalid'] = 'Invalide';
$lang['accessinvalid'] = 'Invalide';
$lang['requiredfields-status-required_fields'] = 'Les champs obligatoires doivent être remplis pour changer le statut en %%STATUS%%. Veuillez définir les champs suivants et réessayer : %%FIELDS%%';
$lang['error_file_upload_cond-InvalidMimeType'] = 'Type MIME invalide';
$lang['error-edit_status_change_missing_required_fields'] = 'Il n\'est pas possible de changer le statut d\'archive de toutes les ressources. Les ressources suivantes ont été ignorées car elles ont des données manquantes dans des champs obligatoires :';
$lang['missing_required_fields'] = 'Ressources avec des champs obligatoires incomplets';
$lang['missing_required_fields_intro'] = 'Les ressources dans la collection apparaissent ci-dessous triées par champs requis incomplets.';
$lang['action_update_now'] = 'Mettre à jour maintenant';
$lang['errors'] = 'Erreurs';
$lang['error_savefirst'] = 'Veuillez enregistrer vos modifications';
$lang['language-be'] = 'Biélorusse';
...
$lang['years'] = 'Années';
$lang['ago'] = 'il y a';
$lang['action-selectresource'] = 'Sélectionner la ressource';
$lang['addremove'] = 'Sélectionner';
$lang['expand'] = 'Développer';
$lang['error_fieldidnotfound'] = 'Champ id non trouvé.';
$lang['page-title_login'] = 'Connexion';
$lang['page-title_about'] = 'À propos de nous';
$lang['page-title_alternative_file'] = 'Fichier alternatif';
$lang['page-title_alternative_files'] = 'Fichiers alternatifs';
$lang['page-title_annotate_pdf_config'] = 'Annoter le PDF';
$lang['page-title_annotate_pdf_gen'] = 'Annoter le PDF';
$lang['page-title_api_test'] = 'Test API';
$lang['page-title_change_language'] = 'Changer de langue';
$lang['page-title_check'] = 'Vérification de l\'installation';
$lang['page-title_collection_comment'] = 'Commentaires de la collection';
$lang['page-title_collection_copy_resources'] = 'Copier les ressources de la collection';
$lang['page-title_collection_download'] = 'Téléchargement de la collection';
$lang['page-title_collection_edit'] = 'Modifier la collection';
$lang['page-title_collection_edit_previews'] = 'Modifier les aperçus de la collection';
$lang['page-title_collection_email'] = 'Collection d\'Email';
$lang['page-title_collection_feedback'] = 'Retour sur la collection';
$lang['page-title_collection_log'] = 'Journal de collection';
$lang['page-title_collection_manage'] = 'Gérer les collections';
$lang['page-title_collection_public'] = 'Collections publiques';
$lang['page-title_collection_request'] = 'Demander une collection';
$lang['page-title_collection_set_category'] = 'Définir la catégorie de collection';
$lang['page-title_collections_featured'] = 'Collections en vedette';
$lang['page-title_collection_share'] = 'Partager la collection';
$lang['page-title_collections'] = 'Collections';
$lang['page-title_contact'] = 'Contactez-nous';
$lang['page-title_contactsheet_settings'] = 'Configuration de la feuille de contact';
$lang['page-title_content'] = 'Aperçu du contenu du site';
$lang['page-title_contribute'] = 'Contributions';
$lang['page-title_csv_export_results_metadata'] = 'Export CSV';
$lang['page-title_dash_tile'] = 'Modifier le carreau du tableau de bord';
$lang['page-title_done'] = 'Fait';
$lang['page-title_download'] = 'Télécharger';
$lang['page-title_download_progress'] = 'Progression du téléchargement';
$lang['page-title_download_usage'] = 'Téléchargement d\'utilisation';
$lang['page-title_edit_fields'] = 'Modifier le champ de métadonnées';
$lang['page-title_edit'] = 'Modifier la ressource';
$lang['page-title_geo_edit'] = 'Modifier l\'emplacement';
$lang['page-title_geo_search'] = 'Recherche de localisation';
$lang['page-title_graph'] = 'Graphique';
$lang['page-title_help'] = 'Aide';
$lang['page-title_home'] = 'Dash';
$lang['page-title_job_details'] = 'Détails de l\'emploi hors ligne';
$lang['page-title_log_entry'] = 'Journal des ressources';
$lang['page-title_log'] = 'Journal des ressources';
$lang['page-title_manage_external_shares'] = 'Gérer les Partages';
$lang['page-title_manage_jobs'] = 'Gérer les travaux hors ligne';
$lang['page-title_metadata_download'] = 'Télécharger les métadonnées';
$lang['page-title_mp3_play'] = 'Lire le fichier audio';
$lang['page-title_no_uploads'] = 'Téléchargement indisponible';
$lang['page-title_preview'] = 'Aperçu';
$lang['page-title_request_log'] = 'Journal des demandes';
$lang['page-title_requests'] = 'Demandes';
$lang['page-title_research_request'] = 'Demande de recherche';
$lang['page-title_resource_collection_list'] = 'Liste des collections';
$lang['page-title_resource_email'] = 'Email Ressource';
$lang['page-title_resource_request'] = 'Demander une ressource';
$lang['page-title_resource_share'] = 'Partager la ressource';
$lang['page-title_search_advanced'] = 'Recherche avancée';
$lang['page-title_search_disk_usage'] = 'Utilisation du disque';
$lang['page-title_search'] = 'Recherche';
$lang['page-title_setup'] = 'Configuration';
$lang['page-title_share_access'] = 'Partager l\'accès';
$lang['page-title_share_upload'] = 'Télécharger Partager';
$lang['page-title_simple_search'] = 'Recherche';
$lang['page-title_system_down'] = 'Système hors service';
$lang['page-title_terms'] = 'Conditions d\'utilisation';
$lang['page-title_themes'] = 'Collections en vedette';
$lang['page-title_upload_batch'] = 'Télécharger des ressources';
$lang['page-title_upload_preview'] = 'Télécharger l\'aperçu';
$lang['page-title_upload_replace_batch'] = 'Remplacer des ressources par lot';
$lang['page-title_user_password'] = 'Changer le mot de passe';
$lang['page-title_user_ratings'] = 'Statistiques de notation des utilisateurs pour la ressource';
$lang['page-title_user_request'] = 'Demander un utilisateur';
$lang['page-title_video_player'] = 'Lecteur vidéo';
$lang['page-title_view_alternative_files'] = 'Voir le fichier alternatif';
$lang['page-title_view_metadata'] = 'Voir les métadonnées de la ressource';
$lang['page-title_view'] = 'Voir la ressource';
$lang['page-title_view_shares'] = 'Voir Partager';
$lang['page-title_admin_content_edit'] = 'Modifier le contenu du site';
$lang['page-title_admin_content'] = 'Contenu du site';
$lang['page-title_admin_copy_field'] = 'Copier le champ de type de ressource';
$lang['page-title_admin_download_config'] = 'Télécharger la configuration du système';
$lang['page-title_admin_filter_edit'] = 'Modifier le filtre';
$lang['page-title_admin_filter_manage'] = 'Gérer le filtre';
$lang['page-title_admin_group_config_edit'] = 'Modifier les remplacements de configuration du groupe d\'utilisateurs';
$lang['page-title_admin_group_management_edit'] = 'Modifier le groupe d\'utilisateurs';
$lang['page-title_admin_group_management'] = 'Groupes d\'utilisateurs';
$lang['page-title_admin_group_permissions'] = 'Modifier les autorisations du groupe d\'utilisateurs';
$lang['page-title_admin_home'] = 'Menu Système';
$lang['page-title_admin_manage_field_options'] = 'Gérer les options de champ';
$lang['page-title_admin_manage_slideshow'] = 'Gérer le diaporama';
$lang['page-title_admin_report_management_edit'] = 'Modifier le rapport';
$lang['page-title_admin_report_management'] = 'Gérer les rapports';
$lang['page-title_admin_resource_type_edit'] = 'Modifier le type de ressource';
$lang['page-title_admin_resource_type_field_edit'] = 'Modifier le champ de type de ressource';
$lang['page-title_admin_resource_type_fields'] = 'Champs de type de ressource';
$lang['page-title_admin_resource_types'] = 'Types de ressources';
$lang['page-title_admin_size_management_edit'] = 'Modifier la taille de l\'image';
$lang['page-title_admin_size_management'] = 'Tailles d\'image';
$lang['page-title_admin_system_config'] = 'Configuration du système';
$lang['page-title_admin_system_log'] = 'Journal système';
$lang['page-title_admin_system_performance'] = 'Performance du système';
$lang['page-title_tabs'] = 'Gérer les onglets';
$lang['page-title_team_analytics_edit'] = 'Modifier le rapport d\'analyse';
$lang['page-title_team_analytics'] = 'Rapport d\'analyse';
$lang['page-title_team_archive'] = 'Archiver les ressources';
$lang['page-title_team_copy'] = 'Copier la ressource';
$lang['page-title_team_dash_admin'] = 'Gérer le tableau de bord';
$lang['page-title_team_dash_tile'] = 'Tuiles du tableau de bord';
$lang['page-title_team_dash_tile_special'] = 'Créer un carreau de tableau spécial';
$lang['page-title_team_export'] = 'Exporter les données système';
$lang['page-title_team_external_shares'] = 'Gérer les Partages Externes';
$lang['page-title_team_home'] = 'Menu Administrateur';
$lang['page-title_team_mail'] = 'Envoyer un mail en masse';
$lang['page-title_team_plugins_groups'] = 'Gérer l\'accès au plugin du groupe d\'utilisateurs';
$lang['page-title_team_plugins'] = 'Gérer les plugins';
$lang['page-title_team_related_keywords_edit'] = 'Modifier les mots-clés associés';
$lang['page-title_team_related_keywords'] = 'Mots-clés associés';
$lang['page-title_team_report'] = 'Voir le rapport';
$lang['page-title_team_request_edit'] = 'Demande de modification';
$lang['page-title_team_request'] = 'Demandes';
$lang['page-title_team_research_edit'] = 'Modifier la demande de recherche';
$lang['page-title_team_research'] = 'Demande de recherche';
$lang['page-title_team_resource'] = 'Menu des ressources';
$lang['page-title_team_user_edit'] = 'Modifier l\'utilisateur';
$lang['page-title_team_user'] = 'Gérer les utilisateurs';
$lang['page-title_team_user_purge'] = 'Purger les utilisateurs';
$lang['page-title_user_actions'] = 'Actions de l\'utilisateur';
$lang['page-title_user_api_session'] = 'Accès API du système distant';
$lang['page-title_user_change_password'] = 'Changer le mot de passe';
$lang['page-title_user_dash_admin'] = 'Gérer le tableau de bord utilisateur';
$lang['page-title_user_home'] = 'Menu Utilisateur';
$lang['page-title_user_message'] = 'Message de l\'utilisateur';
$lang['page-title_user_messages'] = 'Messages Utilisateur';
$lang['page-title_user_preferences'] = 'Préférences utilisateur';
$lang['page-title_user_profile_edit'] = 'Mon Profil';
$lang['page-title_user_profile'] = 'Profil de l\'utilisateur';
$lang['backtomessages'] = 'Retour aux messages';
$lang['viewallmessages'] = 'Voir tous les messages';
$lang['min_ago'] = '%TIME% minute auparavant';
$lang['mins_ago'] = 'il y a %TIME% minutes';
$lang['hour_ago'] = '%TIME% heure auparavant';
$lang['hours_ago'] = 'il y a %TIME% heures';
$lang['day_ago'] = '%TIME% jour auparavant';
$lang['days_ago'] = 'il y a %TIME% jours';
$lang['week_ago'] = '%TIME% semaine précédente';
$lang['weeks_ago'] = '%TIME% semaines auparavant';
$lang['month_ago'] = '%TIME% mois auparavant';
$lang['months_ago'] = '%TIME% mois auparavant';
$lang['random'] = 'Aléatoire';
$lang['log-sf'] = 'Fichier Staticsync modifié';
$lang['log_code_J'] = 'Tâche ajoutée';
$lang['log_code_JC'] = 'Tâche terminée';
$lang['log_code_JD'] = 'Tâche supprimée';
$lang['email_username'] = 'Email / nom d\'utilisateur';
$lang['request_new_password'] = 'Si vous avez oublié votre mot de passe, utilisez le lien ci-dessous pour en demander un nouveau.';
$lang['enter_username_or_email'] = 'Entrez un nom d\'utilisateur ou une adresse email';
$lang['enter_a_password'] = 'Entrez un mot de passe';
$lang['enter_a_full_name'] = 'Entrez un nom complet';
$lang['enter_an_email_address'] = 'Entrez une adresse email';
$lang['new_to_resourcespace'] = 'Nouveau sur [applicationname] ?';
$lang['show_password'] = 'Afficher le mot de passe';
$lang['hide_password'] = 'Cacher le mot de passe';
$lang['select_a_user_group'] = 'Sélectionner un groupe d\'utilisateurs';
$lang['back_to_login'] = 'Retour à la connexion';
$lang['required'] = 'obligatoire';
$lang['select_a'] = 'Sélectionner un';
$lang['notsharableresources'] = 'Les ressources suivantes ne peuvent pas être partagées par cet utilisateur et ne peuvent pas être ajoutées à une collection partagée : ';
$lang['antispam'] = 'Anti-Spam';
$lang['comments_body-placeholder-anon'] = 'Ajouter un commentaire.';
$lang['batch_replace_alternatives'] = 'Remplacer les fichiers originaux ou alternatifs';
$lang['batch_replace_upload_resources'] = 'Fichiers originaux';
$lang['batch_replace_upload_alternatives'] = 'Fichiers alternatifs';
$lang['userpreference_user_interface'] = 'Interface utilisateur';
$lang['systemconfig_watermark_open'] = 'Appliquer un filigrane à la miniature / aperçu pour les groupes avec la permission "w" même lorsque l\'accès est "Ouvert"';
$lang['systemconfig_watermark_open_search'] = 'Si un filigrane est appliqué à la miniature / aperçu (option ci-dessus), appliquer également le filigrane à la page de recherche';
$lang['systemconfig_minyear'] = 'Date la plus ancienne à inclure dans le sélecteur de date du formulaire de recherche. Normalement l\'année du premier téléchargement';
$lang['systemconfig_searchbyday'] = 'Inclure le jour dans la recherche en plus du mois/année';
$lang['systemconfig_default_collection_sort'] = 'Ordre de tri par défaut lors de la visualisation des ressources de la collection. Lorsque les utilisateurs s\'attendent à voir les ressources dans l\'ordre dans lequel elles ont été fournies, cela doit être la collection';
$lang['systemconfig_systemconfig_searchbyday'] = 'Afficher l\'état du flux de travail de la ressource (icône et texte) dans les résultats de recherche en mode miniature';
$lang['systemconfig_category_tree_search_use_and'] = 'La sélection d\'une valeur dans un arbre de catégories sur la page de recherche sélectionnera automatiquement toutes les valeurs parentes';
$lang['systemconfig_category_tree_search_use_and_logic'] = 'Toutes les valeurs de l\'arbre de catégories sélectionnées doivent être présentes pour que la recherche retourne un résultat (ne rien sélectionner pour trouver des correspondances pour n\'importe quelle valeur sélectionnée)';
$lang['systemconfig_recent_search_quantity'] = 'Nombre de ressources à afficher avec les liens Récents et Voir le nouveau matériel';
$lang['systemconfig_general'] = 'Général';
$lang['systemconfig_date_yyyy'] = 'Afficher l\'année en format à quatre chiffres';
$lang['systemconfig_imperial_measurements'] = 'Utiliser le système impérial au lieu du métrique pour les directives de taille de téléchargement';
$lang['systemconfig_site_text_custom_create'] = 'Permet la création de nouvelles entrées de texte du site depuis Gérer le contenu (destiné au développement de nouvelles pages)';
$lang['systemconfig_no_welcometext'] = 'Cacher le texte de bienvenue sur la page d\'accueil';
$lang['systemconfig_internal_preview_sizes_editable'] = 'Permettre la modification des tailles internes';
$lang['systemconfig_edit_autosave'] = 'Enregistrer automatiquement les modifications sur la page d\'édition. Si non, le bouton Enregistrer doit être utilisé';
$lang['systemconfig_resource_request_reason_required'] = 'Lors de la demande d\'une ressource ou de ressources, le champ "Raison de la demande" est-il obligatoire';
$lang['systemconfig_research_request'] = 'Activer la fonctionnalité Demande de recherche';
$lang['systemconfig_custom_access'] = 'Activer le niveau "accès personnalisé" pour un contrôle supplémentaire de l\'accès aux ressources';
$lang['systemconfig_enable_related_resources'] = 'Activer le champ "Ressources liées" lors de l\'édition des ressources.';
$lang['systemconfig_user_accounts'] = 'Comptes utilisateur';
$lang['systemconfig_inactive_user_disable_days'] = 'Désactiver automatiquement les utilisateurs inactifs après un certain nombre de jours (0 désactive cette fonctionnalité)';
$lang['systemconfig_sharing'] = 'Partage';
$lang['systemconfig_external_share_groups_config_options'] = 'Respecter les options de configuration du groupe lors du partage externe en tant que groupe d\'utilisateurs spécifique';
$lang['systemconfig_resource_share_expire_days_default'] = 'Nombre de jours par défaut à partir duquel la sélection pour l\'expiration du partage (mettre 0 pour utiliser la première option)';
$lang['systemconfig_restricted_share'] = 'Les personnes ayant un accès « restreint » à une ressource peuvent-elles partager cette ressource';
$lang['systemconfig_blank_edit_template'] = 'Lors du téléchargement de ressources (téléchargement en lot) et de la modification du modèle, réinitialiser les valeurs à vide ou à la valeur par défaut à chaque fois';
$lang['systemconfig_enable_copy_data_from'] = 'Lors du téléchargement en lot, activer la fonction « Copier les données de la ressource existante »';
$lang['systemconfig_resource_view'] = 'Vue de la ressource';
$lang['systemconfig_show_resourceid'] = 'Afficher l\'ID de la ressource sur la page de visualisation';
$lang['systemconfig_show_resource_type'] = 'Afficher le type de ressource sur la page de visualisation';
$lang['systemconfig_show_access_field'] = 'Afficher l\'accès à la ressource sur la page de visualisation';
$lang['systemconfig_show_contributed_by'] = 'Afficher l\'utilisateur « contribué par » sur la page de visualisation';
$lang['systemconfig_show_related_themes'] = 'Afficher les collections associées et le panneau des collections publiques sur la page de visualisation';
$lang['systemconfig_metadata_download'] = 'Afficher l\'option « Télécharger les métadonnées » sur la page de visualisation';
$lang['systemconfig_uploading'] = 'Téléchargement en cours';
$lang['systemconfig_upload_add_to_new_collection'] = 'L\'option « Ajouter à une nouvelle collection » sera utilisée pour les téléchargements en lot. Désactivez-la pour revenir à « Ne pas ajouter à la collection »';
$lang['systemconfig_upload_add_to_new_collection_opt'] = 'Pour les téléchargements en lot, activer l\'option « Ajouter à une nouvelle collection »';
$lang['systemconfig_upload_do_not_add_to_new_collection_opt'] = 'Pour les téléchargements en lot, activer l\'option « Ne pas ajouter à une nouvelle collection » (si non activée, le téléchargement sera forcé dans une collection)';
$lang['systemconfig_upload_collection_name_required'] = 'Exiger qu\'un nom de collection soit saisi pour les téléchargements en lot. Cela remplacera le comportement par défaut Upload[timestamp]';
$lang['systemconfig_allow_password_change'] = 'Autoriser la modification du mot de passe';
$lang['systemconfig_allow_password_reset'] = 'Permettre aux utilisateurs de demander un nouveau mot de passe via l\'écran de connexion';
$lang['systemconfig_allow_keep_logged_in'] = 'Afficher l\'option « Rester connecté sur cet appareil » sur l\'écran de connexion';
$lang['systemconfig_remember_me_checked'] = 'Option « Rester connecté sur cet appareil » sélectionnée par défaut';
$lang['systemconfig_session_length'] = 'Durée de la session utilisateur (minutes)';
$lang['systemconfig_session_autologout'] = 'Déconnecter automatiquement l\'utilisateur à la fin de la session (temps d\'inactivité égal à la durée de la session)';
$lang['systemconfig_slideshow_photo_delay'] = 'Nombre de secondes avant que le diaporama ne change d\'image';
$lang['config_integer_invalid_range'] = 'Valeur invalide. Entrez un nombre entre %MIN% et %MAX%';
$lang['alternative_file_replaced'] = 'Fichier alternatif remplacé avec succès';
$lang['jq_create_alt_previews_success_text'] = 'Vues créées pour le fichier alternatif #%ALTFILE avec succès';
$lang['jq_create_alt_previews_failure_text'] = 'Échec de la création des aperçus pour le fichier alternatif #%ALTFILE';
$lang['error_report_execution'] = 'Une erreur est survenue lors de l\'exécution du rapport, veuillez vérifier que la requête est valide';
$lang['error_save_not_allowed_dash_tile_set_public'] = 'Impossible d\'enregistrer la modification. Veuillez vous assurer qu\'il n\'y a pas de tuiles de tableau de bord définies pour tous ou plusieurs utilisateurs liées à cette collection';
$lang['error_upload_replace_alternative_file_not_found'] = 'Échec de la mise à jour du fichier alternatif. Aucun enregistrement de fichier alternatif correspondant trouvé avec le nom de fichier [filename]';
$lang['error_upload_replace_alternative_multiple_found'] = 'Échec de la mise à jour du fichier alternatif. Plusieurs enregistrements de fichiers alternatifs correspondants trouvés avec le nom de fichier [filename], limite par ID de ressource ou collection';
$lang['oj-batch-replace-local-alternatives-success-text'] = 'Le remplacement par lot a réussi à remplacer %TOTALFILES fichiers alternatifs';
$lang['replacebatch_collection_alternatives'] = 'Entrez un ID de collection si vous souhaitez uniquement ajouter ou remplacer des fichiers alternatifs dans les ressources de cette collection';
$lang['replacebatch_resource_min_alternatives'] = 'ID de ressource la plus basse pour laquelle remplacer les fichiers alternatifs (ignoré si une collection est spécifiée)';
$lang['replacebatch_resource_max_alternatives'] = 'ID de ressource la plus haute pour laquelle remplacer les fichiers alternatifs';
$lang['system_config_search_engines'] = 'Moteurs de recherche';
$lang['int_ranges_empty'] = 'L\'entrée est vide';
$lang['int_ranges_range_below_1'] = 'Les nombres doivent être supérieurs ou égaux à 1 dans la plage %%PART%%';
$lang['int_ranges_range_reversed'] = 'Le début de la plage %%PART%% ne peut pas être supérieur à la fin';
$lang['int_ranges_range_above_max'] = 'La plage %%PART%% dépasse le nombre maximum de %%MAX_VAL%%';
$lang['int_ranges_single_below_1'] = 'Les nombres doivent être supérieurs ou égaux à 1 (%%PART%%)';
$lang['int_ranges_single_above_max'] = '%%PART%% dépasse le nombre maximum de %%MAX_VAL%%';
$lang['int_ranges_not_valid'] = '%%PART%% n\'est pas un nombre ou une plage valide (utilisez des formats comme 3 ou 5-9)';
$lang['job_trigger'] = 'Lancer une tâche';
$lang['job_configure'] = 'Configurer la tâche';
$lang['jobs_action_stream_log'] = 'Fichier journal du flux';
$lang['jobs_action_download_log'] = 'Télécharger le fichier journal';
$lang['jobs_action_not_started'] = 'Le travail n\'a pas encore commencé';
$lang['jobs_action_missing_job_progress'] = 'Impossible de charger la progression du travail';
$lang['job_action_not_found'] = 'Travail non trouvé.';
$lang['job_list_core'] = 'Noyau';
$lang['job_list_recreate_previews'] = 'Reconstruire les aperçus';
$lang['job_list_exif_data'] = 'Régénérer les données EXIF';
$lang['job_list_purge_duplicates'] = 'Supprimer les ressources en double';
$lang['job_list_reindex'] = 'Réindexer les données';
$lang['job_list_checksums'] = 'Mettre à jour les sommes de contrôle';
$lang['job_list_extracted_text'] = 'Mettre à jour le texte extrait';
$lang['oj_common_create_job'] = 'Créer un travail';
$lang['oj_common_field_refs'] = 'Références de champ';
$lang['oj_common_collection_refs'] = 'Références de collection';
$lang['oj_common_error_required'] = 'Champ requis';
$lang['oj_common_error_invalid'] = 'Valeur invalide fournie pour le champ';
$lang['oj_common_error_invalid_field_ref'] = '%FIELD_REF% ne fait pas référence à un champ valide';
$lang['oj_recreate_previews_target'] = 'Quel type de références sont fournies ?';
$lang['oj_recreate_previews_refs'] = 'Références';
$lang['oj_recreate_previews_image_sizes'] = 'Tailles d\'image à générer';
$lang['oj_recreate_previews_resource_types'] = 'Types de ressources à cibler';
$lang['oj_recreate_previews_use_existing'] = 'Utiliser les aperçus téléchargés existants ?';
$lang['oj_recreate_previews_video_update'] = 'Mettre à jour les aperçus pour toutes les ressources vidéo qui ne disposent pas de l\'extension \'$ffmpeg_preview_extension\' requise ?';
$lang['oj_recreate_previews_delete_existing'] = 'Supprimer tous les aperçus existants';
$lang['oj_recreate_previews_refs_help'] = 'Ce paramètre contrôle quelles références (références de ressources ou de collections) seront utilisées pour le traitement. Les entrées valides incluent des listes séparées par des virgules, des plages et des caractères génériques, par exemple * pour traiter toutes les références, 1-100 pour traiter les 100 premières références, 101-* pour traiter à partir de la référence 101, et 1,3,5 pour traiter les références 1, 3 et 5. Ces options peuvent être combinées pour cibler précisément les références requises, par exemple 1,5-10,15-* ciblerait 1, 5 à 10 et à partir de 15.';
$lang['oj_recreate_previews_use_existing_help'] = 'Ce paramètre tentera de préserver les aperçus qui ont été remplacés manuellement sur les ressources. Si non utilisé, tout aperçu téléchargé manuellement sera remplacé par un aperçu dérivé du fichier original.';
$lang['oj_recreate_previews_video_update_help'] = 'Ce paramètre mettra à jour toutes les vidéos qui ne correspondent pas à l\'extension \'$ffmpeg_preview_extension\' configurée actuellement. Cela est utile lorsque ce paramètre a été modifié, pour ne cibler que les ressources nécessitant une nouvelle génération d\'aperçu.';
$lang['oj_recreate_previews_delete_existing_help'] = 'Ce paramètre supprimera tous les aperçus existants avant de les recréer.';
$lang['oj_exif_data_blanks'] = 'Valeur de champ vide lorsque aucune donnée EXIF n\'existe';
$lang['oj_exif_data_overwrite'] = 'Écraser les valeurs de champ existantes lorsque des données EXIF existent';
$lang['oj_exif_data_field_refs_help'] = 'Ce sont les références des champs pour lesquels vous souhaitez extraire les données EXIF. Ces champs doivent avoir le "Champ Exiftool" configuré. Une liste séparée par des virgules peut être utilisée pour spécifier les champs, par exemple 1,3,5.';
$lang['oj_exif_data_collection_refs_help'] = 'La configuration de cette option signifie que seules les ressources dans les collections listées seront mises à jour. Si aucune collection n\'est spécifiée, les données EXIF seront mises à jour pour TOUTES les ressources appropriées. Les collections peuvent être spécifiées à l\'aide d\'une liste séparée par des virgules ainsi que de plages, par exemple 100,105,110-115.';
$lang['oj_exif_data_blanks_help'] = 'La configuration de cette option entraînera la suppression du contenu du champ spécifié si le fichier ne contient pas de données EXIF intégrées pour celui-ci.';
$lang['oj_exif_data_overwrite_help'] = 'La configuration de cette option entraînera l\'écrasement de toute valeur existante dans le champ spécifié par les données EXIF intégrées, si elles sont présentes dans le fichier.';
$lang['oj_purge_duplicates_intro'] = '<strong>Attention : Ce script permet de SUPPRIMER PERMANENTEMENT des ressources - veuillez utiliser l\'option de simulation pour valider vos paramètres si vous n\'êtes pas sûr.<\\/strong>';
$lang['oj_purge_duplicates_manage_method'] = 'Méthode de gestion';
$lang['oj_purge_duplicates_lifo'] = 'Garder les plus anciennes et supprimer les doublons plus récents';
$lang['oj_purge_duplicates_fifo'] = 'Garder les plus récentes et supprimer les doublons plus anciens';
$lang['oj_purge_duplicates_dry_run'] = 'Simulation';
$lang['oj_purge_duplicates_delete_perm'] = 'Supprimer définitivement';
$lang['oj_purge_duplicates_delete_error'] = 'La suppression permanente n\'est pas possible lors d\'une simulation';
$lang['oj_purge_duplicates_collection_refs_help'] = 'Définit les collections comme portée de la détection des doublons. Vous n\'avez pas besoin que tous les doublons soient dans les collections, un seul suffit. Les doublons seront ensuite traités à l\'échelle du système et purgés via la méthode de gestion sélectionnée. Les collections peuvent être spécifiées à l\'aide d\'une liste séparée par des virgules ainsi que de plages, par exemple 100,105,110-115.';
$lang['oj_purge_duplicates_manage_method_help'] = 'La configuration de cette option contrôle la façon dont le script traitera la suppression des doublons.';
$lang['oj_purge_duplicates_dry_run_help'] = 'La configuration de cette option effectuera une exécution d\'essai sans apporter de modifications à aucune ressource. Le fichier journal contenant les résultats de l\'exécution d\'essai peut être téléchargé pour revue.';
$lang['oj_purge_duplicates_delete_perm_help'] = 'La configuration de cette option entraînera la suppression permanente des ressources en double, sinon les ressources seront déplacées vers l\'état de suppression configuré.';
$lang['oj_reindex_field_refs_help'] = 'La configuration de cette option limitera les champs qui seront réindexés, une liste séparée par des virgules peut être utilisée pour spécifier les champs, par exemple 1,3,5. Si aucun champ n\'est saisi, TOUS les champs seront réindexés.';
$lang['oj_checksums_recreate'] = 'Recréer tous les sommes de contrôle';
$lang['oj_checksums_recreate_help'] = 'La configuration de cette option forcera la recréation de TOUS les sommes de contrôle des ressources, plutôt que seulement celles qui n\'ont pas encore de somme de contrôle existante.';
$lang['oj_extracted_text_update_all'] = 'Mettre à jour même s\'il existe déjà des données, et écraser les anciennes valeurs';
$lang['oj_extracted_text_collection_refs_help'] = 'La configuration de cette option limitera le traitement des ressources à celles des collections listées uniquement. Si aucune collection n\'est spécifiée, le texte extrait sera mis à jour pour TOUTES les ressources appropriées. Les collections peuvent être spécifiées à l\'aide d\'une liste séparée par des virgules ainsi que des plages, par exemple 100,105,110-115';
$lang['oj_extracted_text_update_all_help'] = 'La configuration de cette option lancera l\'extraction même si des données existent déjà, et écrasera la valeur ancienne.';
$lang['requiredfield_multiple'] = 'Il s\'agit d\'un champ obligatoire lors du changement d\'état de l\'archive';
$lang['reorder_invalid'] = 'La collection ne peut pas être réorganisée à moins que l\'ordre de tri ne soit l\'ordre de la collection';
$lang['reorder_permissions_fail'] = 'La collection ne peut pas être réorganisée car vous n\'avez pas accès à toutes les ressources de cette collection';
$lang['resource-card-menu-delete'] = 'Êtes-vous sûr de vouloir supprimer cette ressource ?';
$lang['resource-card-menu-delete-button'] = 'Oui, supprimer la ressource';
$lang['resource-card-menu-delete-perm'] = 'Êtes-vous sûr ? Cette action ne peut pas être annulée.';
$lang['resource-card-menu-delete-perm-button'] = 'Oui, supprimer définitivement';
$lang['blue'] = 'Bleu';
$lang['green'] = 'Vert';
$lang['red'] = 'Rouge';
$lang['purple'] = 'Violet';
$lang['fieldtype-geo_location'] = 'Géolocalisation';
$lang['property-geomapping'] = 'Type de géolocalisation';
$lang['information-geomapping'] = 'Enregistrez la géolocalisation dans ce champ sous forme de latitude, longitude ou les deux.<br \\/>Un seul champ peut être défini pour les deux ou un champ pour chaque latitude et longitude.<br \\/>Disponible uniquement pour les champs de texte en ligne unique.';
$lang['disabled-geomapping-title'] = 'La géolocalisation est définie sur un ou plusieurs autres champs, pour la changer en ce champ, elle doit être supprimée des autres champs';
$lang['geo_location-none'] = 'Aucun';
$lang['geo_location-latitude'] = 'Latitude';
$lang['geo_location-longitude'] = 'Longitude';
$lang['geo_location-both'] = 'Les deux';
$lang['knowledgebase'] = 'Base de connaissances';
$lang['search_filter_panel_toggle'] = 'Basculer les filtres de recherche';
$lang['search_resources'] = 'Rechercher des ressources';
$lang['clear_filters'] = 'Effacer les filtres';
$lang['save-error-invalid-latlong'] = 'Erreur lors de la sauvegarde automatique - géolocalisation invalide, Utilisez : latitude, longitude (par ex. 40.7128, -74.0060). La localisation de la ressource n\'a pas été mise à jour.';
$lang['save-error-invalid-lat'] = 'Erreur lors de la sauvegarde automatique - latitude géographique invalide, doit être comprise entre -90 et 90. La localisation de la ressource n\'a pas été mise à jour.';
$lang['save-error-invalid-long'] = 'Erreur lors de la sauvegarde automatique - longitude géographique invalide, doit être comprise entre -180 et 180. La localisation de la ressource n\'a pas été mise à jour.';
$lang['or'] = 'ou';
$lang['view_all_fcs'] = 'Voir toutes les collections en vedette';
$lang['dashtile_upload'] = 'Ajouter des ressources à votre système';
$lang['knowledgebase-tooltip'] = 'Voir la documentation de ResourceSpace (Base de connaissances)';
$lang['noresources_collection'] = 'Aucune ressource dans la collection';
$lang['hide_collection_bar'] = 'Caché';
$lang['minimal_collection_bar'] = 'Bar minimal';
$lang['thumbnails_collection_bar'] = 'Vignettes';
$lang['language-bg'] = 'Bulgare';
