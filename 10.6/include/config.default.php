...
// If you encounter issues with special characters, use "dajavusans" and make sure GhostScript has ArialUnicodeMS font (on Windows server, this should be there already)
